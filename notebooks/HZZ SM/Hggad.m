...
diag = diagSimplify[diag]/. {Power[q1, n_] :> z^(n/2) /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
       ...
       Do[
          If[checkdiag[[DIAG]] == 1,
             Do[
                If[count[[DIAG, TERM]] == {0, 0},
                   ...
                   If[count[[DIAG, TERM]] == {1, 0},
                      temp1 = temp[[DIAG,TERM]] /. {Power[q1, n_] :> z^(n/2) /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                      temp1 = temp1 //. PVsub;
                      temp0 = Append[temp0, temp1],
                      If[count[[DIAG, TERM]] == {1, 1},
                         temp1 = ExpandSProducts[temp[[DIAG,TERM]] /. rule11shift /. rule11];
                         temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> z^(n/2) /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0};
                         temp1 = temp1 //. PVsub;
             ...
             If[count[[DIAG]][[1]] == {0, 0},
                temp0 = Append[temp0, 0],
                If[count[[DIAG]][[1]] == {1, 0},
                   temp1 = temp[[DIAG]] /. {Power[q1, n_] :> z^(n/2) /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0};
                   temp1 = temp1 //. PVsub;
                   temp0 = Append[temp0, temp1],
                   If[count[[DIAG]] == {1, 1},
...
total = total /. sp[q1, Ep2] sp[q2, Ep1] -> AAAA + sp[Ep1, Ep2] sp[q1, q2] /. sp[q1, q2] -> (h-2z)/2;
