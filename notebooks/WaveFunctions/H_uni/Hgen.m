...
ins1 = InsertFields[ top[[2]], process1, Model -> "Mine/1301.2581", GenericModel -> "Mine/1301.2581", InsertionLevel->{Particles}, ExcludeParticles -> {S[2], S[3], U[_], F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2|4, {3, ___}]} ];
