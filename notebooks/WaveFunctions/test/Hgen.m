...
ins1 = InsertFields[ top[[2]], process1, Model -> "SM", GenericModel -> "Lorentz", InsertionLevel->{Particles}, ExcludeParticles -> {F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2|4, {3, ___}]} ];
