...
ins1 = InsertFields[ top[[2]], process1, Model -> "Mine/1301.2581.mass.bgf", GenericModel -> "Mine/1301.2581.mass.bgf", InsertionLevel->{Particles}, ExcludeParticles -> {F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2|4, {3, ___}]} ];
