...
diag = diag/.{MH->Sqrt[h], MG0->Sqrt[h], MGP->Sqrt[h], MB->Sqrt[b], MT->Sqrt[t],  MS->Sqrt[s], MC->Sqrt[c],  MD->Sqrt[d], MU->Sqrt[u], MZ->Sqrt[z], MW->Sqrt[w]};
...
FILE = NotebookDirectory[]<>"gg_WF.res";
DeleteFile[FILE]; OpenWrite[FILE];
WriteString[FILE,"ggWF=\n"]; Write[FILE,total];
Close[FILE];