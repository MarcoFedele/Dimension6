...
top = CreateTopologies[1, 1 -> 1, Adjacencies -> {3, 4, 5, 6} ];

ins1 = InsertFields[ top, process1, Model -> "Mine/1301.2581.mass2", GenericModel -> "Mine/1301.2581.mass", InsertionLevel->{Particles}, ExcludeParticles -> {F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2|4, {3, ___}]} ];
