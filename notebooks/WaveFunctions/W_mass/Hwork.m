...
diag = diag/.{MH->Sqrt[h], MG0->Sqrt[h], MGP->Sqrt[h], MB->0, MT->Sqrt[t], MZ->Sqrt[z], MW->Sqrt[w]};
...
total = Coefficient[Total[diag], q1, 2] /. B0[x_, m1_, m2_] -> 1/e + B0[x, m1, m2] //. Reorder;

total = Normal[Series[total, {e, 0, 0}]];

total = Collect[total,e,Simplify];
