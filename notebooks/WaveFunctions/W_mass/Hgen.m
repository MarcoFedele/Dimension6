...
ins1 = InsertFields[ top[[2]], process1, Model -> "Mine/1301.2581.mass", GenericModel -> "Mine/1301.2581.mass", InsertionLevel->{Particles}, ExcludeParticles -> {F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2, {3, ___}]} ];
