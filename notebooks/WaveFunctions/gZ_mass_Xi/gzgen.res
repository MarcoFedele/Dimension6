...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}} -> 
    {{V[2], FourMomentum[Outgoing, 1], MZ, {}}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (-I/2)*(cw*gw - g1*sw)*NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ChiralityProjector[-1]] + I*g1*sw*NonCommutative[
       DiracMatrix[Index[Lorentz, 2]], ChiralityProjector[1]], 
    NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1]]], 
    (-I/2)*(cw*g1 + gw*sw)*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
       ChiralityProjector[-1]] - I*cw*g1*NonCommutative[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 4, Number == 4], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MU], 
   ...
   MatrixTrace[NonCommutative[MU + DiracSlash[-FourMomentum[Internal, 1]]], 
    (I/6)*(3*cw*gw - g1*sw)*NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ChiralityProjector[-1]] - ((2*I)/3)*g1*sw*NonCommutative[
       DiracMatrix[Index[Lorentz, 2]], ChiralityProjector[1]], 
    NonCommutative[MU + DiracSlash[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]]], 
    (I/6)*(cw*g1 + 3*gw*sw)*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 7, Number == 7], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MD], 
   ...
   MatrixTrace[NonCommutative[MD + DiracSlash[-FourMomentum[Internal, 1]]], 
    (-I/6)*(3*cw*gw + g1*sw)*NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ChiralityProjector[-1]] + (I/3)*g1*sw*NonCommutative[
       DiracMatrix[Index[Lorentz, 2]], ChiralityProjector[1]], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    ((I/2)*(cw*g1 + gw*sw)*FourVector[-FourMomentum[Internal, 1], 
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])*((-I/2)*(cw*gw - g1*sw)*
  ...
  -((((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
    ...
    ((-I)*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*
     ...
     I*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
       ...
       Index[Lorentz, 6]] + I*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       ...
       Index[Lorentz, 6]]))], FeynAmp[GraphID[Topology == 1, Generic == 5, 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[-FourMomentum[Outgoing, 1], 
    ...
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[-FourMomentum[Outgoing, 1], -FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 4, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MW*Sqrt[GaugeXi[W]]], PropagatorDenominator[
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW], 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[FourMomentum[Outgoing, 1], 
    ...
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[-FourMomentum[Outgoing, 1], -FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)]]
ins1=
TopologyList[Process -> {V[1]} -> {V[2]}, Model -> {"Mine/1301.2581.mass2"}, 
