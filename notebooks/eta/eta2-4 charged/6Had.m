...
AD = AD /. {sp[q1,q2] + 2 sp[q1,q3] - sp[q1,q4] - sp[q2,q2] - 3 sp[q2,q3] + 6 sp[q2,q4] + 2 sp[q3,q3] + 3 sp[q3,q4] - sp[q4,q4] ->
                8 h - 3 sp[q1, q1] + 6 sp[q1, q3] - 3 sp[q2, q2] + 6 sp[q2, q4] - 3 sp[q3, q3] - 3 sp[q4, q4],
            ...
            sp[q1,q2] + 2 sp[q1,q3] - sp[q1,q4] - sp[q2,q3] + 2 sp[q2,q4] + sp[q3,q4] ->
                4 h - sp[q1, q1] + sp[q1, q2] + 2 sp[q1, q3] - sp[q1, q4] - sp[q2, q2] - sp[q2, q3] + 2 sp[q2, q4] - sp[q3, q3] + sp[q3, q4] - sp[q4, q4]} // Simplify;
Print["AD computed."];
