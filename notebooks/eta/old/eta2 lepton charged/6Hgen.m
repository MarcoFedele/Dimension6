...
top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, SelfEnergies, Triangles, Pentagons, Hexagons} ];
 ...
 ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|4|7|8|9|10|11|12], S[2|3]}, InsertionLevel->{Particles} ];
