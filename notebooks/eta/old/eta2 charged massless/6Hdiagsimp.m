...
CRF5 := {    MatrixTrace[a___,
    ...
    MatrixTrace[y___,  x1_. NonCommutative[ChiralityProjector[n1_]] +
                x2_. NonCommutative[ChiralityProjector[n2_]] +
                x3_. NonCommutative[ChiralityProjector[n3_]] , z___] :>
    x1/2 MatrixTrace[y, G[l2, U + n1 G5], z] + x2/2 MatrixTrace[y, G[l2, U + n2 G5], z] +
    x3/2 MatrixTrace[y, G[l2, U + n3 G5], z],
...
diag = diag /. {
    q1 + q2 + q3 - q4 - q5 -> q12345, -q1 - q2 - q3 + q4 + q5 -> -q12345,
    q1 + q2 + q3 -> q123, -q1 - q2 - q3 -> - q123,
    q1 + q2 - q4 -> q124, -q1 - q2 + q4 -> - q124,
    q1 + q2 - q5 -> q125, -q1 - q2 + q5 -> - q125,
    q1 + q3 - q4 -> q134, -q1 - q3 + q4 -> - q134,
    q1 + q3 - q5 -> q135, -q1 - q3 + q5 -> - q135,
    q1 - q4 - q5 -> q145, -q1 + q4 + q5 -> - q145,
    q2 + q3 - q4 -> q234, -q2 - q3 + q4 -> - q234,
    q2 + q3 - q5 -> q235, -q2 - q3 + q5 -> - q235,
    q2 + q3 - q6 -> q236, -q2 - q3 + q6 -> - q236,
    q2 - q4 - q5 -> q245, -q2 + q4 + q5 -> - q245,
    q2 - q4 - q6 -> q246, -q2 + q4 + q6 -> - q246,
    q2 - q5 - q6 -> q256, -q2 + q5 + q6 -> - q256,
    q3 - q4 - q5 -> q345, -q3 + q4 + q5 -> - q345,
    q3 - q4 - q6 -> q346, -q3 + q4 + q6 -> - q346,
    q3 - q5 - q6 -> q356, -q3 + q5 + q6 -> - q356,
    q4 + q5 + q6 -> q456, -q4 - q5 - q6 -> - q456
};
...
amp3 = amp3 //. { sp[a_, b_] + sp[a_, c_] :> sp[a, b + c] /; b =!= c =!= p,
                  sp[a_, b_] - sp[a_, c_] :> sp[a, b - c] /; b =!= c =!= p,
                 -sp[a_, b_] - sp[a_, c_] :> sp[a, -b - c] /; b =!= c =!= p};

FILE = NotebookDirectory[]<>"6Hdiagsimp.res";
