...
spReabs[exp_] := Module[{temp},
                        temp = exp;
                        
                        q1sos = q1 -> -q2 - q3 + q4 + q5 + q6;
                        q2sos = q2 -> -q1 - q3 + q4 + q5 + q6;
                        q3sos = q3 -> -q2 - q1 + q4 + q5 + q6;
                        q4sos = q4 -> q1 + q2 + q3 - q5 - q6;
                        q5sos = q5 -> q1 + q2 + q3 - q4 - q6;
                        
                        pparg = {q1 + q2 + q3, q1 + q2 - q4, q1 + q2 - q5, q1 + q3 - q4, q1 + q3 - q5, q1 - q4 - q5, q2 + q3 - q4, q2 + q3 - q5, q2 - q4 - q5, q3 - q4 - q5, -q1 - q2 - q3, -q1 - q2 + q4, -q1 - q2 + q5, -q1 - q3 + q4, -q1 - q3 + q5, -q1 + q4 + q5, -q2 - q3 + q4, -q2 - q3 + q5, -q2 + q4 + q5, -q3 + q4 + q5};
                        ppres = {q123, q124, q125, q134, q135, q145, q234, q235, q245, q345, -q123, -q124, -q125, -q134, -q135, -q145, -q234, -q235, -q245, -q345};
                        ppsospre = {{q4sos, q5sos}, {q3sos, q5sos}, {q3sos, q4sos}, {q2sos, q5sos}, {q2sos, q4sos}, {q2sos, q3sos}, {q1sos, q5sos}, {q1sos, q4sos}, {q1sos, q3sos}, {q1sos, q2sos}, {q4sos, q5sos}, {q3sos, q5sos}, {q3sos, q4sos}, {q2sos, q5sos}, {q2sos, q4sos}, {q2sos, q3sos}, {q1sos, q5sos}, {q1sos, q4sos}, {q1sos, q3sos}, {q1sos, q2sos}};
                        ppsospost = {{q4 + q5 + q6 -> q1 + q2 + q3, -q4 - q5 - q6 -> -q1 - q2 - q3}, {q3 - q5 - q6 -> -q1 - q2 + q4, -q3 + q5 + q6 -> q1 + q2 - q4}, {q3 - q4 - q6 -> -q1 - q2 + q5, -q3 + q4 + q6 -> q1 + q2 - q5}, {q2 - q5 - q6 -> -q1 - q3 + q4, -q2 + q5 + q6 -> q1 + q3 - q4}, {q2 - q4 - q6 -> -q1 - q3 + q5, -q2 + q4 + q6 -> q1 + q3 - q5}, {q2 + q3 - q6 -> -q1 + q4 + q5, -q2 - q3 + q6 -> q1 - q4 - q5}, {q1 - q5 - q6 -> -q2 - q3 + q4, -q1 + q5 + q6 -> q2 + q3 - q4}, {q1 - q4 - q6 -> -q2 - q3 + q5, -q1 + q4 + q6 -> q2 + q3 - q5}, {q1 + q3 - q6 -> -q2 + q4 + q5, -q1 - q3 + q6 -> q2 - q4 - q5}, {q1 + q2 - q6 -> -q3 + q4 + q5, -q1 - q2 + q6 -> q3 - q4 - q5}, {q4 + q5 + q6 -> q1 + q2 + q3, -q4 - q5 - q6 -> -q1 - q2 - q3}, {q3 - q5 - q6 -> -q1 - q2 + q4, -q3 + q5 + q6 -> q1 + q2 - q4}, {q3 - q4 - q6 -> -q1 - q2 + q5, -q3 + q4 + q6 -> q1 + q2 - q5}, {q2 - q5 - q6 -> -q1 - q3 + q4, -q2 + q5 + q6 -> q1 + q3 - q4}, {q2 - q4 - q6 -> -q1 - q3 + q5, -q2 + q4 + q6 -> q1 + q3 - q5}, {q2 + q3 - q6 -> -q1 + q4 + q5, -q2 - q3 + q6 -> q1 - q4 - q5}, {q1 - q5 - q6 -> -q2 - q3 + q4, -q1 + q5 + q6 -> q2 + q3 - q4}, {q1 - q4 - q6 -> -q2 - q3 + q5, -q1 + q4 + q6 -> q2 + q3 - q5}, {q1 + q3 - q6 -> -q2 + q4 + q5, -q1 - q3 + q6 -> q2 - q4 - q5}, {q1 + q2 - q6 -> -q3 + q4 + q5, -q1 - q2 + q6 -> q3 - q4 - q5}};
                        
                        diagarg = Table[arg = 0;
                                        Do[
                                           If[ Coefficient[temp[[j]], pp[pparg[[i]], h]] =!= 0, arg = ppres[[i]]
                                              ], {i, Length[pparg]}
                                           ];
                                        arg
                                        ,{j, Length[temp]}];
                        ...
                        rule := {
                            sp[a_, b_] +  sp[b_, c_] +  sp[a_, c_] -> sp[a + b + c, a + b + c]/2 - 3 h/2,
                            sp[a_, b_] -  sp[b_, c_] - sp[a_, c_] -> sp[a + b - c, a + b - c]/2 - 3 h/2,
                            - sp[a_, b_] + sp[b_, c_] - sp[a_, c_] -> sp[-a + b + c, -a + b + c]/2 -  3 h/2,
                            - sp[a_, b_] - sp[b_, c_] + sp[a_, c_] -> sp[a - b + c, a - b + c]/2 - 3 h/2,
                            - sp[a_, b_] - sp[b_, c_] - sp[a_, c_] -> -sp[a + b + c, a + b + c]/2 + 3 h/2,
                            ...
                            sp[a_, b_] - sp[b_, c_] + sp[a_, c_] -> -sp[-a + b + c, -a + b + c]/2 + 3 h/2,
                            sp[a_, b_] + sp[b_, c_] - sp[a_, c_] -> -sp[a - b + c, a - b + c]/2 + 3 h/2,
                            2 sp[a_, b_] + 2 sp[b_, c_] + 2 sp[a_, c_] -> sp[a + b + c, a + b + c] - 3 h,
                            2 sp[a_, b_] - 2 sp[b_, c_] - 2 sp[a_, c_] -> sp[a + b - c, a + b - c] - 3 h,
                            - 2 sp[a_, b_] + 2 sp[b_, c_] - 2  sp[a_, c_] -> sp[-a + b + c, -a + b + c] -  3 h,
                            - 2 sp[a_, b_] - 2 sp[b_, c_] + 2  sp[a_, c_] -> sp[a - b + c, a - b + c] - 3 h,
                            - 2 sp[a_, b_] - 2 sp[b_, c_] - 2  sp[a_, c_] -> -sp[a + b + c, a + b + c] + 3 h,
                        ...
                        Do[
                           Do[If[diagarg[[j]] === ppres[[i]],
                                 temp[[j]] = ExpandScalarProducts[temp[[j]] /. ppsospre[[i]]];
                                 temp[[j]] = Simplify[temp[[j]]] //. rule;
                                 temp[[j]] = temp[[j]] /. ppsospost[[i]];
                                 ], {i, Length[ppres]}
                              ], {j, Length[temp]}
                           ];
                        
                        temp = 
                        temp /. {q1^2 -> h, q2^2 -> h, q3^2 -> h, q4^2 -> h, q5^2 -> h, q6^2 -> h};
