...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  EL*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      ...
      Index[Lorentz, 1]] - I*EL*FourVector[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      Index[Lorentz, 1]])*(-MH^2/(2*MW*sw) - (MW*GaugeXi[Q])/sw)], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  I*(((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
   ...
   (((-I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
    ...
    (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
     ...
     GaugeXi[Q] + ((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*
    ...
    (I*EL*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
   ...
   (((2*I)*cW*gw^2*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    (I*EL*MW*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]])/sw - 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 1, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*(I*EL*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
     I*EL*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*(I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
         1], Index[Lorentz, 2]] - I*EL*FourVector[FourMomentum[Internal, 1], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
        ...
        FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
       Index[Lorentz, 4]])*
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 3]]*FourVector[FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
        Index[Lorentz, 1]])/LAMBDA^2 + 
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
       ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2))/
   sw], FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 2, 
  ...
  (EL*((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
       ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2))/
   sw], FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 1, 
  ...
  6*lam*vev*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
   ...
   (((-I)*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
    ...
    (I*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 3, 
   Number == 15], Integral[FourMomentum[Internal, 1]], 
  -(EL*(-MH^2/(2*MW*sw) - (MW*GaugeXi[Q])/sw)*
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
       PropagatorDenominator[FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
       ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]])/
      LAMBDA^2)*(((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 4]]*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/LAMBDA^2 + 
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
       ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
      LAMBDA^2))], FeynAmp[GraphID[Topology == 1, Generic == 6, 
  ...
  -(EL*(-MH^2/(2*MW*sw) - (MW*GaugeXi[Q])/sw)*
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
       ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
      LAMBDA^2))], FeynAmp[GraphID[Topology == 1, Generic == 7, 
   ...
   (((2*I)*(cw^2*cW*gw^2 + cw*cWB*g1*gw*sw + cB*g1^2*sw^2)*vev*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]])/LAMBDA^2 + 
    (I*EL*MW*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])/(cw^2*sw) - 
    ((2*I)*(cw^2*cW*gw^2 + cw*cWB*g1*gw*sw + cB*g1^2*sw^2)*vev*
      MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 3, Number == 19], 
  ...
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 5]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1]])/LAMBDA^2)*
   (((2*I)*cW*gw^2*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    (I*EL*MW*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])/sw - 
   ...
   (((2*I)*cW*gw^2*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    ((2*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
    (((-I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2 - 
     ...
     I*gw*sw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
       ...
       Index[Lorentz, 5]] + (I*EL*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
       ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]])/
      LAMBDA^2))/sw], FeynAmp[GraphID[Topology == 1, Generic == 8, 
  ...
  (EL*FourVector[FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
       ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]])/
      LAMBDA^2))/sw], FeynAmp[GraphID[Topology == 1, Generic == 9, 
   Particles == 1, Number == 23], Integral[FourMomentum[Internal, 1]], 
  (EL*FourVector[FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
    (((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
       FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]])/LAMBDA^2 + 
  ...
  (EL*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
    ...
    (((-I)*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 2], 
     ...
     (I*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
       ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
      LAMBDA^2))/sw], FeynAmp[GraphID[Topology == 2, Generic == 1, 
  ...
  -((((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0], 
   ...
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*
    ...
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 2, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 32], 
  ...
  (I/2)*vev*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MZ*Sqrt[GaugeXi[Q]]], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MZ*Sqrt[GaugeXi[Q]]]]*
   (2*lam + ((g1^2 + gw^2)*GaugeXi[Q])/2)*
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*
      FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]])/LAMBDA^2 - 
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*
  ...
  (-I)*EL*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[Q]]]]*
   (-MH^2/(2*MW*sw) - (MW*GaugeXi[Q])/sw)*
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(cw*cWB*g1 + cW*gw*sw))*
      FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]])/LAMBDA^2 + 
    (2*I)*EL^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]] - 
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(cw*cWB*g1 + cW*gw*sw))*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 2, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  (2*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  -((((-2*I)*EL^2 + ((2*I)*cW*gw^4*sw^2*vev^2)/LAMBDA^2)*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     (I*EL^2 - (I*cW*gw^4*sw^2*vev^2)/LAMBDA^2)*(1 - GaugeXi[Q]^(-1))*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
    ...
    (((2*I)*cW*gw^2*vev*FourVector[-FourMomentum[Internal, 1], 
     ...
     (I*EL*MW*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])/sw - 
     ((2*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 5, Generic == 4, Particles == 1, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  (I*EL*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
    ((I*cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 2]])/LAMBDA^2 + (I*cw*cWB*g1*gw^2*sw*vev*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2 - 
     (I*cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 4]])/LAMBDA^2 - (I*cw*cWB*g1*gw^2*sw*vev*
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 4, Particles == 2, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*EL*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
    (((-I)*cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], 
...
TopologyList[Process -> {V[10], V[10]} -> {S[10]}, 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[10], 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> U[3], Field[5] -> -U[3], 
      Field[6] -> U[3]], FeynmanGraph[1, Particles == 3][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> -U[4], 
      Field[5] -> U[4], Field[6] -> -U[4]], FeynmanGraph[1, Particles == 4][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
      Field[4] -> U[4], Field[5] -> -U[4], Field[6] -> U[4]]], 
   ...
   FeynmanGraph[1, Generic == 6][Field[1] -> V[10], Field[2] -> V[10], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> V[1], 
     ...
     FeynmanGraph[1, Particles == 3][Field[1] -> V[10], Field[2] -> V[10], 
      ...
      Field[6] -> -S[3]], FeynmanGraph[1, Particles == 4][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> V[3], 
   ...
   FeynmanGraph[1, Generic == 7][Field[1] -> V[10], Field[2] -> V[10], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
     ...
     FeynmanGraph[1, Particles == 3][Field[1] -> V[10], Field[2] -> V[10], 
      ...
      Field[6] -> -V[3]], FeynmanGraph[1, Particles == 4][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> S[3], 
