...
FeynAmpList[Process -> {{V[3], FourMomentum[Incoming, 1], MW, {Q}}, 
    ...
    {{S[3], FourMomentum[Outgoing, 1], MW, {Q}}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 2], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   ((cw*cWB*g1*gw*vev*FourVector[-FourMomentum[Incoming, 2] - 
    ...
    (cw*g1*gw*vev*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]])/2 + 
    (cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 3], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[FourMomentum[Incoming, 2] + 
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 8]])/LAMBDA^2 + 
    (g1*gw*sw*vev*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]])/2 - 
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, Number == 4], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 + 
    (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/2)*
   ((-I/2)*(cw*g1 + gw*sw)*FourVector[-FourMomentum[Outgoing, 1], 
      Index[Lorentz, 4]] + (I/2)*(cw*g1 + gw*sw)*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 2, Number == 5], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 + 
    (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/2)*
   ((-I/2)*(cw*gw - g1*sw)*FourVector[-FourMomentum[Outgoing, 1], 
      Index[Lorentz, 4]] + (I/2)*(cw*gw - g1*sw)*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], Index[Lorentz, 4]])*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 9], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   ((-I/2)*(cw*g1 + gw*sw)*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
    (I/2)*(cw*g1 + gw*sw)*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 2]])*((I/2)*(cw*gw - g1*sw)*
     FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
      Index[Lorentz, 4]] - (I/2)*(cw*gw - g1*sw)*
     FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]])*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, Number == 10], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((cw*cWB*g1*gw*vev*FourVector[-FourMomentum[Incoming, 2] - 
    ...
    (cw*g1*gw*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])/2 + 
    (cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 3, Number == 15], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[FourMomentum[Incoming, 2] + 
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 6]])/LAMBDA^2 + 
    (g1*gw*sw*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])/2 - 
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 1, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MW], PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((I/2)*(cw*g1 + gw*sw)*FourVector[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], Index[Lorentz, 6]] - 
    (I/2)*(cw*g1 + gw*sw)*FourVector[-FourMomentum[Outgoing, 1], 
      Index[Lorentz, 6]])*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   ((-I)*gw*sw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*
     FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    I*gw*sw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*
   ...
   ((cw*cWB*g1*gw*vev*FourVector[-FourMomentum[Incoming, 2], 
    ...
    (cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 3, 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((-I)*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
    ...
    (I*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 4, 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MZ]]*
   ((I/2)*(cw*gw - g1*sw)*FourVector[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], Index[Lorentz, 6]] - 
    (I/2)*(cw*gw - g1*sw)*FourVector[-FourMomentum[Outgoing, 1], 
      Index[Lorentz, 6]])*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   ((-I)*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*
    ...
    (I*gw*sw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
     ...
     I*gw*sw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
    ((cw*cWB*g1*gw^2*sw*vev*FourVector[-FourMomentum[Incoming, 2], 
        Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]])/LAMBDA^2 + 
     (cw*cWB*g1*gw^2*sw*vev*FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]])/LAMBDA^2 + 
     (cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 2], 
    ...
    (I*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
     ...
     I*cw*gw*(1 - (cW*gw^2*vev^2)/LAMBDA^2)*FourVector[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
    ((cw^2*cWB*g1*gw^2*vev*FourVector[-FourMomentum[Incoming, 2], 
        Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]])/LAMBDA^2 + 
     (cWB*g1*gw^2*sw^2*vev*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]])/LAMBDA^2 + 
     (cw^2*cWB*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
     ...
     (cWB*g1*gw^2*sw^2*vev*FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], 
        Index[Lorentz, 6]])/LAMBDA^2)*MetricTensor[Index[Lorentz, 5], 
     Index[Lorentz, 6]])], FeynAmp[GraphID[Topology == 2, Generic == 2, 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(cw*cWB*g1 + cW*gw*sw))*
    ...
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(cw*cWB*g1 + cW*gw*sw))*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 2, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
   ...
   ((cWB*g1*gw*sw*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)*
   ((I*(cw^2*cWB*g1*gw - 2*cB*cw*g1^2*sw + 2*cw*cW*gw^2*sw - cWB*g1*gw*sw^2)*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    ...
    (I*(-(cw^2*cWB*g1*gw) + 2*cw*(cB*g1^2 - cW*gw^2)*sw + cWB*g1*gw*sw^2)*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 3, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   ((cw*cWB*g1*gw*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    (cw*cWB*g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
   ...
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
    ...
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
   ...
   (((-I)*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
    ...
    (I*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
   ...
   ((cw*cWB*g1*gw*vev*FourVector[-FourMomentum[Incoming, 2], 
    ...
    (cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  (2*I)*lam*vev*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MH], PropagatorDenominator[
     FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
   ((cw*cWB*g1*gw*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]])/LAMBDA^2 - 
    (cw*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/2 + 
    (cw*cWB*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]]*(((2*I)*gw^2*sw^2*(-LAMBDA^2 + cW*gw^2*vev^2)*
     ...
     (I*gw^2*sw^2*(-LAMBDA^2 + cW*gw^2*vev^2)*MetricTensor[Index[Lorentz, 1], 
        ...
        Index[Lorentz, 6]])/LAMBDA^2)*MetricTensor[Index[Lorentz, 5], 
     Index[Lorentz, 6]]*
    ((cw*cWB*g1*gw*vev*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 5]]*FourVector[FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/LAMBDA^2 - 
     (cw*g1*gw*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])/2 + 
     (cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 2, Number == 32], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MZ], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]]*(((2*I)*cw*gw^2*sw*(-LAMBDA^2 + cW*gw^2*vev^2)*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2 + 
    ...
    MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]*
    ((cWB*g1*gw*sw*vev*FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 5]]*FourVector[FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/LAMBDA^2 + 
     (g1*gw*sw*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])/2 - 
     (cWB*g1*gw*sw*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 4, Generic == 3, Particles == 1, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], 0]]*
   ((I/2)*(cw*g1 + gw*sw)*FourVector[-FourMomentum[Internal, 1], 
      Index[Lorentz, 3]] - (I/2)*(cw*g1 + gw*sw)*
     FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])*
   ((cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
     LAMBDA^2 + (cw*cWB*g1*gw^2*sw*vev*FourVector[
       -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
     ...
     LAMBDA^2 + (cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]], 
 FeynAmp[GraphID[Topology == 4, Generic == 3, Particles == 2, Number == 34], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MZ]]*
   ((I/2)*(cw*gw - g1*sw)*FourVector[-FourMomentum[Internal, 1], 
      Index[Lorentz, 3]] - (I/2)*(cw*gw - g1*sw)*
     FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])*
   ((cw^2*cWB*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
     LAMBDA^2 + (cWB*g1*gw^2*sw^2*vev*FourVector[FourMomentum[Internal, 1] + 
    ...
    (cw^2*cWB*g1*gw^2*vev*FourVector[-FourMomentum[Incoming, 2], 
     ...
     LAMBDA^2 + (cWB*g1*gw^2*sw^2*vev*FourVector[-FourMomentum[Internal, 1] - 
      ...
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]], 
 FeynAmp[GraphID[Topology == 4, Generic == 3, Particles == 3, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MW]]*
   ...
   (((-2*I)*cW*gw^3*sw*vev*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
     LAMBDA^2 + (I*gw^2*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    ((2*I)*cW*gw^3*sw*vev*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]])/
     LAMBDA^2 - ((2*I)*cW*gw^3*sw*vev*FourVector[-FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]])/LAMBDA^2 + 
    (I*gw^2*(cw*cWB*g1 - 2*cW*gw*sw)*vev*FourVector[FourMomentum[Incoming, 
        2], Index[Lorentz, 1]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]])/LAMBDA^2 + 
   ...
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]]]
ins1=
TopologyList[Process -> {V[3], V[1]} -> {S[3]}, 
  Model -> {"Mine/1301.2581.mass2"}, GenericModel -> {"Mine/1301.2581.mass"}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[3], 
     Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S, Field[5] -> S, 
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> S[3], Field[5] -> S[1], Field[6] -> S[3]]], 
   FeynmanGraph[1, Generic == 2][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> V, Field[5] -> V, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[3], 
      Field[5] -> V[1], Field[6] -> V[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> V[3], Field[5] -> V[2], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 3][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> S, Field[5] -> S, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S[1], 
      Field[5] -> S[3], Field[6] -> V[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> S[1], Field[5] -> S[3], Field[6] -> V[2]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> V[3], Field[2] -> V[1], 
      Field[3] -> -S[3], Field[4] -> S[3], Field[5] -> S[1], 
      Field[6] -> V[3]], FeynmanGraph[1, Particles == 4][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S[3], 
      Field[5] -> S[2], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 4][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> S, Field[5] -> V, Field[6] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S[3], 
      Field[5] -> V[1], Field[6] -> S[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> S[3], Field[5] -> V[2], Field[6] -> S[3]]], 
   FeynmanGraph[1, Generic == 5][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> V, Field[5] -> S, Field[6] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[1], 
      Field[5] -> S[3], Field[6] -> S[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> V[2], Field[5] -> S[3], Field[6] -> S[1]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> V[3], Field[2] -> V[1], 
      Field[3] -> -S[3], Field[4] -> V[3], Field[5] -> S[1], 
      Field[6] -> S[3]]], FeynmanGraph[1, Generic == 6][Field[1] -> V[3], 
     Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S, Field[5] -> V, 
     Field[6] -> V] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> S[1], Field[5] -> V[3], Field[6] -> V[1]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> V[3], Field[2] -> V[1], 
      Field[3] -> -S[3], Field[4] -> S[3], Field[5] -> V[1], 
      Field[6] -> V[3]], FeynmanGraph[1, Particles == 3][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S[1], 
      Field[5] -> V[3], Field[6] -> V[2]], FeynmanGraph[1, Particles == 4][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> S[3], Field[5] -> V[2], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 7][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> V, Field[5] -> S, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[3], 
      Field[5] -> S[1], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 8][Field[1] -> V[3], Field[2] -> V[1], 
     Field[3] -> -S[3], Field[4] -> V, Field[5] -> V, Field[6] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[1], 
      Field[5] -> V[3], Field[6] -> S[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[3], Field[2] -> V[1], Field[3] -> -S[3], 
      Field[4] -> V[3], Field[5] -> V[1], Field[6] -> S[3]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> V[3], Field[2] -> V[1], 
      Field[3] -> -S[3], Field[4] -> V[2], Field[5] -> V[3], 
      Field[6] -> S[1]], FeynmanGraph[1, Particles == 4][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[3], 
      Field[5] -> V[2], Field[6] -> S[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[3], 
     Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V, Field[5] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[1], 
      Field[5] -> V[3]], FeynmanGraph[1, Particles == 2][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[2], 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[3], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      ...
      Field[5] -> -V[3]], FeynmanGraph[1, Particles == 2][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> V[2], 
      Field[5] -> -V[3]]], FeynmanGraph[1, Generic == 3][Field[1] -> V[3], 
     Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> S, Field[5] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[3], 
      Field[2] -> V[1], Field[3] -> -S[3], Field[4] -> -S[3], 
      Field[5] -> V[1]], FeynmanGraph[1, Particles == 2][Field[1] -> V[3], 
