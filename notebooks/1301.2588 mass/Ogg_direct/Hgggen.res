...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  Model -> {"Mine/1301.2581.mass3"}, GenericModel -> {"Mine/1301.2581.mass"}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
      ...
      Index[Lorentz, 4]]*((-I)*gw*sw*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 3]] + I*gw*sw*FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 3]] + I*gw*sw*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 5]] - I*gw*sw*FourVector[FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
        Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 5]] - I*gw*sw*FourVector[-FourMomentum[Internal, 1], 
        ...
        Index[Lorentz, 4]] - I*gw*sw*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 7]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]] - I*gw*sw*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 7]] + I*gw*sw*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 7]] - 
      I*gw*sw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
          1], Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], 
        Index[Lorentz, 7]] + I*gw*sw*FourVector[FourMomentum[Internal, 1], 
     ...
     MetricTensor[Index[Lorentz, 7], Index[Lorentz, 8]])/2], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, Number == 7], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((2*I)*C\[Gamma]\[Gamma]*vev*FourVector[FourMomentum[Incoming, 2], 
    ...
    (I/2)*(cw*g1 - gw*sw)^2*vev*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 3]] - ((2*I)*C\[Gamma]\[Gamma]*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 2, Number == 8], 
  Integral[FourMomentum[Internal, 1]], 
  ((cw*gw + g1*sw)*(cw*g1 - gw*sw)*vev*FeynAmpDenominator[
    ...
    (((-(cw*gw) - g1*sw)*FourVector[-FourMomentum[Outgoing, 1], 
     ...
     ((cw*gw + g1*sw)*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
        Index[Lorentz, 4]])/2)*MetricTensor[Index[Lorentz, 2], 
     Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/
   2], FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 3, 
   Number == 9], Integral[FourMomentum[Internal, 1]], 
  (-I/2)*cw*g1*gw*vev*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MW], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 4, Number == 10], 
  Integral[FourMomentum[Internal, 1]], (I/2)*cw*g1*gw*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 1, Number == 11], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((-(cw*g1) + gw*sw)*FourVector[FourMomentum[Incoming, 2] + 
    ...
    Index[Lorentz, 4]]*(((2*I)*C\[Gamma]\[Gamma]*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 12], 
  ...
  ((cw*gw + g1*sw)*(cw*g1 - gw*sw)*vev*FeynAmpDenominator[
    ...
    (((cw*gw + g1*sw)*FourVector[FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1], Index[Lorentz, 4]])/2 + 
     ((-(cw*gw) - g1*sw)*FourVector[-FourMomentum[Outgoing, 1], 
        Index[Lorentz, 4]])/2)*MetricTensor[Index[Lorentz, 1], 
     Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/
   2], FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 3, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, Number == 15], 
  ...
  6*lam*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MH]]*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   (((2*I)*C\[Gamma]\[Gamma]*vev*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 3]]*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 1]])/LAMBDA^2 + (I/2)*(cw*g1 - gw*sw)^2*vev*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] - 
    ((2*I)*C\[Gamma]\[Gamma]*vev*MetricTensor[Index[Lorentz, 1], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((2*I)*C\[Gamma]\[Gamma]*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 5]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    (I/2)*(cw*g1 - gw*sw)^2*vev*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 5]] - ((2*I)*C\[Gamma]\[Gamma]*vev*
   ...
   (((2*I)*C\[Gamma]\[Gamma]*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    (I/2)*(cw*g1 - gw*sw)^2*vev*MetricTensor[Index[Lorentz, 4], 
      Index[Lorentz, 6]] - ((2*I)*C\[Gamma]\[Gamma]*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 2, Number == 20], 
  Integral[FourMomentum[Internal, 1]], (I/4)*(cw*gw + g1*sw)^2*
   (cw*g1 - gw*sw)^2*vev^2*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MH], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MZ], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 4, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  -((cw*gw + g1*sw)^4*(cw*g1 - gw*sw)^2*vev^3*FeynAmpDenominator[
      PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], MZ], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
     MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]])/8], 
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 5, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  -(cw^2*g1^2*gw^4*vev^3*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MW], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MW], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], (I/2)*cw*g1*gw*vev*
   ...
   MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   (I*gw*sw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    I*gw*sw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    I*gw*sw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 5]] + 
    I*gw*sw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
    ...
    I*gw*sw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 2, Number == 26], 
  Integral[FourMomentum[Internal, 1]], (-I/2)*cw*g1*gw*vev*
   FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
   ...
   ((-I)*gw*sw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
    ...
    I*gw*sw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], (-I/2)*cw*g1*gw*vev*
   FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
   ...
   ((gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 6]])/2)*MetricTensor[Index[Lorentz, 2], 
    Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   ((-I)*gw*sw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    I*gw*sw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    I*gw*sw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
    ...
    I*gw*sw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 2, Number == 28], 
  Integral[FourMomentum[Internal, 1]], (I/2)*cw*g1*gw*vev*
   FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
   ...
   (I*gw*sw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
    ...
    I*gw*sw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((2*I)*C\[Gamma]\[Gamma]*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    ((2*I)*C\[Gamma]\[Gamma]*vev*MetricTensor[Index[Lorentz, 1], 
       ...
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)*
   (((2*I)*C\[Gamma]\[Gamma]*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]])/LAMBDA^2 + (I/2)*(cw*g1 - gw*sw)^2*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    ((2*I)*C\[Gamma]\[Gamma]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]]*ScalarProduct[FourMomentum[Incoming, 2], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 2, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  -((cw*gw + g1*sw)^2*(cw*g1 - gw*sw)^2*vev*FeynAmpDenominator[
      PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/4], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 3, Number == 31], 
  Integral[FourMomentum[Internal, 1]], 
  -(cw^2*g1^2*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MW], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/4], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 4, Number == 32], 
  Integral[FourMomentum[Internal, 1]], 
  -(cw^2*g1^2*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MW], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 37], 
  ...
  (3*I)*lam*vev*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((2*I)*C\[Gamma]\[Gamma]*FourVector[FourMomentum[Incoming, 1], 
    ...
    ((2*I)*C\[Gamma]\[Gamma]*MetricTensor[Index[Lorentz, 1], 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 1, Number == 40], 
  Integral[FourMomentum[Internal, 1]], (-I/2)*gw^2*vev*
   ...
   (I*gw^2*sw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
    I*gw^2*sw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] - 
    (2*I)*gw^2*sw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]]]
ins1=
TopologyList[Process -> {V[1], V[1]} -> {S[1]}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[1], 
     ...
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], Field[4] -> V[1], 
      Field[5] -> S[1], Field[6] -> S[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], Field[4] -> V[2], 
      Field[5] -> S[1], Field[6] -> S[1]], FeynmanGraph[1, Particles == 3][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], 
      Field[4] -> -V[3], Field[5] -> S[3], Field[6] -> -S[3]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> V[1], Field[2] -> V[1], 
      Field[3] -> S[1], Field[4] -> V[3], Field[5] -> -S[3], 
      Field[6] -> S[3]]], FeynmanGraph[1, Generic == 6][Field[1] -> V[1], 
     Field[2] -> V[1], Field[3] -> S[1], Field[4] -> S, Field[5] -> V, 
     Field[6] -> V] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> V[1], Field[6] -> V[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> V[1], Field[6] -> V[2]], FeynmanGraph[1, Particles == 3][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], Field[4] -> S[1], 
     ...
     FeynmanGraph[1, Particles == 6][Field[1] -> V[1], Field[2] -> V[1], 
      Field[3] -> S[1], Field[4] -> S[3], Field[5] -> -V[3], 
      Field[6] -> V[3]]], FeynmanGraph[1, Generic == 7][Field[1] -> V[1], 
     Field[2] -> V[1], Field[3] -> S[1], Field[4] -> V, Field[5] -> S, 
     Field[6] -> V] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> V[1], Field[2] -> V[1], 
      Field[3] -> S[1], Field[4] -> V[3], Field[5] -> -S[3], 
      Field[6] -> V[3]]], FeynmanGraph[1, Generic == 8][Field[1] -> V[1], 
     Field[2] -> V[1], Field[3] -> S[1], Field[4] -> V, Field[5] -> V, 
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[1], Field[3] -> S[1], 
