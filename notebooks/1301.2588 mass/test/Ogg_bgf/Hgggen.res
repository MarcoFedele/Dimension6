...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 1]] - I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]]))/sw], FeynAmp[GraphID[Topology == 1, Generic == 2, 
  ...
  6*lam*vev*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
    ...
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, 
  ...
  6*lam*vev*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((-I)*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
    ...
    (I*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, 
   ...
   (((2*I)*(cw^2*cW*gw^2 + cw*cWB*g1*gw*sw + cB*g1^2*sw^2)*vev*
    ...
    ((2*I)*(cw^2*cW*gw^2 + cw*cWB*g1*gw*sw + cB*g1^2*sw^2)*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    ...
    (((I/2)*gw*(-2*LAMBDA^2*sw + gw*(-(cw*cWB*g1) + 2*cW*gw*sw)*vev^2)*
     ...
     I*EL*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 3]] - ((I/2)*gw*(-2*LAMBDA^2*sw + 
   ...
   Particles == 1, Number == 18], Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
   ...
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
    ...
    ((2*I)*(cB*cw^2*g1^2 + gw*sw*(-(cw*cWB*g1) + cW*gw*sw))*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 2, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
   ...
   (((-I)*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
    ...
    (I*(cw^2*cWB*g1*gw + 2*cw*(cB*g1^2 - cW*gw^2)*sw - cWB*g1*gw*sw^2)*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  ...
  (-I/2)*EL*(-MH^2/(2*MW*sw) - MW/(cw^2*sw))*FeynAmpDenominator[
  ...
  (-I)*EL*(-MH^2/(2*MW*sw) - MW/sw)*FeynAmpDenominator[
    PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MW]]*
   (((2*I)*(cB*cw^2*g1^2 + gw*sw*(cw*cWB*g1 + cW*gw*sw))*
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 2, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  (2*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
    MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/sw], 
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
    ...
    (((2*I)*cW*gw^2*vev*FourVector[-FourMomentum[Internal, 1], 
     ...
     ((2*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 5, Generic == 4, Particles == 1, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  (I*EL*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MW], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MW]]*FourVector[-FourMomentum[Outgoing, 1], 
     Index[Lorentz, 3]]*
    ((cw*cWB*g1*gw^2*sw*vev*FourVector[-FourMomentum[Incoming, 1], 
     ...
     (cw*cWB*g1*gw^2*sw*vev*FourVector[FourMomentum[Incoming, 2], 
        ...
        Index[Lorentz, 4]])/LAMBDA^2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])/sw], FeynAmp[GraphID[Topology == 5, Generic == 4, 
   Particles == 2, Number == 27], Integral[FourMomentum[Internal, 1]], 
  ((-I)*EL*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
