...
If[!MatchQ[Coefficient[totale, AAAA], 0] ,
   ...
   Print[""];
   Table[Print["Entry relative to ", c, " : ", Expand[Coefficient[ad, c]] ,"\n"],{c,{cB,cW,cWB}}],
...
If[!MatchQ[Coefficient[total0, AAAA], 0] ,
   ...
   ft = Coefficient[total0/2, AAAA] /. g1^2 + gw^2 -> g1^2/s2 /.
   1/(2 h g1^2 + 2 h gw^2)  -> s2/(2 h (g1^2) ) /.
   1/(4 h g1^2 + 4 h gw^2)  -> s2/(4 h (g1^2) ) /.
   1/(8 h g1^2 + 8 h gw^2)  -> s2/(8 h (g1^2) ) /.
   1/(h g1^2 + h gw^2)  -> s2/(h (g1^2) )/. c2 -> 1 - s2 /.
   B0[0, z, h] -> B0[0, h, z] /. B0[0, z, w] -> B0[0, w, z] /. B0[0, h, w] -> B0[0, w, h];
   
   ft = Collect[ ft, {cB, cW, cWB,
    Log[_], B0[___], C0[___], vev, q1, h, w, z}, Simplify]/. g1^2 + gw^2 -> g1^2/s2;
...
If[!MatchQ[Coefficient[total0, AAAA, 0], 0] ,
   ...
   extraft = Coefficient[total0, AAAA, 0] /. g1^2 + gw^2 -> g1^2/s2 /.
   1/(2 h g1^2 + 2 h gw^2)  -> s2/(2 h (g1^2) ) /.
   1/(4 h g1^2 + 4 h gw^2)  -> s2/(4 h (g1^2) ) /.
   1/(8 h g1^2 + 8 h gw^2)  -> s2/(8 h (g1^2) ) /.
   1/(h g1^2 + h gw^2)  -> s2/(h (g1^2) ) /. c2 -> 1 - s2 /.
   ...
   extraft = Collect[ extraft, {sp[Ep1, Ep2], cB, cW, cWB,
    Log[_], B0[___], C0[___], vev, q1, q2, h, w, z}, Simplify]/. g1^2 + gw^2 -> g1^2/s2;
