...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 5], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      MW*Sqrt[GaugeXi[Q]]]]*(I*(-(cw*g1) + (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 6], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      MW*Sqrt[GaugeXi[Q]]]]*((I*cw*g1 - (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] + I*(-(cw*g1) + (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
    ((I*cw*g1 - (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
     I*(-(cw*g1) + (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 3, Number == 7], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      MW*Sqrt[GaugeXi[Q]]]]*(((-I)*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*vev^2)*
       FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/LAMBDA^2 + 
     ((-I)*cw*g1 + (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 8], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      MW*Sqrt[GaugeXi[Q]]]]*(((-I)*cw*g1 + (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] - (I*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*vev^2)*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2)*
    (((-I)*cw*g1 + (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
     (I*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*vev^2)*
  ...
  I*(((-I)*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
   ...
   ((I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 7]]*(((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] - (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + 
       cw*cWB*g1*gw^2*vev^2)*FourVector[FourMomentum[Incoming, 2], 
  ...
  I*((I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
   ...
   (((-I)*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     (((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 7]] + I*(cw*g1 - (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 7]] - 
    (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 2, Number == 18], 
  ...
  (gw^2*vev*((4*cw^2*g1^2*lam)/gw^2 + cw^2*g1^2*GaugeXi[Q])*
   ...
   Particles == 1, Number == 20], Integral[FourMomentum[Internal, 1]], 0], 
  ...
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
   ...
   ((I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    I*(cw*g1 - (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
    FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 5]]*(((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] - (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + 
       cw*cWB*g1*gw^2*vev^2)*FourVector[FourMomentum[Incoming, 2], 
  ...
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
   ...
   (((-I)*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     (((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 5]] + I*(cw*g1 - (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 5]] - 
    (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
  ...
  -((((-I)*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
     ...
     I*(cw*g1 - (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 5]] + FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 3]]*(((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
        (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 5]] - (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2)*
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])/LAMBDA^2 + 
   ...
   Particles == 1, Number == 33], Integral[FourMomentum[Internal, 1]], 0], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 36], 
  ...
  ((I/2)*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (((4*I)*cw^2*(cB + cW + cWB)*g1^2*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 1]])/LAMBDA^2 + 
     (I/2)*(4*cw^2*g1^2 - (8*cw^4*cWB*g1^4*vev^2)/LAMBDA^2)*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]] - 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  (-2*cw^4*cWB*g1^4*gw^2*vev^3*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  -(((I*(-(cw^2*g1^2*LAMBDA^2) + 2*cw^4*cWB*g1^4*vev^2 + 
        (cw^2*g1^2*LAMBDA^2 - 2*cw^4*cWB*g1^4*vev^2)*GaugeXi[Q])*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/
      (LAMBDA^2*GaugeXi[Q]) + (I*(-(cw^2*g1^2*LAMBDA^2) + 
        2*cw^4*cWB*g1^4*vev^2 + (cw^2*g1^2*LAMBDA^2 - 2*cw^4*cWB*g1^4*vev^2)*
         GaugeXi[Q])*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]])/
      (LAMBDA^2*GaugeXi[Q]) + ((-2*I)*cw^2*g1^2 + ((4*I)*cw^4*cWB*g1^4*vev^2)/
