...
process1 = {F[12], -F[11]} -> {S[1], S[1], S[1]};

top = CreateTopologies[1, 2 -> 3, Adjacencies -> {3, 4, 5}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top[[28 ;; 34 ;; 3]], process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V}, InsertionLevel->{Particles} ];
