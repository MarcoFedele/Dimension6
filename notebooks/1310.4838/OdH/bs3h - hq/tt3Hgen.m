...
ins1 = InsertFields[ top[[{36, 37, 39, 40, 42, 43, 45, 46, 48, 49, 51, 52}]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V, F[7|10|16|19]}, InsertionLevel->{Particles} ];
