...
process1 = {F[11], -F[21]} -> {S[1], S[1], S[1]};

top = CreateTopologies[1, 2 -> 3, Adjacencies -> {3, 5}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top, process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V}, InsertionLevel->{Particles} ];
