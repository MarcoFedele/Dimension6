...
process1 = {F[9], -F[9]} -> {S[1], V[4]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Internal, Tadpoles} ];

 ins1 = InsertFields[ top[[{1,2,4}]], process1, Model -> "Mine/1310.4838", GenericModel -> "Mine/1310.4838", ExcludeParticles -> {V, F[1|4|7|10]}, InsertionLevel->{Particles} ];
...
FILE = NotebookDirectory[]<>"ttHGgen.res";
