...
FeynAmpList[Process -> {{F[9, {Index[Colour, 1]}], FourMomentum[Incoming, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((FermionChain[HC[yu[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    (cqd11133*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     cqd81133*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 3]]*
  ...
  ((FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cud11331*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
      IndexDelta[Index[Colour, 3], Index[Colour, 4]] + 
     cud81331*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
  ...
  ((FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cud11331*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     cud81331*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 3]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
  ...
  ((FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cud11133*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     cud81133*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 3]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 8], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cqu13113*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
      IndexDelta[Index[Colour, 3], Index[Colour, 4]] + 
     cqu83113*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 3]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 10], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[-((HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 4, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[-((HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yu[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    (cqd11331*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
      IndexDelta[Index[Colour, 3], Index[Colour, 4]] + 
     cqd81331*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 3]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 2, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yu[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 3, Number == 14], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yu[3, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 4, Number == 15], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[(HC[yu[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
         NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 5, Number == 16], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[(HC[yu[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 6, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 18], 
  ...
  ((FermionChain[((-I)*HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    (2*(cqq31331 + cqq33113)*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     (cqq11133 + cqq13311 - cqq31133 - cqq33311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*IndexDelta[Index[Colour, 3], Index[Colour, 4]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[((-I)*HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
         NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    (2*(cqq31133 + cqq33311)*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     (cqq11331 + cqq13113 - cqq31331 - cqq33113)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*IndexDelta[Index[Colour, 3], Index[Colour, 4]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 3, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[-((HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
          NonCommutative[ChiralityProjector[1]]))/Sqrt[2]), 
      NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 4, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[-((HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
          NonCommutative[ChiralityProjector[1]]))/Sqrt[2]), 
      NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 5, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]), NonCommutative[
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
      ...
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    ((cqq11133 + cqq13311 - cqq31133 - cqq33311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 4]]*IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     2*(cqq31331 + cqq33113)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
      IndexDelta[Index[Colour, 3], Index[Colour, 4]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 6, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]), NonCommutative[
       DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2]]], 
    ...
    ((cqq11331 + cqq13113 - cqq31331 - cqq33113)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 4]]*IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     2*(cqq31133 + cqq33311)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
      IndexDelta[Index[Colour, 3], Index[Colour, 4]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
  ...
  ((FermionChain[HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cqu13311*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 3]] + 
     cqu83311*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 3]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2]]
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[6] -> F[16, {Index[Colour, 1]}], Field[7] -> 
       F[21, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[18, {Index[Colour, 1]}], Field[7] -> 
       F[19, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[16, {Index[Colour, 1]}], Field[7] -> 
       F[21, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[3], 
      Field[6] -> F[19, {Index[Colour, 1]}], Field[7] -> 
       F[18, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[3], 
      Field[6] -> F[21, {Index[Colour, 1]}], Field[7] -> 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> F[16, {Index[Colour, 1]}], Field[7] -> 
       -F[10, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> F[18, {Index[Colour, 1]}], Field[7] -> 
       -F[12, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[16, {Index[Colour, 1]}], Field[7] -> 
       -F[10, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[18, {Index[Colour, 1]}], Field[7] -> 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> -F[8, {Index[Colour, 2]}], Field[7] -> 
       F[20, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> -F[9, {Index[Colour, 2]}], Field[7] -> 
       F[21, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> -F[7, {Index[Colour, 2]}], Field[7] -> 
       F[19, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> -F[8, {Index[Colour, 2]}], Field[7] -> 
       F[20, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> -F[9, {Index[Colour, 2]}], Field[7] -> 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> -F[7, {Index[Colour, 2]}], Field[7] -> 
       -F[12, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> -S[3], 
      Field[6] -> -F[10, {Index[Colour, 2]}], 
      Field[7] -> -F[9, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> -S[3], 
      Field[6] -> -F[12, {Index[Colour, 2]}], 
      Field[7] -> -F[7, {Index[Colour, 4]}]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[16, {Index[Colour, 2]}], Field[3] -> F[10, {Index[Colour, 3]}], 
      Field[4] -> -F[21, {Index[Colour, 4]}], Field[5] -> -S[3], 
      Field[6] -> F[16, {Index[Colour, 3]}], Field[7] -> 
       -F[9, {Index[Colour, 4]}]]]]]
