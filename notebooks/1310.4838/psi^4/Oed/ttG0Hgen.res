...
FeynAmpList[Process -> {{F[13], FourMomentum[Incoming, 1], 0, 
      ...
      {Q, -LeptonNumber}}} -> {{F[21, {Index[Colour, 3]}], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (cld1133*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    (FermionChain[((-I)*HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[
      ...
      ((-I)*(NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]])*yl[1, 1])/Sqrt[2]] + 
     FermionChain[((-I)*HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[
           -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1]]], NonCommutative[
  ...
  (cld2233*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[-1]]] + FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
    (FermionChain[((-I)*HC[yl[2, 1]]*(NonCommutative[ChiralityProjector[
           -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1]]], NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
  ...
  (cld3333*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[-1]]] + FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
    (FermionChain[((-I)*HC[yl[3, 1]]*(NonCommutative[ChiralityProjector[
           -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1]]], NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
  ...
  (cld2233*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[-1]]] + FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
    (FermionChain[-((HC[yl[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
          NonCommutative[ChiralityProjector[1]]))/Sqrt[2]), 
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1]]], NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
    ...
    (FermionChain[HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
     ...
     FermionChain[HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
      ...
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         ...
         FourMomentum[Outgoing, 2]]], 
      -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]])*yl[1, 1])])*FeynAmpDenominator[
    ...
    (FermionChain[HC[yl[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
     ...
     FermionChain[HC[yl[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
      ...
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         ...
         FourMomentum[Outgoing, 2]]], 
      -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]])*yl[2, 1])])*FeynAmpDenominator[
     PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
    ...
    (FermionChain[HC[yl[3, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
     ...
     FermionChain[HC[yl[3, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
      ...
      NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
         ...
         FourMomentum[Outgoing, 2]]], 
      -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]])*yl[3, 1])])*FeynAmpDenominator[
     PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
  ...
  ((-I)*FermionChain[
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 2, Number == 11], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[cHd33*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
      (NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
       ...
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]], ChiralityProjector[1]])]*
    FermionChain[((-I)*HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
     NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
     ((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ChiralityProjector[1]])*yl[1, 1])/Sqrt[2]]*
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 3, Number == 12], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[
     cHd33*(-NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
           FourMomentum[Internal, 1]], ChiralityProjector[-1]] - 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 4, Number == 13], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[cHd33*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
      (NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
       ...
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]], ChiralityProjector[1]])]*
    FermionChain[((-I)*HC[yl[2, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
     NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
     ((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ChiralityProjector[1]])*yl[2, 1])/Sqrt[2]]*
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 5, Number == 14], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[
     cHd33*(-NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
           FourMomentum[Internal, 1]], ChiralityProjector[-1]] - 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 6, Number == 15], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[cHd33*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
      (NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
       ...
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]], ChiralityProjector[1]])]*
    FermionChain[((-I)*HC[yl[3, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
     NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
     ((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ChiralityProjector[1]])*yl[3, 1])/Sqrt[2]]*
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 7, Number == 16], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*cHd33*(NonCommutative[DiracSlash[
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 8, Number == 17], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*cHd33*(NonCommutative[DiracSlash[
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1]], 
        ChiralityProjector[-1]] + NonCommutative[DiracSlash[
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1]], 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 9, Number == 18], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*cHd33*(NonCommutative[DiracSlash[
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1]], 
        ChiralityProjector[-1]] + NonCommutative[DiracSlash[
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1]], 
  ...
  ((-I)*FermionChain[cHe11*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
        ChiralityProjector[-1]] + NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
        ChiralityProjector[1]] - NonCommutative[DiracSlash[
  ...
  ((-I)*FermionChain[
     cHe11*(-NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
  ...
  ((-I)*FermionChain[I*cHe11*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
        ChiralityProjector[-1]] + NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
        ChiralityProjector[1]] - NonCommutative[DiracSlash[
  ...
  ((-I)*FermionChain[I*cHe11*(NonCommutative[DiracSlash[
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2]]
ins1=
TopologyList[Process -> {F[13], -F[13]} -> {F[21, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[13], 
     Field[2] -> -F[13], Field[3] -> -F[21, {Index[Colour, 3]}], 
     Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S, Field[6] -> F, 
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> F[4], Field[7] -> -F[4]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> F[5], Field[7] -> -F[5]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> F[6], Field[7] -> -F[6]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[4], Field[7] -> -F[4]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[2], Field[6] -> F[5], Field[7] -> -F[5]], 
     FeynmanGraph[1, Particles == 6][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[6], Field[7] -> -F[6]], FeynmanGraph[1, Particles == 7][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -S[3], Field[6] -> F[1], Field[7] -> -F[1]], 
     FeynmanGraph[1, Particles == 8][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> -S[3], 
      Field[6] -> F[2], Field[7] -> -F[2]], FeynmanGraph[1, Particles == 9][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -S[3], Field[6] -> F[3], Field[7] -> -F[3]]], 
   FeynmanGraph[1, Generic == 2][Field[1] -> F[13], Field[2] -> -F[13], 
     Field[3] -> -F[21, {Index[Colour, 3]}], 
     Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F, Field[6] -> S, 
     Field[7] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> F[4], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F[4], 
      Field[6] -> S[2], Field[7] -> S[1]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> F[5], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F[5], 
      Field[6] -> S[2], Field[7] -> S[1]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> F[6], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 6][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F[6], 
      Field[6] -> S[2], Field[7] -> S[1]], FeynmanGraph[1, Particles == 7][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> F[1], Field[6] -> -S[3], Field[7] -> S[3]], 
     FeynmanGraph[1, Particles == 8][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F[2], 
      Field[6] -> -S[3], Field[7] -> S[3]], FeynmanGraph[1, Particles == 9][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> F[3], Field[6] -> -S[3], Field[7] -> S[3]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[13], 
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> -F[12, {Index[Colour, 3]}], 
      Field[7] -> F[12, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[2], Field[6] -> -F[12, {Index[Colour, 3]}], 
      Field[7] -> F[12, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> S[3], Field[6] -> -F[9, {Index[Colour, 3]}], 
      Field[7] -> F[9, {Index[Colour, 4]}]]], 
   FeynmanGraph[1, Generic == 2][Field[1] -> F[13], Field[2] -> -F[13], 
     Field[3] -> -F[21, {Index[Colour, 3]}], 
     Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> F, Field[6] -> S, 
     Field[7] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[13], Field[2] -> -F[13], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -F[10, {Index[Colour, 3]}], Field[6] -> S[1], 
      Field[7] -> S[2]], FeynmanGraph[1, Particles == 2][Field[1] -> F[13], 
      Field[2] -> -F[13], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
       -F[10, {Index[Colour, 3]}], Field[6] -> S[2], Field[7] -> S[1]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 5][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 7][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 9][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
