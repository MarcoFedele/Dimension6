...
process1 = {F[1], -F[13]} -> {F[9], -F[21]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles} ];

 ins1 = InsertFields[ top[[{1,2,3,4,5,6,28,41,46,50,55,57}]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V}, InsertionLevel->{Particles} ];
