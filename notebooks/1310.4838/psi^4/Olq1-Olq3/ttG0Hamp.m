...
amp21 = Expand[amp21] //. {SumOver[___,External] -> 1, DELTA[___] -> 1, IndexSum[SUNT[Gluon$1,Index[Colour,a_],Index[Colour,b_]] SUNT[Gluon$1,Index[Colour,b_],Index[Colour,c_]],{Gluon$1,1,8}]SumOver[Index[Colour,b_],3] -> CF, SumOver[Index[Colour,b_],3] -> NC};
col1 = col1 //. {SumOver[___,External] -> 1, DELTA[___] -> 1, IndexSum[SUNT[Gluon$1,Index[Colour,a_],Index[Colour,b_]] SUNT[Gluon$1,Index[Colour,b_],Index[Colour,c_]],{Gluon$1,1,8}]SumOver[Index[Colour,b_],3] -> CF, SumOver[Index[Colour,b_],3] -> NC};
...
amp22 = Expand[amp22] //. {SumOver[___,External] -> 1, DELTA[___] -> 1, IndexSum[SUNT[Gluon$1,Index[Colour,a_],Index[Colour,b_]] SUNT[Gluon$1,Index[Colour,b_],Index[Colour,c_]],{Gluon$1,1,8}]SumOver[Index[Colour,b_],3] -> CF, SumOver[Index[Colour,b_],3] -> NC};
col2 = col2 //. {SumOver[___,External] -> 1, DELTA[___] -> 1, IndexSum[SUNT[Gluon$1,Index[Colour,a_],Index[Colour,b_]] SUNT[Gluon$1,Index[Colour,b_],Index[Colour,c_]],{Gluon$1,1,8}]SumOver[Index[Colour,b_],3] -> CF, SumOver[Index[Colour,b_],3] -> NC};
