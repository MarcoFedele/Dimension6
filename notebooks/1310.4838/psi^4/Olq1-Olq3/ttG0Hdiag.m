...
Paint[DiagramExtract[ins1, finaldiag], DisplayFunction -> (Export["vvbb_included.pdf",#]&), ColumnsXRows ->{3,4}];
...
Paint[DiagramExtract[ins2, finaldiag], DisplayFunction -> (Export["vvtt_included.pdf",#]&), ColumnsXRows ->{3,4}];
Print["Included diagrams printed"];
