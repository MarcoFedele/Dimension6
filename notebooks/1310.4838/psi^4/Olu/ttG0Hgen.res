...
FeynAmpList[Process -> {{F[4], FourMomentum[Incoming, 1], 0, 
      {-Q, LeptonNumber}}, {-F[4], FourMomentum[Incoming, 2], 0, 
      {Q, -LeptonNumber}}} -> {{F[18, {Index[Colour, 3]}], 
      FourMomentum[Outgoing, 1], 0, {(2*Q)/3}}, {-F[18, {Index[Colour, 4]}], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((-I)*FermionChain[cHu33*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 5, Number == 11], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[
     cHu33*(-NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
           FourMomentum[Internal, 1]], ChiralityProjector[-1]] - 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 6, Number == 12], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[cHu33*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
      (NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
  ...
  -((FermionChain[NonCommutative[ChiralityProjector[-1]], 
        NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
           FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
           FourMomentum[Outgoing, 2]]], ((-I)*HC[yl[1, 1]]*
          (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]]))/Sqrt[2]]*
       (2*clequ11133*FermionChain[((-I)*HC[yu[3, 3]]*
            (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
        ...
        2*clequ11133*FermionChain[((-I)*HC[yu[3, 3]]*
           ...
           DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
              1]]], NonCommutative[ChiralityProjector[1]]] + 
        clequ31133*(FermionChain[((-I)*HC[yu[3, 3]]*
             (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
               ChiralityProjector[1]]))/Sqrt[2], NonCommutative[
            DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
               1]]], NonCommutative[DiracMatrix[Index[Lorentz, a]], 
            DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
        ...
        clequ31133*(FermionChain[((-I)*HC[yu[3, 3]]*
          ...
          FermionChain[((-I)*HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
           ...
           NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
              FourMomentum[Outgoing, 1]]], NonCommutative[
            DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, a]], 
            ChiralityProjector[1]]])) + clequ31133*
       (FermionChain[((-I)*HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
               -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
          NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
             FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
            -1]]]*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, 
              a]], DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
           NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
              FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
              FourMomentum[Outgoing, 2]]], ((-I)*HC[yl[1, 1]]*
             (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
        ...
        FermionChain[((-I)*HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
          ...
          NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
           ...
           NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
             ...
             (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
               ChiralityProjector[1]]))/Sqrt[2]]) - 
        2*(FermionChain[((-I)*HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
                -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
           NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
              FourMomentum[Outgoing, 1]]], NonCommutative[
     ...
     IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
     SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
      External])/(2*LAMBDA^2)], FeynAmp[GraphID[Topology == 2, Generic == 1, 
  ...
  -((FermionChain[NonCommutative[ChiralityProjector[-1]], 
        ...
        -((HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
            NonCommutative[ChiralityProjector[1]]))/Sqrt[2])]*
       (2*clequ11133*FermionChain[(HC[yu[3, 3]]*(NonCommutative[
              ChiralityProjector[-1]] + NonCommutative[ChiralityProjector[
               1]]))/Sqrt[2], NonCommutative[DiracSlash[
            -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
        ...
        2*clequ11133*FermionChain[(HC[yu[3, 3]]*(NonCommutative[
            ...
            -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
          NonCommutative[ChiralityProjector[1]]] + 
        clequ31133*(FermionChain[(HC[yu[3, 3]]*(NonCommutative[
               ChiralityProjector[-1]] + NonCommutative[ChiralityProjector[
                1]]))/Sqrt[2], NonCommutative[DiracSlash[
             -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
           NonCommutative[DiracMatrix[Index[Lorentz, a]], 
            DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
          FermionChain[(HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
                -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
           NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
              FourMomentum[Outgoing, 1]]], NonCommutative[
            DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, a]], 
       ...
       (FermionChain[(HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        ...
        FermionChain[(HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
          ...
          FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
           ...
           -((HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
               NonCommutative[ChiralityProjector[1]]))/Sqrt[2])]) - 
        2*(FermionChain[(HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
                -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
           NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
              FourMomentum[Outgoing, 1]]], NonCommutative[
            DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, b]], 
  ...
  -(((clequ11133*FermionChain[NonCommutative[ChiralityProjector[-1]], 
        NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 2]]], ((-I)*IndexDelta[Index[Colour, 3], 
       ...
       (FermionChain[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
         ...
         NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
           ...
           -1]]] + FermionChain[((-I)*(NonCommutative[ChiralityProjector[
              -1]] + NonCommutative[ChiralityProjector[1]])*yl[1, 1])/
          Sqrt[2], NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
            FourMomentum[Internal, 1]]], NonCommutative[ChiralityProjector[
           1]]]) + clequ11133*FermionChain[NonCommutative[
         ChiralityProjector[1]], NonCommutative[DiracSlash[
       ...
       (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ...
         (FermionChain[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
           ...
           NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
            ...
            Index[Lorentz, a]], DiracMatrix[Index[Lorentz, a]], 
           ChiralityProjector[1]], NonCommutative[DiracSlash[
            FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
          ((-I)*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
            (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ...
         (FermionChain[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
           ...
           NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
            ...
            Sqrt[2], NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
              FourMomentum[Internal, 1]]], NonCommutative[ChiralityProjector[
             1]]]) - (FermionChain[NonCommutative[DiracMatrix[
             Index[Lorentz, a]], DiracMatrix[Index[Lorentz, b]], 
            ChiralityProjector[-1]], NonCommutative[DiracSlash[
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
           ((-I)*IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
             (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
   ...
   Particles == 2, Number == 16], Integral[FourMomentum[Internal, 1]], 
  -(((clequ11133*FermionChain[NonCommutative[ChiralityProjector[-1]], 
        NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 2]]], 
        -((IndexDelta[Index[Colour, 3], Index[Colour, 4]]*
       ...
       (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ...
         (FermionChain[((NonCommutative[ChiralityProjector[-1]] + 
           ...
           NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
            ...
            ChiralityProjector[-1]], NonCommutative[DiracSlash[
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
           -((IndexDelta[Index[Colour, 3], Index[Colour, 4]]*(NonCommutative[
                ChiralityProjector[-1]] + NonCommutative[ChiralityProjector[
                 1]])*yu[3, 3])/Sqrt[2])] + FermionChain[NonCommutative[
            DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, b]], 
            ChiralityProjector[1]], NonCommutative[DiracSlash[
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
           -((IndexDelta[Index[Colour, 3], Index[Colour, 4]]*(NonCommutative[
  ...
  ((clq11111 - clq31111)*(FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
     FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[1]]])*
    (FermionChain[((-I)*HC[yu[1, 3]]*(NonCommutative[ChiralityProjector[
           -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
      NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]]], NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
  ...
  ((clq11133 - clq31133)*(FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
     FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[1]]])*
    (FermionChain[((-I)*HC[yu[3, 3]]*(NonCommutative[ChiralityProjector[
  ...
  ((clq11111 + clq31111)*(FermionChain[NonCommutative[
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 1, 
   Particles == 6, Number == 22], Integral[FourMomentum[Internal, 1]], 
  ((clq11133 + clq31133)*(FermionChain[NonCommutative[
       DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
     FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[1]]])*
  ...
  ((-I)*FermionChain[-((cHl111 + cHl311)*
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 3, Number == 25], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(cHl111 + cHl311)*
      (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 4, Number == 26], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[-((cHl111 + cHl311)*
       (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
        NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 5, Number == 27], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(cHl111 + cHl311)*
      (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 6, Number == 28], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[-((cHl111 + cHl311)*
       (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
        NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 7, Number == 29], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(-I)*(cHl111 - cHl311)*
      (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[1]] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 8, Number == 30], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(-I)*(cHl111 - cHl311)*
      (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2], FeynAmp[GraphID[Topology == 4, Generic == 2, 
   Particles == 9, Number == 31], Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(-I)*(cHl111 - cHl311)*
      (NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]], ChiralityProjector[-1]] + 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2]]
ins1=
TopologyList[Process -> {F[4], -F[4]} -> {F[18, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[4], 
     Field[2] -> -F[4], Field[3] -> -F[18, {Index[Colour, 3]}], 
     Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> S, Field[6] -> F, 
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> F[13], Field[7] -> -F[13]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> S[1], 
      Field[6] -> F[14], Field[7] -> -F[14]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> F[15], Field[7] -> -F[15]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[13], Field[7] -> -F[13]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[2], Field[6] -> F[14], Field[7] -> -F[14]], 
     FeynmanGraph[1, Particles == 6][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> F[15], Field[7] -> -F[15]]], 
   FeynmanGraph[1, Generic == 2][Field[1] -> F[4], Field[2] -> -F[4], 
     Field[3] -> -F[18, {Index[Colour, 3]}], 
     Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> F, Field[6] -> S, 
     Field[7] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> F[13], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      ...
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> F[14], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> F[14], 
      Field[6] -> S[2], Field[7] -> S[1]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> F[15], Field[6] -> S[1], Field[7] -> S[2]], 
     FeynmanGraph[1, Particles == 6][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> F[15], 
      Field[6] -> S[2], Field[7] -> S[1]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[4], 
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> -F[7, {Index[Colour, 3]}], 
      Field[7] -> F[7, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[1], Field[6] -> -F[9, {Index[Colour, 3]}], 
      Field[7] -> F[9, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[2], Field[6] -> -F[7, {Index[Colour, 3]}], 
      Field[7] -> F[7, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> S[2], Field[6] -> -F[9, {Index[Colour, 3]}], 
      Field[7] -> F[9, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> -S[3], Field[6] -> -F[10, {Index[Colour, 3]}], 
      Field[7] -> F[10, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> -S[3], Field[6] -> -F[12, {Index[Colour, 3]}], 
   ...
   FeynmanGraph[1, Generic == 2][Field[1] -> F[4], Field[2] -> -F[4], 
     ...
     Field[7] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[4], Field[2] -> -F[4], Field[3] -> 
       -F[18, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}], 
      Field[5] -> -F[7, {Index[Colour, 3]}], Field[6] -> S[1], 
      Field[7] -> S[2]], FeynmanGraph[1, Particles == 2][Field[1] -> F[4], 
      Field[2] -> -F[4], Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
       -F[7, {Index[Colour, 3]}], Field[6] -> S[2], Field[7] -> S[1]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 5][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 7][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
       -F[10, {Index[Colour, 3]}], Field[6] -> -S[3], Field[7] -> S[3]], 
     FeynmanGraph[1, Particles == 8][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
       -F[11, {Index[Colour, 3]}], Field[6] -> -S[3], Field[7] -> S[3]], 
     FeynmanGraph[1, Particles == 9][Field[1] -> F[4], Field[2] -> -F[4], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}], Field[5] -> 
