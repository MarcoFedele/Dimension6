...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES for Oee1133-Oee3311."]; (* il fattore 4 viene dalla base LR, il fattore 2 dal mixing aabb-bbaa *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] / 4 / 2 ] ],"\n"],{c,{cHe11,cHe33,cle1133,cle3311,cle3333}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES for Oee1331-Oee3113."]; (* il fattore 4 viene dalla base LR, il fattore 2 dal mixing abba-baab *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] / 4 / 2 ] ],"\n"],{c,{cHe13,cHe31,cle1133,cle1331,cle3113}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   ...
   WriteString[FILE,"\n"];
   ,{c,{cHe11,cHe13,cHe31,cHe33,cle1133,cle1331,cle3113,cle3311,cle3333}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
