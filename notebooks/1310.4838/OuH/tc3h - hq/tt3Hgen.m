...
process1 = {F[8], -F[18]} -> {S[1], S[1], S[1]};

top = CreateTopologies[1, 2 -> 3, Adjacencies -> {3, 4, 5}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top[[{36, 37, 39, 40, 42, 43, 45, 46, 48, 49, 51, 52}]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V, F[7|16]}, InsertionLevel->{Particles} ];
