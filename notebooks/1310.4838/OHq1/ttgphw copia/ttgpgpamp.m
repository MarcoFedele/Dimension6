...
diag = Color /@ diag;
diag = diag //.  IndexSum[SUNT[Gluon$1,Index[Colour,a_],Index[Colour,b_]]SUNT[Gluon$1,Index[Colour,c_],Index[Colour,c_]],{Gluon$1,1,8}] -> 0 ;
...
FILE = NotebookDirectory[]<>"ttgpgpamp.res";
