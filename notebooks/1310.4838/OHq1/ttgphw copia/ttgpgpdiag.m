...
ftrans[exp_] := Module[
                       ...
                       temp = exp /. FermionChain[AA___] -> MatrixTrace[ AA, NonCommutative[DiracMatrix[ Index[Lorentz,1] ]] ] / nd;
                       
                       (*temp = Expand[ temp FourVector[Ep,Index[Lorentz,1]] ] ;*)
                       temp = Expand[ temp ] ;
...
FILE = NotebookDirectory[]<>"ttgpgpdiag.res";
