...
process1 = {F[9], -F[12]} -> {V[3], S[1], S[1]};

top = CreateTopologies[0, 2 -> 3, Adjacencies -> {3, 4, 5}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top, process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V, F[1|4|7|10|13|16|19]}, InsertionLevel->{Particles} ];
...
FILE = NotebookDirectory[]<>"ttgpgpgen_tree.res";
