...
diag = diag /. {B0[ - q1_ - q2_ , m1_ , m2_ ] -> B0[ q1 + q2 , m1 , m2 ], q1^2 -> 0, q2^2 -> 0, q3^2 -> h, q4^2 -> 0};
diag = diag /. {sp[Ep3, q1] -> 0, sp[Ep3, q2] -> 0} /. {sp[Epa_, q_] :>  sp[q, Epa] /; MatchQ[Epa, Ep3] && ! MatchQ[q, Ep3]};
