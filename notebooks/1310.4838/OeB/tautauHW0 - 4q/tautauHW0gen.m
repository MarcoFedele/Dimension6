...
process1 = {F[6], -F[6]} -> {S[1], V[2]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top, process1, Model -> "Mine/1310.4838", GenericModel -> "Mine/1310.4838", ExcludeParticles -> {V, F[1|4|7|10], S}, InsertionLevel->{Particles} ];
