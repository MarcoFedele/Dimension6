...
top = CreateTopologies[1, 2 -> 3, Adjacencies -> {3, 4, 5}, ExcludeTopologies -> {Internal, Tadpoles} ];
 ...
 ins1 = InsertFields[ top[[{1,6,7,21,22,77}]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V, F[1|4|7|10|13|16|19]}, InsertionLevel->{Particles} ];
...
FILE = NotebookDirectory[]<>"ttgpgpgen.res";
