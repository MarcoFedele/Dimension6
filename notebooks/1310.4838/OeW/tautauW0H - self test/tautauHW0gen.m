...
process1 = {F[6], -F[15]} -> {V[2], S[1]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Internal, Tadpoles} ];

 ins1 = InsertFields[ top[[{3,5}]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V, F[1|4|7|10]}, ExcludeFieldPoints -> {FieldPoint[_][S[1], S[2], V[2]],FieldPoint[_][S[3], S[3], V[2]]}, InsertionLevel->{Particles} ];
...
FILE = NotebookDirectory[]<>"tautauHW0gen.res";
