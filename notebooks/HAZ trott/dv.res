...
3*lam*(1 - Log[h]) + (gw^2*w*(1 - 3*Log[w]))/(2*h) + 
 ((g1^2 + gw^2)*z*(1 - 3*Log[z]))/(4*h) + 
 (gw^2*GaugeXi[Q]*(1 - Log[w*GaugeXi[Q]]))/4 + 
 ((g1^2 + gw^2)*GaugeXi[Q]*(1 - Log[z*GaugeXi[Q]]))/8 - 
 (2*t*(1 - Log[t])*yu[3, 3]^2)/h

########  ANOMALOUS DIMENSION ENTRIES  ########

3*lam + (3*gw^2*w)/(2*h) + (3*g1^2*z)/(4*h) + (3*gw^2*z)/(4*h) + 
 (gw^2*GaugeXi[Q])/4 + ((g1^2 + gw^2)*GaugeXi[Q])/8 - (2*t*yu[3, 3]^2)/h
