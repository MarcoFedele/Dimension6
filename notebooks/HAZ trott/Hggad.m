...
diag = diag /. {gHza -> 0, gHaa -> 0, dsth2 -> 0, dg1 -> 0, dgw -> 0, dGf -> 0,
    dMH2 -> 0, vevhat -> vev, EL -> e, sth -> sw, cth -> cw, LambdaSMEFT -> LAMBDA};

diag = diagSimplify[diag] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;

prefactor = e^2 vev / LAMBDA^2 ;
       ...
       Do[
          If[checkdiag[[DIAG]] == 1,
             Do[
                If[count[[DIAG, TERM]] == {0, 0},
                   ...
                   If[count[[DIAG, TERM]] == {1, 0},
                      temp1 = temp[[DIAG,TERM]] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                      temp1 = temp1 //. PVsub;
                      temp0 = Append[temp0, temp1],
                      If[count[[DIAG, TERM]] == {1, 1},
                         temp1 = ExpandSProducts[temp[[DIAG,TERM]] /. rule11shift /. rule11];
                         temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0};
                         temp1 = temp1 //. PVsub;
                                           ...
                                           If[count[[DIAG, TERM]] == {3, 0},
                                              ...
                                              If[count[[DIAG, TERM]] == {3, 1},
                                                 ...
                                                 If[count[[DIAG,TERM]] == {3, 2},
                                                    ...
                                                    temp1 = temp1 //. PVsub;
                                                    temp0 = Append[temp0, temp1[[1]]],
                                                    If[count[[DIAG,TERM]] == {3, 3},
                                                       temp1 = ExpandSProducts[temp[[DIAG, TERM]] /. rule33 /. rule32 /. rule31];
                                                       temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                       temp1 = ExpandSProducts[temp1 /. rule24 /. rule23 /. rule22shift /. rule22 /. rule21shift /. rule21];
                                                       temp1 = diagSimplify[temp1] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                       temp1 = ExpandSProducts[temp1 /. rule14shift /. rule13 /. rule12shift /. rule12 /. rule11shift /. rule11];
                                                       ...
                                                       temp1 = temp1 //. PVsub;
                                                       temp0 = Append[temp0, temp1[[1]]],
                                                       If[count[[DIAG,TERM]] == {3, 4},
                                                          temp1 = ExpandSProducts[temp[[DIAG, TERM]] /. rule34 /. rule33 /. rule32 /. rule31];
                                                          temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                          temp1 = ExpandSProducts[temp1 /. rule24 /. rule23 /. rule22shift /. rule22 /. rule21shift /. rule21];
                                                          temp1 = diagSimplify[temp1] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                          temp1 = ExpandSProducts[temp1 /. rule14shift /. rule13 /. rule12shift /. rule12 /. rule11shift /. rule11];
             ...
             If[count[[DIAG]][[1]] == {0, 0},
                temp0 = Append[temp0, 0],
                If[count[[DIAG]][[1]] == {1, 0},
                   temp1 = temp[[DIAG]] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0};
                   temp1 = temp1 //. PVsub;
                   temp0 = Append[temp0, temp1],
                   If[count[[DIAG]] == {1, 1},
                                        ...
                                        If[count[[DIAG]][[1]] == {3, 0},
                                           ...
                                           If[count[[DIAG]][[1]] == {3, 1},
                                              ...
                                              If[count[[DIAG]][[1]] == {3, 2},
                                                 ...
                                                 temp0 = Append[temp0, temp1[[1]]],
                                                 If[count[[DIAG]][[1]] == {3, 3},
                                                    temp1 = ExpandSProducts[temp[[DIAG]] /. rule33 /. rule32 /. rule31];
                                                    temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                    temp1 = ExpandSProducts[temp1 /. rule24 /. rule23 /. rule22shift /. rule22 /. rule21shift /. rule21];
                                                    temp1 = diagSimplify[temp1] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                    temp1 = ExpandSProducts[temp1 /. rule14shift /. rule13 /. rule12shift /. rule11shift /. rule12 /. rule11];
                                                    ...
                                                    temp0 = Append[temp0, temp1[[1]]],
                                                    If[count[[DIAG]][[1]] == {3, 4},
                                                       temp1 = ExpandSProducts[temp[[DIAG]] /. rule34 /. rule34 /. rule32 /. rule31];
                                                       temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                       temp1 = ExpandSProducts[temp1 /. rule24 /. rule23 /. rule22shift /. rule22 /. rule21shift /. rule21];
                                                       temp1 = diagSimplify[temp1] /. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> z^(n/2) /; n > 0} ;
                                                       temp1 = ExpandSProducts[temp1 /. rule14shift /. rule13 /. rule12shift /. rule11shift /. rule12 /. rule11];
          ...
          tempprint = PrintTemporary["PV :", DIAG ,"/",Length[checkdiag]];
...
(*total = total + c\[Gamma]Z (HWF+ 2 dv) 4 AAAA /. A0[m_] -> - m Log[m] + m;*)
total = total /. sp[q1, Ep2] sp[q2, Ep1] -> AAAA + sp[Ep1, Ep2] sp[q1, q2] /. sp[q1, q2] -> (h-z)/2;
total = total /. cHB -> - c\[Gamma]Z gw/g1 + cHW gw^2/g1^2 - cHWB (gw^2 - g1^2)/(2 g1^2);
...
If[!MatchQ[Coefficient[totale, AAAA], 0] ,
   ...
   Print[""];
   Table[Print["Entry relative to ", c, " : ", Expand[Simplify[Coefficient[-2*ad/4, c]]] ,"\n"],{c,{c\[Gamma]Z,CHB,cHW,cHWB}}],

   Print["Total Entry : ", Collect[-2*ad/4, {cHbox, cHD, cHW, cHB, cHWB, c\[Gamma]Z} ,Simplify ] ,"\n"]
...
If[!MatchQ[Coefficient[total0, AAAA], 0] ,
   ...
   ft = Collect[ Coefficient[total0/4, AAAA], {e, c\[Gamma]Z, cHbox, cHD, cHW, cHB, cHWB, Log[_], B0[___], C0[___]}, Simplify];
