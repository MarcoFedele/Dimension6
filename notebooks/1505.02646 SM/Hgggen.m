...
ins1 = InsertFields[ top, process1, Model -> "Mine/1505.02646.bgf", GenericModel -> "Mine/1505.02646.bgf", ExcludeParticles -> {F[1|2|3|4, {1, ___}], F[1|2|3|4, {2, ___}], F[1|2|4, {3, ___}], V[1]}, InsertionLevel->{Particles} ];
