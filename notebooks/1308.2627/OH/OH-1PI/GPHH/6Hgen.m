...
process1 = {S[3], S[1], S[1]} -> {S[3], S[1], S[1]};
 ...
 top = CreateTopologies[1, 3 -> 3, Adjacencies -> {3, 4, 5, 6}, ExcludeTopologies -> {Internal, Tadpoles} ];
 
 ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F}, InsertionLevel->{Particles} ];
