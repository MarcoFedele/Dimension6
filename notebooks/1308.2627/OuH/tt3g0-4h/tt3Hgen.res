  ...
  (I/2)*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
   ...
   (6*lam + (3*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
    ...
    ((2*cHBOX + cHD)*ScalarProduct[-FourMomentum[Outgoing, 2], 
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]])/LAMBDA^2 + 
    (3*cHBOX*ScalarProduct[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
         1] + FourMomentum[Outgoing, 2], FourMomentum[Internal, 1] + 
   ...
   (6*lam + (3*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
    ...
    (3*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 3], 
       -FourMomentum[Outgoing, 3]])/LAMBDA^2 + 
    ((2*cHBOX + cHD)*ScalarProduct[-FourMomentum[Outgoing, 3], 
       FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2] + 
        FourMomentum[Outgoing, 3]])/LAMBDA^2 + 
   ...
   SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
    External]], FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 4, 
  ...
  (I/2)*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
   ...
   (6*lam + (3*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
    ...
    (3*cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])/LAMBDA^2)*
   SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
    External]], FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 4, 
  ...
  (I/2)*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
   ...
   (6*lam + (3*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
    ...
    (3*cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])/LAMBDA^2)*
   SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
    External]], FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 4, 
...
TopologyList[Process -> {F[9, {Index[Colour, 1]}], 
     -F[9, {Index[Colour, 2]}]} -> {S[2], S[2], S[2]}, 
  Model -> {"Mine/1308.2627.4f"}, GenericModel -> {"Mine/1308.2627.4f"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][6], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
     Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
      -F[9, {Index[Colour, 2]}], Field[3] -> S[2], Field[4] -> S[2], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[8] -> S[3]], FeynmanGraph[2, Particles == 2][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[2], Field[4] -> S[2], 
      Field[5] -> S[2], Field[6] -> S[2], Field[7] -> S[1], 
      Field[8] -> S[1]], FeynmanGraph[2, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[2], Field[4] -> S[2], 
      Field[5] -> S[2], Field[6] -> S[2], Field[7] -> S[2], 
      Field[8] -> S[2]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[2], Field[4] -> S[2], 
