...
FeynAmpList[Process -> {{V[2], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]])/2 - (g1*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 2]])/2)*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((I/2)*g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1], Index[Lorentz, 2]] - 
    (I/2)*g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
   ((I/2)*gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
    (I/2)*gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
      ...
      Index[Lorentz, 1]])*((-2*I)*lam - 
    (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1], FourMomentum[Incoming, 2] + FourMomentum[Internal, 1]])/
     LAMBDA^2 - ((I/2)*cHD*ScalarProduct[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], -FourMomentum[Outgoing, 1]])/LAMBDA^2 - 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 5], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   ((gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 - 
    (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 1]])/2)*MetricTensor[Index[Lorentz, 3], 
    Index[Lorentz, 4]]*(((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/LAMBDA^2 - 
    (I*cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
       FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
       Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2 - 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 2, Number == 6], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
   ...
   ((cWB*g1*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]])/LAMBDA^2 + 
    (cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
       FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
       Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2 + 
    (g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/2 - 
    (cWB*g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 4, Number == 8], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
     ...
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MH]]*
   (-(g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (g1*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2)*
   ((gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 - 
    (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 1]])/2)*MetricTensor[Index[Lorentz, 3], 
    Index[Lorentz, 4]]*(((2*I)*cB*g1^2*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    ((2*I)*cBt*g1^2*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
       FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
       Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2 + 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 1, Number == 9], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]])/2 + 
    ...
    Index[Lorentz, 4]]*((-I)*gw*FourVector[FourMomentum[Incoming, 1], 
   ...
   ((cWB*g1*gw*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
    ...
    (g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]])/2 + 
    (cWB*g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    (I*cWB*g1*gw*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   ((gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 - 
    (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       ...
       Index[Lorentz, 1]])/2)*
   (-(g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (g1*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]])/2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   (((2*I)*cB*g1^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    ((2*I)*cB*g1^2*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 1, Number == 15], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     0], PropagatorDenominator[FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 17], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   ((gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 - 
    (gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   (((2*I)*cW*gw^2*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])/LAMBDA^2 + 
    ((2*I)*cWt*gw^2*LeviCivita[FourVector[FourMomentum[Incoming, 1]], 
       FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
       Index[Lorentz, 1], Index[Lorentz, 4]])/LAMBDA^2 + 
    ...
    ((2*I)*cW*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 2, Number == 18], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
   ...
   (-(g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (g1*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
   (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])/LAMBDA^2 - 
    (I*cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 1]], 
       FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
       Index[Lorentz, 1], Index[Lorentz, 4]])/LAMBDA^2 - 
    (I/2)*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]] + 
    (I*cWB*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
   ...
   (((2*I)*cW*gw^2*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
    ...
    ((2*I)*cW*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 1, Number == 21], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 + 
     ...
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 7, Generic == 1, 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MGP]]*
    ((I/2)*g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
         1], Index[Lorentz, 2]] - (I/2)*g1*FourVector[FourMomentum[Internal, 
        1], Index[Lorentz, 2]])*
    ((I/2)*gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
     (I/2)*gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1] - FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
    ...
    (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 + 
     (gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        ...
        Index[Lorentz, 3]])/2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 7, Generic == 1, 
   Particles == 3, Number == 27], Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MGP], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
    ...
    (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 + 
     (gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        ...
        Index[Lorentz, 3]])/2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 7, Generic == 1, 
   Particles == 4, Number == 28], Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MG0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
    ...
    (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 + 
     (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        ...
        Index[Lorentz, 1]])/2)*
    (-(g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
         Index[Lorentz, 4]])/2 + (g1*FourVector[-FourMomentum[Outgoing, 2], 
        Index[Lorentz, 4]])/2)*
    ((g1*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 - 
     (g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
        Index[Lorentz, 3]])/2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 8, Generic == 1, 
   Particles == 1, Number == 29], Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MG0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    (-(g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        ...
        Index[Lorentz, 2]])/2)*
    (-(g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
         Index[Lorentz, 3]])/2 + (g1*FourVector[-FourMomentum[Outgoing, 1], 
        Index[Lorentz, 3]])/2)*
    (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 + 
     (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
    ...
    ((g1*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 4]])/2 - 
     (g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
        Index[Lorentz, 4]])/2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 9, Generic == 1, 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
   ...
   (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]])/2 + 
    (gw*FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]])/2)*
   ((-I/2)*g1*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
        1], Index[Lorentz, 2]] + 
    (I/2)*g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
 ...
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 1, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  (3*cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH]]*MetricTensor[Index[Lorentz, 1], 
     Index[Lorentz, 2]])/(2*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 2, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  (cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MG0]]*MetricTensor[Index[Lorentz, 1], 
     Index[Lorentz, 2]])/(2*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 11, Generic == 1, Particles == 1, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
       FourMomentum[Outgoing, 2], MG0]]*
    (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 + 
     (gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
        Index[Lorentz, 1]])/2)*
    ((cHD*g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      (2*LAMBDA^2) + (cHD*g1*FourVector[-FourMomentum[Outgoing, 1], 
        Index[Lorentz, 2]])/(2*LAMBDA^2) + 
     (cHD*g1*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 2]])/
      (2*LAMBDA^2) - (3*cHD*g1*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
         FourMomentum[Outgoing, 2], Index[Lorentz, 2]])/(2*LAMBDA^2)))], 
 FeynAmp[GraphID[Topology == 11, Generic == 1, Particles == 2, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
    ...
    ((I/2)*gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
     (I/2)*gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1] - FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 1]])*
    (((-I/2)*cHD*g1*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      LAMBDA^2 + ((I/2)*cHD*g1*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
         FourMomentum[Outgoing, 2], Index[Lorentz, 2]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 11, Generic == 2, Particles == 1, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
     ...
     Index[Lorentz, 4]]*((-I)*gw*FourVector[FourMomentum[Incoming, 1], 
       ...
       Index[Lorentz, 3]] + I*gw*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 3]] + I*gw*FourVector[FourMomentum[Incoming, 1], 
    ...
    ((I*cWB*g1*gw^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
     ...
     LeviCivita[FourVector[FourMomentum[Incoming, 2]], Index[Lorentz, 2], 
       Index[Lorentz, 4], Index[Lorentz, 6]]*
      C[0][S[1], S[1], V[5], -V[3], V[3]][LeviCivita[FourVector[Mom[3]], 
        KI1[3], KI1[4], KI1[5]]] + 
     LeviCivita[FourVector[FourMomentum[Internal, 1]], Index[Lorentz, 2], 
       Index[Lorentz, 4], Index[Lorentz, 6]]*
      C[0][S[1], S[1], V[5], -V[3], V[3]][LeviCivita[FourVector[Mom[4]], 
        KI1[3], KI1[4], KI1[5]]] + 
     LeviCivita[FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
         FourMomentum[Outgoing, 2]], Index[Lorentz, 2], Index[Lorentz, 4], 
       Index[Lorentz, 6]]*C[0][S[1], S[1], V[5], -V[3], V[3]][
       LeviCivita[FourVector[Mom[5]], KI1[3], KI1[4], KI1[5]]]))], 
 FeynAmp[GraphID[Topology == 12, Generic == 1, Particles == 1, Number == 40], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MH]]*
     (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 1], 
         Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2], 
         Index[Lorentz, 1]])/LAMBDA^2 - 
      (I*cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 1]], 
         FourVector[FourMomentum[Incoming, 2]], Index[Lorentz, 1], 
      ...
      ((3*I)*cHBOX*ScalarProduct[-FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
         -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 12, Generic == 1, Particles == 2, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
     ...
     (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 1], 
      ...
      (I*cHBOX*ScalarProduct[-FourMomentum[Internal, 1] + 
         ...
         -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 12, Generic == 1, Particles == 3, Number == 42], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MGP]]*
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((2*I)*cW*gw^2*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
    ...
    ((2*I)*cWt*gw^2*LeviCivita[FourVector[FourMomentum[Incoming, 1]], 
     ...
     LAMBDA^2 + (I/2)*gw^2*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 3]] - ((2*I)*cW*gw^2*MetricTensor[Index[Lorentz, 1], 
   ...
   (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    (I*cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
       FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 2]], Index[Lorentz, 2], Index[Lorentz, 4]])/
     LAMBDA^2 - (I/2)*g1*gw*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + (I*cWB*g1*gw*MetricTensor[Index[Lorentz, 2], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((-I)*cWB*g1*gw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
    ...
    (I*cWBt*g1*gw*LeviCivita[FourVector[FourMomentum[Incoming, 1]], 
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 2]], Index[Lorentz, 1], Index[Lorentz, 3]])/
     LAMBDA^2 - (I/2)*g1*gw*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 3]] + (I*cWB*g1*gw*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 1], 
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]])/LAMBDA^2)*
   (((2*I)*cB*g1^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    ((2*I)*cBt*g1^2*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
       FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 2]], Index[Lorentz, 2], Index[Lorentz, 4]])/
     LAMBDA^2 + (I/2)*g1^2*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] - ((2*I)*cB*g1^2*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]]*ScalarProduct[FourMomentum[Incoming, 2], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 2]])/LAMBDA^2)], 
 ...
 FeynAmp[GraphID[Topology == 15, Generic == 1, Particles == 1, Number == 47], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MG0]]*
    ((g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]])/2 - 
     (g1*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/2)*
    ((3*cHD*gw*FourVector[FourMomentum[Incoming, 2] - FourMomentum[Internal, 
          1], Index[Lorentz, 1]])/(2*LAMBDA^2) - 
     (cHD*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]])/
      (2*LAMBDA^2) - (cHD*gw*FourVector[-FourMomentum[Outgoing, 1], 
        Index[Lorentz, 1]])/(2*LAMBDA^2) - 
     (cHD*gw*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 1]])/
      (2*LAMBDA^2)))], FeynAmp[GraphID[Topology == 15, Generic == 1, 
   Particles == 2, Number == 48], Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MGP]]*
    (((-I/2)*cHD*gw*FourVector[FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 1]])/LAMBDA^2 + 
     ((I/2)*cHD*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]])/
      LAMBDA^2)*((I/2)*g1*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] - (I/2)*g1*FourVector[-FourMomentum[Incoming, 2] + 
 ...
 FeynAmp[GraphID[Topology == 16, Generic == 1, Particles == 1, Number == 49], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
   ...
   ((gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 - 
    (gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2)*
   (-((cWBt*g1*gw^2*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
        Index[Lorentz, 1], Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2) + 
    (cWB*g1*gw^2*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    (cWB*g1*gw^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
   ...
   ((cWB*g1*gw^2*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    LeviCivita[FourVector[FourMomentum[Incoming, 1]], Index[Lorentz, 1], 
     ...
     C[0][S[1], S[3], V[2], V[5], -V[3]][LeviCivita[FourVector[Mom[3]], 
       KI1[3], KI1[4], KI1[5]]] + 
    LeviCivita[FourVector[FourMomentum[Incoming, 2]], Index[Lorentz, 1], 
      Index[Lorentz, 2], Index[Lorentz, 4]]*
     C[0][S[1], S[3], V[2], V[5], -V[3]][LeviCivita[FourVector[Mom[4]], 
       KI1[3], KI1[4], KI1[5]]] + 
    LeviCivita[FourVector[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
         1]], Index[Lorentz, 1], Index[Lorentz, 2], Index[Lorentz, 4]]*
     C[0][S[1], S[3], V[2], V[5], -V[3]][LeviCivita[FourVector[Mom[5]], 
       KI1[3], KI1[4], KI1[5]]])], 
 FeynAmp[GraphID[Topology == 17, Generic == 1, Particles == 1, Number == 51], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
   ...
   (-((cWBt*g1*gw^2*LeviCivita[FourVector[FourMomentum[Incoming, 2]], 
    ...
    (cWB*g1*gw^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/LAMBDA^2)*
   MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]], 
 FeynAmp[GraphID[Topology == 17, Generic == 1, Particles == 2, Number == 52], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 2], 0]]*
   ...
   ((cWB*g1*gw^2*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    LeviCivita[FourVector[FourMomentum[Incoming, 2]], Index[Lorentz, 1], 
     ...
     C[0][S[1], S[3], V[2], V[5], -V[3]][LeviCivita[FourVector[Mom[4]], 
       KI1[3], KI1[4], KI1[5]]] + 
    LeviCivita[FourVector[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
         2]], Index[Lorentz, 1], Index[Lorentz, 2], Index[Lorentz, 4]]*
     C[0][S[1], S[3], V[2], V[5], -V[3]][LeviCivita[FourVector[Mom[5]], 
       KI1[3], KI1[4], KI1[5]]])]]
ins1=
TopologyList[Process -> {V[2], V[5]} -> {S[1], S[1]}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[6][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[2], 
     Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S] -> 
    Insertions[Particles][FeynmanGraph[2, Particles == 1][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[1]], FeynmanGraph[2, Particles == 2][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[2]]]], 
