...
diag = ExpandScalarProducts[diag /. {q23 -> q2 - q3, q24 -> q2 - q4, q34 -> q3 + q4}];
...
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] * (2/I) ] ],"\n"],{c,{cHD}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Simplify[ Coefficient[total,c]* (2/I) ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cHD}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
