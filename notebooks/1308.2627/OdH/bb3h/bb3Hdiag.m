...
Paint[DiagramExtract[ins1, finaldiag], DisplayFunction -> (Export["bb3H_included.pdf",#]&), ColumnsXRows ->{3,4}];
Print["Included diagrams printed"];

(*If[Length[DiagramComplement[ins1, DiagramExtract[ins1, finaldiag]]] != 0,
   Paint[DiagramComplement[ins1, DiagramExtract[ins1, finaldiag]], DisplayFunction -> (Export["bb3H_excluded.pdf",#]&), ColumnsXRows ->{3,4}];
...
FILE = NotebookDirectory[]<>"bb3Hdiag.res";
