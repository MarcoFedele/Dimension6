...
FeynAmpList[Process -> {{S[2], FourMomentum[Incoming, 1], MG0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (-3*cH*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH]])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 1, 
   Particles == 2, Number == 2], Integral[FourMomentum[Internal, 1]], 
  (-9*cH*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MG0]])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 1, 
   Particles == 3, Number == 3], Integral[FourMomentum[Internal, 1]], 
  (-12*cH*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MGP]])/LAMBDA^2], FeynAmp[GraphID[Topology == 2, Generic == 1, 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
     ...
     (I*cHD*ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 
     ...
     (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Incoming, 
         2]])/LAMBDA^2 - (I*cHD*ScalarProduct[FourMomentum[Incoming, 2], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     ...
     ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
      ...
      (I*cHD*ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 
          ...
          2], -FourMomentum[Outgoing, 2]])/LAMBDA^2 - 
      (I*cHD*ScalarProduct[FourMomentum[Incoming, 2], 
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2 - 
      (I*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
         FourMomentum[Internal, 1]])/LAMBDA^2 - 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
     ...
     ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
      ...
      (I*cHBOX*ScalarProduct[-FourMomentum[Incoming, 2] - 
         ...
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
        FourMomentum[Incoming, 1]])/LAMBDA^2 - 
     (I*cHD*ScalarProduct[FourMomentum[Incoming, 1], 
        -FourMomentum[Internal, 1]])/LAMBDA^2 - 
    ...
    ((-4*I)*lam - ((2*I)*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
     ...
     ((2*I)*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
        -FourMomentum[Outgoing, 2]])/LAMBDA^2 - 
     ((4*I)*cHD*ScalarProduct[FourMomentum[Incoming, 2], 
        -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 2]])/LAMBDA^2 - 
     ((2*I)*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
        FourMomentum[Internal, 1]])/LAMBDA^2 - 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 8], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
        FourMomentum[Incoming, 2]])/LAMBDA^2 - 
     (I*cHD*ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 
         1]])/LAMBDA^2 - (I*cHD*ScalarProduct[FourMomentum[Incoming, 2], 
        -FourMomentum[Outgoing, 1]])/LAMBDA^2 - 
     ((2*I)*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
        -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2 - 
     (I*cHBOX*ScalarProduct[FourMomentum[Internal, 1], FourMomentum[Internal, 
         1]])/LAMBDA^2 - ((2*I)*cHBOX*ScalarProduct[FourMomentum[Internal, 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
     ...
     (I*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
        -FourMomentum[Outgoing, 2]])/LAMBDA^2))]]
ins1=
TopologyList[Process -> {S[2], S[3]} -> {S[2], S[3]}, 
  Model -> {"Mine/1308.2627"}, GenericModel -> {"Mine/1308.2627"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[6][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[2], 
     Field[2] -> S[3], Field[3] -> S[2], Field[4] -> -S[3], Field[5] -> S] -> 
    Insertions[Particles][FeynmanGraph[2, Particles == 1][Field[1] -> S[2], 
      Field[2] -> S[3], Field[3] -> S[2], Field[4] -> -S[3], 
      Field[5] -> S[1]], FeynmanGraph[2, Particles == 2][Field[1] -> S[2], 
      Field[2] -> S[3], Field[3] -> S[2], Field[4] -> -S[3], 
      Field[5] -> S[2]], FeynmanGraph[1, Particles == 3][Field[1] -> S[2], 
      Field[2] -> S[3], Field[3] -> S[2], Field[4] -> -S[3], 
      Field[5] -> -S[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[2], 
     ...
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> S[2], Field[2] -> S[3], Field[3] -> S[2], 
      Field[4] -> -S[3], Field[5] -> S[2], Field[6] -> S[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[2], 
     ...
     FeynmanGraph[2, Particles == 2][Field[1] -> S[2], Field[2] -> S[3], 
      Field[3] -> S[2], Field[4] -> -S[3], Field[5] -> S[2], 
      Field[6] -> S[2]], FeynmanGraph[1, Particles == 3][Field[1] -> S[2], 
      Field[2] -> S[3], Field[3] -> S[2], Field[4] -> -S[3], 
