...
FeynAmpList[Process -> {{S[2], FourMomentum[Incoming, 1], MG0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (-45*cH*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MG0]])/LAMBDA^2], FeynAmp[GraphID[Topology == 1, Generic == 1, 
   Particles == 3, Number == 3], Integral[FourMomentum[Internal, 1]], 
  (-18*cH*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
     ...
     (I*cHBOX*ScalarProduct[-FourMomentum[Internal, 1] + 
        ...
        -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
         FourMomentum[Outgoing, 2]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     ...
     ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
      ...
      (I*cHBOX*ScalarProduct[-FourMomentum[Incoming, 2] - 
         ...
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 8], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
     ...
     ((-6*I)*lam - ((3*I)*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
      ...
      ((3*I)*cHBOX*ScalarProduct[-FourMomentum[Incoming, 2] - 
         ...
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 2], 
     ...
     (I*cHBOX*ScalarProduct[-FourMomentum[Incoming, 2] - 
        ...
        -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 2]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 10], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
     ...
     ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
      ...
      (I*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
         -FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 2, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
     ...
     ((-6*I)*lam - ((3*I)*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
      ...
      ((3*I)*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
         -FourMomentum[Outgoing, 2]])/LAMBDA^2))/2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 3, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
...
TopologyList[Process -> {S[2], S[2]} -> {S[2], S[2]}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[6][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[2], 
     Field[2] -> S[2], Field[3] -> S[2], Field[4] -> S[2], Field[5] -> S] -> 
