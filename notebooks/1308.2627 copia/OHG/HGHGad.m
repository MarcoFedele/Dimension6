...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OG."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] * (1/2/(-sp[Ep1,Ep2] sp[q1,q2]+sp[q1,Ep2] sp[q2,Ep1])) ] ],"\n"],{c,{cG}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OGtilde."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] *
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Simplify[ Coefficient[total,c]* (1/2/(-sp[Ep1,Ep2] sp[q1,q2]+sp[q1,Ep2] sp[q2,Ep1])) ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cG}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
