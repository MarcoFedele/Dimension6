...
diag = diag /. {B0[ - q1_ - q2_ , m1_ , m2_ ] -> B0[ q1 + q2 , m1 , m2 ], Q234 -> - q1};
diag = diag //.ScalarProductRules;
...
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Coefficient[total, c] ] ], lam],"\n"],{c,{cHq333,cHud33,cHl333}}];
