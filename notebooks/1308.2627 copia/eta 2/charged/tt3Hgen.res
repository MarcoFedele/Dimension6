...
FeynAmpList[Process -> {{S[1], FourMomentum[Incoming, 1], MH, {}}, 
  ...
  AmplitudeLevel -> {Particles}, ExcludeParticles -> 
   {S, V, -F[1], F[1], -F[2], F[2], -F[4], F[4], -F[5], F[5], -F[7], F[7], 
    -F[8], F[8], -F[10], F[10], -F[11], F[11], -F[7, {_}], F[7, {_}], 
    -F[8, {_}], F[8, {_}], -F[10, {_}], F[10, {_}], -F[11, {_}], F[11, {_}], 
    S[1], S[2], -S[3], S[3], V[1], V[2], -V[3], V[3], V[4], V[5], V[4, {_}]}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    MatrixTrace[NonCommutative[ChiralityProjector[1]], 
     ...
     NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]]]]*yl[3, 3])/LAMBDA^2], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 4], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    MatrixTrace[((-I)*(HC[yl[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     I*((cHl133 - cHl333)*NonCommutative[DiracSlash[FourMomentum[Incoming, 
       ...
       cHe33*NonCommutative[DiracSlash[FourMomentum[Incoming, 2]], 
         ...
         DiracSlash[-FourMomentum[Outgoing, 2]], ChiralityProjector[-1]] + 
       cHl333*NonCommutative[DiracSlash[-FourMomentum[Outgoing, 2]], 
         ChiralityProjector[-1]] - cHe33*NonCommutative[
         DiracSlash[-FourMomentum[Outgoing, 2]], ChiralityProjector[1]]), 
     NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]]]])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 2, Number == 5], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 3, Number == 6], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[((-I)*(HC[yu[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 4, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 5, Number == 8], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[((-I)*(HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 6, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[((-I)*(HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 10], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
    ...
    HC[yl[3, 3]]*MatrixTrace[
     ...
     NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]]]])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
    ...
    MatrixTrace[HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] - 
     ...
     (2*cHq333*NonCommutative[DiracSlash[FourMomentum[Incoming, 2]], 
      ...
      Sqrt[2], NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 16], 
  ...
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    MatrixTrace[((-I)*(HC[yl[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]]]])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] - 
     ...
     (-2*cHq333*NonCommutative[DiracSlash[FourMomentum[Incoming, 1]], 
      ...
      Sqrt[2], NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 3, Number == 18], 
  Integral[FourMomentum[Internal, 1]], 
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[((-I)*(HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     (-2*cHq333*NonCommutative[DiracSlash[FourMomentum[Incoming, 1]], 
      ...
      Sqrt[2], NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1]]]]*SumOver[Index[Colour, 5], 3])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 1, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
   ...
   yl[3, 3]], FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 2, 
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 3, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 7, Generic == 1, Particles == 2, Number == 23], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    MatrixTrace[((-I)*(HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
     ...
     NonCommutative[DiracSlash[FourMomentum[Internal, 1]]]]*
    SumOver[Index[Colour, 5], 3])], 
 FeynAmp[GraphID[Topology == 8, Generic == 1, Particles == 1, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
   ...
   MatrixTrace[NonCommutative[ChiralityProjector[1]], 
    ...
    NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]]]*yl[3, 3]], 
 FeynAmp[GraphID[Topology == 8, Generic == 1, Particles == 2, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 8, Generic == 1, Particles == 3, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    MatrixTrace[HC[yu[3, 3]]*NonCommutative[ChiralityProjector[-1]] - 
     ...
     NonCommutative[DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]]]*
    SumOver[Index[Colour, 5], 3])], 
 FeynAmp[GraphID[Topology == 9, Generic == 1, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    MatrixTrace[Sqrt[2]*cHl333*
      (-NonCommutative[DiracSlash[FourMomentum[Incoming, 1]], 
         ChiralityProjector[-1]] + NonCommutative[
        DiracSlash[FourMomentum[Incoming, 2]], ChiralityProjector[-1]]), 
     NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 9, Generic == 1, Particles == 2, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
 ...
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 1, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0]]*
 ...
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 2, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0]]*
...
TopologyList[Process -> {S[1], S[3]} -> {S[1], S[3]}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> S[1], 
     Field[2] -> S[3], Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> F, 
     Field[6] -> F, Field[7] -> F] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> F[6], 
      Field[6] -> -F[6], Field[7] -> F[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> -F[9, {Index[Colour, 5]}], 
      Field[6] -> F[9, {Index[Colour, 5]}], Field[7] -> 
       -F[12, {Index[Colour, 5]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[12, {Index[Colour, 5]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> S[1], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> -F[6], 
      Field[6] -> F[6], Field[7] -> -F[6]], FeynmanGraph[1, Particles == 2][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[6], Field[6] -> -F[6], 
      Field[7] -> F[6]], FeynmanGraph[1, Particles == 3][Field[1] -> S[1], 
      Field[2] -> S[3], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> -F[9, {Index[Colour, 5]}], Field[6] -> 
       F[9, {Index[Colour, 5]}], Field[7] -> -F[9, {Index[Colour, 5]}]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> 
       F[9, {Index[Colour, 5]}], Field[6] -> -F[9, {Index[Colour, 5]}], 
      Field[7] -> F[9, {Index[Colour, 5]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> -F[12, {Index[Colour, 5]}], 
      Field[6] -> F[12, {Index[Colour, 5]}], Field[7] -> 
       -F[12, {Index[Colour, 5]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[12, {Index[Colour, 5]}], 
      Field[6] -> -F[12, {Index[Colour, 5]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> S[1], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> -F[6], 
      Field[6] -> F[3], Field[7] -> -F[6]], FeynmanGraph[1, Particles == 2][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[9, {Index[Colour, 5]}], 
      Field[6] -> -F[12, {Index[Colour, 5]}], 
      Field[7] -> F[9, {Index[Colour, 5]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> -F[12, {Index[Colour, 5]}], 
      Field[6] -> F[9, {Index[Colour, 5]}], Field[7] -> 
       -F[12, {Index[Colour, 5]}]]]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> S[1], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> S[1], 
      Field[2] -> S[3], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> F[6], Field[6] -> -F[6], Field[7] -> F[3], 
      Field[8] -> -F[6]], FeynmanGraph[1, Particles == 2][Field[1] -> S[1], 
      Field[2] -> S[3], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> -F[9, {Index[Colour, 5]}], Field[6] -> 
       F[9, {Index[Colour, 5]}], Field[7] -> -F[12, {Index[Colour, 5]}], 
      Field[8] -> F[9, {Index[Colour, 5]}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[12, {Index[Colour, 5]}], 
      Field[6] -> -F[12, {Index[Colour, 5]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> S[1], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> S[1], 
      ...
      Field[8] -> F[3]], FeynmanGraph[1, Particles == 2][Field[1] -> S[1], 
      Field[2] -> S[3], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> -F[9, {Index[Colour, 5]}], Field[6] -> 
       F[9, {Index[Colour, 5]}], Field[7] -> F[9, {Index[Colour, 5]}], 
      Field[8] -> -F[12, {Index[Colour, 5]}]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> 
       F[12, {Index[Colour, 5]}], Field[6] -> -F[12, {Index[Colour, 5]}], 
      Field[7] -> -F[12, {Index[Colour, 5]}], 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[1], 
     ...
     Field[6] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> S[1], Field[2] -> S[3], Field[3] -> S[1], 
      Field[4] -> -S[3], Field[5] -> F[3], Field[6] -> -F[6]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> S[1], Field[2] -> S[3], 
      Field[3] -> S[1], Field[4] -> -S[3], Field[5] -> 
