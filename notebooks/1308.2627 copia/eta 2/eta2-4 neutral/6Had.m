...
total = Total[diag];
WCList = {cHq133,cHq333,cHu33,cHd33,cHe33,cHl133,cHl333};
Print["Computing AD..."];
AD = Table[ FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (-1) ] ] ],{c, WCList}];
AD = AD /. 2 sp[q1, q2] + sp[q1, q3] + sp[q1, q4] - 2 sp[q2, q2] + 3 sp[q2, q3] + 3 sp[q2, q4] + sp[q3, q3] + 6 sp[q3, q4] + sp[q4, q4] ->
                sp[q1, q1] + 6 sp[q1, q2] + sp[q2, q2] + sp[q3, q3] + 6 sp[q3, q4] + sp[q4, q4];
Print["AD computed."];

etaAD = AD /. sp[q1, q1] + 6 sp[q1, q2] + sp[q2, q2] + sp[q3, q3] + 6 sp[q3, q4] + sp[q4, q4] ->
                eta3coeff + 4 * eta4coeff ;
etaList = {eta2,eta3,eta4};

eta2entry = Total[ Table[ Coefficient[etaAD[[i]],eta2coeff] * WCList[[i]] , {i,Length[etaAD]} ]/2 ];
