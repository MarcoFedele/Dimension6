...
process1 = {S[1], S[2]} -> {S[1], S[2]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, Internal}];

ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|2|3|4|5|7|8|10|11], S}, InsertionLevel->{Particles} ];
