...
process1 = {S[1], S[1], S[2]} -> {S[1], S[1], S[2]};

top = CreateTopologies[1, 3 -> 3, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, SelfEnergies, Triangles, Pentagons, Hexagons} ];

 ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627", GenericModel -> "Mine/1308.2627", ExcludeParticles -> {V, F[1|2|3|4|5|7|8|9|10|11|12], S[2|3]}, InsertionLevel->{Particles} ];
