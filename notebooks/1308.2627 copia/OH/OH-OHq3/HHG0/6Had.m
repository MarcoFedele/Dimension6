...
diag = diag/.{MH->Sqrt[h],MG0->Sqrt[h]};
...
Print[""];
total = Total[diag];
total = Collect[total, {pp[q1 + q2 - q5, h], pp[q1 + q2 - q4, h], pp[-q1 + q4 + q5, h], pp[-q2 + q4 + q5, h]}]
Table[Print["Entry relative to ", c, " : \n", FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/18) ] ] ],"\n"],{c,{cHu33,cHd33,cHq133,cHq333}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/18) ] ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cHu33,cHd33,cHq133,cHq333,cHud23,cHud32}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
