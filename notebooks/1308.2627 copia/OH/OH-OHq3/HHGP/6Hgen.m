...
process1 = {S[3], S[1], S[1]} -> {S[3], S[1], S[1]};

top = CreateTopologies[1, 3 -> 3, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, SelfEnergies, Triangles, Pentagons, Hexagons} ];

 ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|2|3|4|5|6|7|8|10|11]}, InsertionLevel->{Particles} ];
 ...
 rule1 := {DiracObject[x___][Index[Dirac, a_], Index[Dirac, b_]] -> FermionLine[NonCommutative[x], a, b],
    ...
    c_ FermionLine[x___, a_Integer, b_Integer] + d_ FermionLine[y___, a_Integer, b_Integer] :> FermionLine[c x + d y, a, b] /; !MatchQ[c, Times[FermionLine[___], ___] ],
