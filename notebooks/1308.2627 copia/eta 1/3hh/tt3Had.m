...
(*Print[""];
 ...
 Print[diag];*)
total = Total[diag];
total = total /. a_^2 :> h - 2 lam (HH/2 + GPGP + G0G0/2) - Yd /; MemberQ[{q1, q2, q3, q4, q5, q12345}, a];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR CH - HH (16)."];
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Coefficient[total, HH c] / 90 ] ], lam],"\n"],{c,{cuH33,cdH33,ceH33}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR CH - GPGP (16)."];
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Coefficient[total, GPGP c] / 18 ] ], lam],"\n"],{c,{cuH33,cdH33,ceH33}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR CH - G0G0 (16)."];
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Coefficient[total, G0G0 c] / 18 ] ], lam],"\n"],{c,{cuH33,cdH33,ceH33}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR lam (1)."];
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 h Coefficient[total, h c] / 6] ], lam],"\n"],{c,{cuH33,cdH33,ceH33}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR CuH (1)."];
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Yd Coefficient[total, Yd c] Sqrt[2]/3 ] ], lam],"\n"],{c,{cuH33,cdH33,ceH33}}];
