...
top = CreateTopologies[1, 3 -> 1, Adjacencies -> {3, 5}, ExcludeTopologies -> {Tadpoles, Internal}];

ins1 = InsertFields[ top, process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|2|3]}, InsertionLevel->{Particles} ];
