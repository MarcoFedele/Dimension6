  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    ...
    ((-2*I)*lam - (I*cHBOX*ScalarProduct[FourMomentum[Incoming, 1], 
     ...
     (I*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
        -FourMomentum[Outgoing, 2]])/LAMBDA^2))]]
ins1=
TopologyList[Process -> {S[1], S[1]} -> {S[1], S[1]}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[6][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[1], 
     Field[2] -> S[1], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S] -> 
    Insertions[Particles][FeynmanGraph[2, Particles == 1][Field[1] -> S[1], 
      Field[2] -> S[1], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[1]], FeynmanGraph[2, Particles == 2][Field[1] -> S[1], 
      Field[2] -> S[1], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[2]], FeynmanGraph[1, Particles == 3][Field[1] -> S[1], 
      Field[2] -> S[1], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> -S[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> S[1], 
     ...
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[2, Particles == 1][
      Field[1] -> S[1], Field[2] -> S[1], Field[3] -> S[1], Field[4] -> S[1], 
