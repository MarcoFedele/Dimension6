...
process1 = {F[12], -F[12]} -> {S[1]};

top = CreateTopologies[1, 2 -> 1, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, Internal}];

ins1 = InsertFields[ top[[4]], process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|2|3]}, InsertionLevel->{Particles} ];
