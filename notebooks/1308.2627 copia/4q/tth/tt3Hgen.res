...
FeynAmpList[Process -> {{F[9, {Index[Colour, 1]}], FourMomentum[Incoming, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     Index[Colour, 2]]*(clequ11133*FermionChain[NonCommutative[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*IndexDelta[Index[Colour, 1], 
     Index[Colour, 2]]*(clequ13333*FermionChain[NonCommutative[
        ChiralityProjector[1]]]*MatrixTrace[
       ...
       NonCommutative[ChiralityProjector[1]], NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
           1]]]] - clu3333*FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 5, Number == 5], 
    ...
    (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
      ...
      (cqu13311*IndexDelta[Index[Colour, 1], Index[Colour, 2]] + 
       cqu83311*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 4]], 
       ...
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]], 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]]]])*SumOver[Index[Colour, 4], 3]*
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
      ...
      (cqu13223*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cqu83223*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) - FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]]*
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
      ...
      (cqu13333*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
       ...
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1]]], 
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
         -1]]]*(cqu13333*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cqu83333*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) - 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ...
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1]]], 
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]]*
      (cqu13323*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cqu83323*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) - FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]]*
    ...
    (FermionChain[NonCommutative[ChiralityProjector[1]], 
      ...
      (cquqd11331*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
       ...
       cquqd81331*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) + FermionChain[NonCommutative[
        ChiralityProjector[1]]]*(cquqd13311*IndexDelta[Index[Colour, 1], 
         Index[Colour, 2]] + cquqd83311*IndexSum[
    ...
    (FermionChain[NonCommutative[ChiralityProjector[1]], 
      ...
      (cquqd12332*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
       ...
       cquqd82332*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) + FermionChain[NonCommutative[
        ChiralityProjector[1]]]*(cquqd13322*IndexDelta[Index[Colour, 1], 
         Index[Colour, 2]] + cquqd83322*IndexSum[
         SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 4]], 
         {Gluon$1, 1, 8}])*MatrixTrace[
       ((-I)*(HC[yd[2, 2]]*NonCommutative[ChiralityProjector[-1]] + 
  ...
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (FermionChain[NonCommutative[ChiralityProjector[1]], 
      ...
      (cquqd13333*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
       ...
       NonCommutative[ChiralityProjector[1]], NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
           1]]]] + cqu13333*FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]]*
      IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
     ...
     cqu83333*FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ChiralityProjector[1]]]*IndexSum[SUNT[Gluon$1, Index[Colour, 2], 
         Index[Colour, 1]]*SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 4]], 
       {Gluon$1, 1, 8}]*MatrixTrace[
       ((-I)*(HC[yd[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
          NonCommutative[ChiralityProjector[1]]*yd[3, 3]))/Sqrt[2], 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1]]], 
...
TopologyList[Process -> {F[9, {Index[Colour, 1]}], 
     -F[9, {Index[Colour, 2]}]} -> {S[1]}, Model -> {"Mine/1308.2627.4f"}, 
  GenericModel -> {"Mine/1308.2627.4f"}, InsertionLevel -> {Particles}, 
  ExcludeParticles -> {V, -F[1], F[1], -F[2], F[2], -F[3], F[3], V[1], V[2], 
    -V[3], V[3], V[4], V[5], V[4, {_}]}, ExcludeFieldPoints -> {}, 
  LastSelections -> {}][Topology[2][Propagator[Incoming][Vertex[1][1], 
    Vertex[4][4], Field[1]], Propagator[Incoming][Vertex[1][2], Vertex[4][4], 
    Field[2]], Propagator[Outgoing][Vertex[1][3], Vertex[3][5], Field[3]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
     Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
      -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> F, 
     Field[5] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -F[4], 
      Field[5] -> F[4]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -F[5], 
      Field[5] -> F[5]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -F[6], 
      Field[5] -> F[6]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -F[5], 
      Field[5] -> F[6]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[7, {Index[Colour, 4]}], Field[5] -> 
       F[7, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[8, {Index[Colour, 4]}], Field[5] -> 
       F[8, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 7][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[9, {Index[Colour, 4]}], Field[5] -> 
       F[9, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 8][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[8, {Index[Colour, 4]}], Field[5] -> 
       F[9, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 9][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[10, {Index[Colour, 4]}], 
      Field[5] -> F[10, {Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 10][Field[1] -> F[9, {Index[Colour, 1]}], 
      Field[2] -> -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[11, {Index[Colour, 4]}], 
      Field[5] -> F[11, {Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 11][Field[1] -> F[9, {Index[Colour, 1]}], 
      Field[2] -> -F[9, {Index[Colour, 2]}], Field[3] -> S[1], 
      Field[4] -> -F[12, {Index[Colour, 4]}], 
      Field[5] -> F[12, {Index[Colour, 4]}]], 
