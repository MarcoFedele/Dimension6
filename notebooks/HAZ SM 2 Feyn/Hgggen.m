...
top = CreateTopologies[1, 2 -> 1, Adjacencies -> {3, 4, 5, 6}, ExcludeTopologies -> {Tadpoles} ];

ins1 = InsertFields[ top, process1, Model -> "SMbgf", GenericModel -> "Lorentzbgf", ExcludeParticles -> {F, V[1]}, InsertionLevel->{Particles} ];
