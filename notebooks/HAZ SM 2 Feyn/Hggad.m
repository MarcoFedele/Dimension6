...
total0 = Collect[
                 PowerExpand[ total0 //. {1 - s2 -> cw^2, s2 -> sw^2, sw -> cw*g1/gw, cw -> gw/Sqrt[g1^2 + gw^2], Sqrt[w] -> gw vev/2, 1/Sqrt[w] -> 2/(gw vev), w -> gw^2 vev^2/4, z -> (g1^2 + gw^2) vev^2/4, h -> 2 lam vev^2} ],
                 C0[__], Simplify] /. gw^2 vev^2 -> 4 w;
