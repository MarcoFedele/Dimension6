...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MT], 
   ...
   MatrixTrace[NonCommutative[MT + DiracSlash[FourMomentum[Incoming, 2] + 
    ...
    ((-2*I)/3)*cw*g1*NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ChiralityProjector[-1]] - ((2*I)/3)*cw*g1*NonCommutative[
  ...
  I*((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
   ...
   (I*cw*g1*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 7]]*
    ...
    I*cw*g1*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
      ...
      Index[Lorentz, 7]] - I*cw*g1*FourVector[-FourMomentum[Incoming, 2] - 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, Number == 5], 
  ...
  6*lam*vev*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])*
   (((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
    ...
    ((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
     ...
     LAMBDA^2)*(((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 8], 
  ...
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
    ...
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*vev*MetricTensor[
       Index[Lorentz, 2], Index[Lorentz, 5]]*ScalarProduct[
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
    ...
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*vev*MetricTensor[
       Index[Lorentz, 4], Index[Lorentz, 6]]*ScalarProduct[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 3, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MH], PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], 0], PropagatorDenominator[
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
    ...
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       ...
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 4, Number == 10], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MH], PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], MZ], PropagatorDenominator[
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
    ...
    ((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
  ...
  -(((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 1, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0], 
   ...
   (((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
    ...
    ((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)*
   (((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
    ...
    ((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 2, Number == 14], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ], 
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*FourVector[FourMomentum[Incoming, 
        2], Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]])/LAMBDA^2 + 
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*MetricTensor[Index[Lorentz, 2], 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 15], 
  ...
  -(((-I)*cw*g1*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     ...
     I*cw*g1*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
       ...
       Index[Lorentz, 5]] + I*cw*g1*FourVector[-FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
    (((-2*I)*(2*cw*cW*g1 - cw*cWB*g1)*gw^2*vev*
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
    ...
    ((4*I)*(cB*cw^2*g1^2 + cw*g1*(cw*cW*g1 - cw*cWB*g1))*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 2, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[-FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], MZ], PropagatorDenominator[
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
    ...
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*vev*MetricTensor[
       Index[Lorentz, 2], Index[Lorentz, 3]]*ScalarProduct[
       FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 18], 
  Integral[FourMomentum[Internal, 1]], 
  ...
  -((I*cw^2*g1^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     I*cw^2*g1^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[1], 
   ...
   FeynmanGraph[1, Generic == 3][Field[1] -> V[1], Field[2] -> V[1], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      ...
      Field[6] -> S[1]]], FeynmanGraph[1, Generic == 4][Field[1] -> V[1], 
