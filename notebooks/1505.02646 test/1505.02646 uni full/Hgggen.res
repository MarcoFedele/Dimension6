 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 3], 
  ...
  I*(((-I)*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
   ...
   ((I*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
    ...
    (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[FourMomentum[Internal, 
    ...
    (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
     ...
     LAMBDA^2 - (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 15], 
  ...
  -((((-I)*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
     ...
     (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
        ...
        Index[Lorentz, 5]])/LAMBDA^2 - (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])/LAMBDA^2 + 
     (I*cw*g1*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
        -FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
