...
process1 = {V[1], V[2]} -> {S[1]};

top = CreateTopologies[1, 2 -> 1, Adjacencies -> {3, 4, 5, 6}, ExcludeTopologies -> {Internal, Tadpoles} ];

ins1 = InsertFields[ top, process1, Model -> "Mine/1505.02646.uni", GenericModel -> "Mine/1505.02646.uni", ExcludeParticles -> {F, V[1]}, InsertionLevel->{Particles} ];
