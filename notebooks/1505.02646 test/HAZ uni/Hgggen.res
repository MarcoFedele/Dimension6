...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  I*((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
   ...
   (I*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 7]]*
    ...
    I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
      ...
      Index[Lorentz, 7]] - I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - 
  ...
  6*lam*vev*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
    ...
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*vev*MetricTensor[Index[Lorentz, 2], 
      ...
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, 
  ...
  -(((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 1, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*
    ...
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*MetricTensor[Index[Lorentz, 2], 
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 8], 
  Integral[FourMomentum[Internal, 1]], 
  -(((-I)*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     ...
     I*cw*gw*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
       ...
       Index[Lorentz, 5]] + I*cw*gw*FourVector[-FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
    ...
    ((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 10], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 11], 
  ...
  -((I*cw^2*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     I*cw^2*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
    ...
    (((4*I)*cW*gw^2*vev*FourVector[-FourMomentum[Internal, 1], 
     ...
     ((4*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))]]
ins1=
TopologyList[Process -> {V[1], V[2]} -> {S[1]}, 
  Model -> {"Mine/1505.02646.uni"}, GenericModel -> {"Mine/1505.02646.uni"}, 
