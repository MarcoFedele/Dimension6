...
total = total + c\[Gamma]Z e^2 HWF 2 (- sp[Ep1, Ep2] sp[q1, q2] + sp[q1, Ep2] sp[q2, Ep1]);
total = total /. sp[q1, Ep2] sp[q2, Ep1] -> AAAA + sp[Ep1, Ep2] sp[q1, q2] /. sp[q1, q2] -> h/2;
total = total /. cB -> (c\[Gamma]Z gw)/(2 g1) + (cW gw^2)/g1^2 + cWB (1/2 - gw^2/(2 g1^2));
...
If[!MatchQ[Coefficient[totale, AAAA], 0] ,
   ...
   Print[""];
   Table[Print["Entry relative to ", c, " : ", Expand[Coefficient[2*ad/2, c e^2]] ,"\n"],{c,{c\[Gamma]Z,cW,cWB}}],
...
If[!MatchQ[Coefficient[total0, AAAA], 0] ,
   ...
   ft = Collect[ Coefficient[total0/2, AAAA], {e, c\[Gamma]Z, cW, cWB,
