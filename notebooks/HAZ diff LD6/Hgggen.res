...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
     ...
     ((I/2)*(-((cw*g1^2)/gw) + cw*gw)*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 2]] - 
      (I/2)*(-((cw*g1^2)/gw) + cw*gw)*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])*(I*cw*g1*FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 1]] - I*cw*g1*FourVector[FourMomentum[Incoming, 2] + 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
        Index[Lorentz, 1]])*((4*cw^2*g1^2*lam)/gw^2 + cw^2*g1^2*GaugeXi[Q]))/
   (2*cw^2*g1^2)], FeynAmp[GraphID[Topology == 1, Generic == 1, 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
       ...
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[Q]]]]*
     ((-I/2)*(-((cw*g1^2)/gw) + cw*gw)*FourVector[
        -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 2]] + (I/2)*(-((cw*g1^2)/gw) + cw*gw)*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 8], 
  ...
  I*(((-I)*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
    ...
    FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    (I*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
   ...
   ((I*gw*(cw*cWB*g1^2*vev^2 + cw*(LAMBDA^2 + 2*cW*gw^2*vev^2))*
    ...
    (I*cw*gw*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 7]])/
     LAMBDA^2 + (I*cw*gw*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 7]])/
     GaugeXi[Q] - (I*cw*gw*(LAMBDA^2 + 2*cW*gw^2*vev^2)*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 7]])/
     LAMBDA^2 + (I*cw*gw*(LAMBDA^2 + 2*cW*gw^2*vev^2)*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 2, Number == 10], 
  ...
  I*((I*gw*((cw*g1*LAMBDA^2)/gw + (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*
    ...
    FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     (((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 3]] - (I*gw*((cw*g1*LAMBDA^2)/gw + 
       (2*cw*cW*g1 - cw*cWB*g1)*gw*vev^2)*FourVector[FourMomentum[Incoming, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 2, Number == 15], 
  Integral[FourMomentum[Internal, 1]], 
  I*((I/2)*(-((cw*g1^2)/gw) + cw*gw)*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]] - 
    (I/2)*(-((cw*g1^2)/gw) + cw*gw)*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 2]])*
   (-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*
    ...
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*MetricTensor[Index[Lorentz, 2], 
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 2, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 32], 
  ...
  -((((-I)*gw*(cw*cWB*g1^2*vev^2 + cw*(LAMBDA^2 + 2*cW*gw^2*vev^2))*
     ...
     (I*cw*gw*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
        ...
        Index[Lorentz, 5]])/LAMBDA^2 - 
     (I*cw*gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]]*
     ...
     (I*cw*gw*(LAMBDA^2 + 2*cW*gw^2*vev^2)*FourVector[
        ...
        Index[Lorentz, 5]])/LAMBDA^2)*
    (((-2*I)*(2*cw*cW*g1 - cw*cWB*g1)*gw^2*vev*
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  -(((I*cw^2*g1*gw*(LAMBDA^2 - 2*cW*gw^2*vev^2)*MetricTensor[
        Index[Lorentz, 1], Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 2], 
        Index[Lorentz, 4]])/LAMBDA^2 + 
     ((I*cw^2*g1*gw*(LAMBDA^2 - 2*cW*gw^2*vev^2))/LAMBDA^2 - 
       ((2*I)*cw^2*g1*gw)/GaugeXi[Q])*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 6]] + cw*((-2*I)*cw*g1*gw + ((4*I)*cw*cW*g1*gw^3*vev^2)/
        LAMBDA^2)*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])*
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
       PropagatorDenominator[FourMomentum[Internal, 1] + 
    ...
    (((4*I)*cW*gw^2*vev*FourVector[-FourMomentum[Internal, 1], 
     ...
     ((4*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 40], 
  Integral[FourMomentum[Internal, 1]], 
  (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
   ...
   ((2*cw^2*cWB*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       ...
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])], 
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 2, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 - 
    (gw*FourVector[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
