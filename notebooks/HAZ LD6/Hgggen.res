...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  Model -> {"Mine/1505.02646.bgf.2"}, GenericModel -> 
   {"Mine/1505.02646.bgf.2"}, AmplitudeLevel -> {Particles}, 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
     ...
     (I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
          1], Index[Lorentz, 2]] - I*cw*gw*FourVector[FourMomentum[Internal, 
         1], Index[Lorentz, 2]])*
     (I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
      I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 2, Number == 2], 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
       ...
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[Q]]]]*
     ((-I)*cw*gw*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
      I*cw*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
     ((-I)*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
      I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
          1] - FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*
     ((4*cw^2*g1^2*lam)/gw^2 + cw^2*g1^2*GaugeXi[Q]))/(2*cw^2*g1^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 3], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      MW*Sqrt[GaugeXi[Q]]]]*(I*cw*gw*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 2]] + I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])*
    (I*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 1]] + 
     I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]))/4], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 4], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      MW*Sqrt[GaugeXi[Q]]]]*(I*cw*gw*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 2]] + I*cw*gw*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 2]])*(I*cw*g1*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 1]] + I*cw*g1*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 6], 
  ...
  I*((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    (I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1] - FourMomentum[Outgoing, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]])/GaugeXi[Q] + 
    I*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] - 
    I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
        1] - FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] - 
    (I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]]*
    ...
    I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
        1] - FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   (I*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 7]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    I*cw*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 7]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    (I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
         1], Index[Lorentz, 7]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]])/GaugeXi[Q] - 
    I*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 7]] + 
    I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1], Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 7]] + (I*cw*gw*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 7]])/
     GaugeXi[Q] - I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 1, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  I*(I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
    I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
        1] - FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*
   ...
   (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      Index[Lorentz, 4]])*
   ((-2*cw*cWB*g1^2*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 3]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2 - 
    ((cw^3*g1 + (cw^3*g1^3)/gw^2)*gw^2*vev*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 3]])/(2*cw^2*g1) + 
    (2*cw*cWB*g1^2*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  I*((((cw*g1^2)/gw + cw*gw)*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/2 + 
    ((-((cw*g1^2)/gw) - cw*gw)*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 2]])/2)*
   ((((cw*g1^2)/gw + cw*gw)*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], Index[Lorentz, 4]])/2 + 
    ((-((cw*g1^2)/gw) - cw*gw)*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]])/2 + 
    (gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]])/(2*cw))*
   (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      ...
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])*
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 2, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  I*(I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1], Index[Lorentz, 2]] - 
    I*cw*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
   (-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        Index[Lorentz, 4]])/2 + (gw*FourVector[-FourMomentum[Outgoing, 1], 
   ...
   ((-2*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    (2*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 3, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  I*((-I)*cw*gw*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
    I*cw*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
   (-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        Index[Lorentz, 4]])/2 + (gw*FourVector[-FourMomentum[Outgoing, 1], 
   ...
   ((2*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    (2*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 1, Number == 14], 
  Integral[FourMomentum[Internal, 1]], 
  6*lam*vev*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*vev*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] - ((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + 
       cw^2*cW*gw^2)*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 2, 
  ...
  (gw^2*vev*((4*cw^2*g1^2*lam)/gw^2 + cw^2*g1^2*GaugeXi[Q])*
    ...
    ((2*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
     ...
     (2*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      ...
      LAMBDA^2)*((2*cw*cWB*g1^2*vev*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 4]]*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/LAMBDA^2 + ((cw^3*g1 + (cw^3*g1^3)/gw^2)*gw^2*vev*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/(2*cw^2*g1) - 
     (2*cw*cWB*g1^2*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
       ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
      LAMBDA^2))/(2*cw^2*g1^2)], FeynAmp[GraphID[Topology == 1, Generic == 6, 
   Particles == 3, Number == 16], Integral[FourMomentum[Internal, 1]], 
  (gw^2*vev*((4*cw^2*g1^2*lam)/gw^2 + cw^2*g1^2*GaugeXi[Q])*
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
       PropagatorDenominator[FourMomentum[Incoming, 2] + 
  ...
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*vev*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]])/LAMBDA^2 + (I/2)*((cw*g1^2)/gw + cw*gw)^2*vev*
  ...
  (-I)*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((-2*cw*cWB*g1^2*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 5]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/LAMBDA^2 - 
    ((cw^3*g1 + (cw^3*g1^3)/gw^2)*gw^2*vev*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 5]])/(2*cw^2*g1) + 
    (2*cw*cWB*g1^2*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1]])/LAMBDA^2)*
   (((4*I)*cW*gw^2*vev*FourVector[FourMomentum[Incoming, 2] + 
   ...
   (((4*I)*cW*gw^2*vev*FourVector[FourMomentum[Incoming, 2] + 
    ...
    ((4*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
   ...
   (I*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    I*cw*gw*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] - 
    (I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
    ...
    I*cw*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1], Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 5]] + (I*cw*gw*FourVector[FourMomentum[Internal, 1], 
  ...
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
    ...
    (gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 6]])/2)*
   ((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    I*cw*g1*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    (I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
  ...
  -(((-I)*cw*g1*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
     ...
     I*cw*g1*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1] - FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
    (((-2*I)*gw^2*((cw*cWB*g1^2)/gw + 2*cw*cW*gw)*vev*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 1, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ], 
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
    ...
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       ...
       FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)*
   (((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + cw^2*cW*gw^2)*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/LAMBDA^2 + 
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] - ((4*I)*(cw^2*cWB*g1^2 + (cB*cw^2*g1^4)/gw^2 + 
       cw^2*cW*gw^2)*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 2, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
   ...
   ((-2*cw*cWB*g1*gw*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    (2*cw*cWB*g1*gw*vev*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/LAMBDA^2)*
   ((-2*cw*cWB*g1^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/LAMBDA^2 - 
    ((cw^3*g1 + (cw^3*g1^3)/gw^2)*gw^2*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]])/(2*cw^2*g1) + 
    (2*cw*cWB*g1^2*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 3, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 29], 
  ...
  -(((-I)*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     ...
     I*cw*gw*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 5]] - 
     I*cw*gw*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
     ...
     I*cw*gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]] + 
     I*cw*gw*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         1], Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 3], 
       Index[Lorentz, 5]])*(((-2*I)*(2*cw*cW*g1 - cw*cWB*g1)*gw^2*vev*
     ...
     ((4*I)*cw*cW*g1*gw^2*vev*FourVector[FourMomentum[Internal, 1], 
        ...
        Index[Lorentz, 4]])/LAMBDA^2 - ((2*I)*(-2*cw*cW*g1 + cw*cWB*g1)*gw^2*
       vev*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]])/LAMBDA^2 - 
     ((4*I)*cw*cW*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]])/LAMBDA^2 + 
     ((4*I)*cw*cW*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 2] - 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      ...
      Index[Lorentz, 4]])*
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*FourVector[FourMomentum[Incoming, 
        1], Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1], Index[Lorentz, 1]])/LAMBDA^2 + 
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*MetricTensor[Index[Lorentz, 1], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((-2*cw*cWB*g1^2*vev*FourVector[FourMomentum[Incoming, 2], 
    ...
    (2*cw*cWB*g1^2*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  (3*I)*lam*vev*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((-2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*FourVector[FourMomentum[Incoming, 
        1], Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 1]])/LAMBDA^2 + 
    ((2*I)*(-((cw^2*cWB*g1^3)/gw) + cw^2*cWB*g1*gw + 
       (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 2]]*ScalarProduct[FourMomentum[Incoming, 1], 
       FourMomentum[Incoming, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 34], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 3, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  ((I/2)*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (((2*I)*((-2*cB*cw^2*g1^3)/gw - (cw^2*cWB*g1^3)/gw + 2*cw^2*cW*g1*gw + 
        cw^2*cWB*g1*gw)*FourVector[FourMomentum[Incoming, 1], 
        Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2], 
        Index[Lorentz, 1]])/LAMBDA^2 + I*cw*g1*(-((cw*g1^2)/gw) + cw*gw)*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]] + 
     ((2*I)*((cw^2*cWB*g1^3)/gw - cw^2*cWB*g1*gw + 
        (2*cw^2*g1*(cB*g1^2 - cW*gw^2))/gw)*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 2]]*ScalarProduct[FourMomentum[Incoming, 1], 
        FourMomentum[Incoming, 2]])/LAMBDA^2))/(cw^2*g1^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  -((I*cw^2*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     (I*cw^2*g1*gw - ((2*I)*cw^2*g1*gw)/GaugeXi[Q])*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] - 
     (2*I)*cw^2*g1*gw*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])*
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
       PropagatorDenominator[FourMomentum[Internal, 1] + 
    ...
    (((4*I)*cW*gw^2*vev*FourVector[-FourMomentum[Internal, 1], 
     ...
     ((4*I)*cW*gw^2*vev*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
       ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/LAMBDA^2))], 
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    ...
    (gw*FourVector[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 3]])/2)*
   ((2*cw^2*cWB*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
     LAMBDA^2 - (2*cw^2*cWB*g1^3*vev*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
     LAMBDA^2 - (2*cw^2*cWB*g1*gw^2*vev*FourVector[FourMomentum[Incoming, 1], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       ...
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])], 
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 2, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  (-(gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 - 
    (gw*FourVector[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
...
TopologyList[Process -> {V[10], V[20]} -> {S[10]}, 
  Model -> {"Mine/1505.02646.bgf.2"}, GenericModel -> 
   {"Mine/1505.02646.bgf.2"}, InsertionLevel -> {Particles}, 
  ExcludeParticles -> {F, -F[1], F[1], -F[2], F[2], -F[3], F[3], -F[4], F[4], 
    -F[1, {1}], F[1, {1}], -F[1, {2}], F[1, {2}], -F[1, {3}], F[1, {3}], 
    -F[2, {1}], F[2, {1}], -F[2, {2}], F[2, {2}], -F[2, {3}], F[2, {3}], 
    -F[3, {1, _}], F[3, {1, _}], -F[3, {2, _}], F[3, {2, _}], -F[3, {3, _}], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[10], 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> V[10], Field[2] -> V[20], 
      Field[3] -> S[10], Field[4] -> U[31], Field[5] -> -U[31], 
      Field[6] -> U[31]], FeynmanGraph[1, Particles == 3][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> -U[32], 
   ...
   FeynmanGraph[1, Generic == 5][Field[1] -> V[10], Field[2] -> V[20], 
     Field[3] -> S[10], Field[4] -> S, Field[5] -> V, Field[6] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> S[1], 
      Field[5] -> V[2], Field[6] -> S[2]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[10], Field[2] -> V[20], Field[3] -> S[10], 
     ...
     FeynmanGraph[1, Particles == 3][Field[1] -> V[10], Field[2] -> V[20], 
      ...
      Field[6] -> S[3]]], FeynmanGraph[1, Generic == 6][Field[1] -> V[10], 
     Field[2] -> V[20], Field[3] -> S[10], Field[4] -> V, Field[5] -> S, 
     Field[6] -> S] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[10], Field[2] -> V[20], Field[3] -> S[10], 
      Field[4] -> V[2], Field[5] -> S[1], Field[6] -> S[1]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> V[10], Field[2] -> V[20], 
   ...
   FeynmanGraph[1, Generic == 7][Field[1] -> V[10], Field[2] -> V[20], 
     Field[3] -> S[10], Field[4] -> S, Field[5] -> V, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> S[1], 
      Field[5] -> V[2], Field[6] -> V[2]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[10], Field[2] -> V[20], Field[3] -> S[10], 
      Field[4] -> -S[3], Field[5] -> V[3], Field[6] -> -V[3]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> V[10], Field[2] -> V[20], 
      Field[3] -> S[10], Field[4] -> S[3], Field[5] -> -V[3], 
      Field[6] -> V[3]]], FeynmanGraph[1, Generic == 8][Field[1] -> V[10], 
     Field[2] -> V[20], Field[3] -> S[10], Field[4] -> V, Field[5] -> S, 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> V[10], Field[2] -> V[20], 
      Field[3] -> S[10], Field[4] -> V[3], Field[5] -> -S[3], 
      Field[6] -> V[3]]], FeynmanGraph[1, Generic == 9][Field[1] -> V[10], 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[10], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> -V[3], 
      Field[5] -> V[3]]], FeynmanGraph[1, Generic == 3][Field[1] -> V[10], 
     Field[2] -> V[20], Field[3] -> S[10], Field[4] -> S, Field[5] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> -S[3], 
