...
Diag = Diag /. SumOver[_] -> Nc;
 
(* Here I store the result I obtained so far in the file hh2.res. I have to do so, since I have to quit
  the kernel I am working on before loading FeynCalc, which is in conflict with Tracer. *)

FILE = NotebookDirectory[]<>"hh2.res";
