...
decayKinematics := {sp[q1,q1] -> z, sp[q2,q2] -> 0, sp[Ep1,q1] -> 0, sp[Ep2,q2] -> 0}
...
Diag = Diag /. SumOver[___] -> 1;
 
(* Here I store the result I obtained so far in the file Haast2.res. I have to do so, since I have to quit
   the kernel I am working on before loading FeynCalc, which is in conflict with Tracer. *)

FILE = NotebookDirectory[]<>"Haast2.res";
