...
Diag = Diag /. SumOver[___] -> Nc;
 
(* Here I store the result I obtained so far in the file dv2.res. I have to do so, since I have to quit
  the kernel I am working on before loading FeynCalc, which is in conflict with Tracer. *)

FILE = NotebookDirectory[]<>"dv2.res";
