...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  EL*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
   ...
   ((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
      ...
      Index[Lorentz, 1]] + I*EL*FourVector[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      Index[Lorentz, 1]])*(-MH^2/(2*MW*SW) - (MW*GaugeXi[Q])/SW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 2, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
    ...
    ((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
       ...
       Index[Lorentz, 1]] + I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])*GaugeXi[Q])/SW], 
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 3, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
    ...
    ((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
       ...
       Index[Lorentz, 1]] + I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])*GaugeXi[Q])/SW], 
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 4, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MW*Sqrt[GaugeXi[Q]]], PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
    ...
    (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 1]] - I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])*GaugeXi[Q])/SW], 
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  -((EL*MW*((I*EL*FourVector[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  2*EL^3*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 1, Number == 30], 
  ...
  ((-I)*EL*MW*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
    ((-I)*EL^2*(-1 + GaugeXi[Q]^(-1))*MetricTensor[Index[Lorentz, 1], 
       ...
       Index[Lorentz, 4]] - I*EL^2*(-1 + GaugeXi[Q]^(-1))*
