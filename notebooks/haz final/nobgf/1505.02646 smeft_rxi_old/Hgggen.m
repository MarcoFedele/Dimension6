...
ins1 = InsertFields[ top, process1, Model -> "Mine/smeft_test", GenericModel -> "Mine/smeft_test", ExcludeParticles -> {F}, InsertionLevel->{Particles} ];
...
amp0 = CreateFeynAmp[ ins1, Truncated->True,  PreFactor -> 1];
 ...
 amp0 = amp0 /. {TphiW -> cW, TphiWB -> cWB, TphiB -> cB, G1 -> g1, GW -> gw};
