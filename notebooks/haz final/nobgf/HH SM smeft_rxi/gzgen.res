...
FeynAmpList[Process -> {{S[1], FourMomentum[Incoming, 1], MH, {}}} -> 
    {{S[1], FourMomentum[Outgoing, 1], MH, {}}}, Model -> {"Mine/smeft_rxi"}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (3*lam*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH]])/2], FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 2, 
   Number == 2], Integral[FourMomentum[Internal, 1]], 
  (lam*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MZ]])/2], FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, 
   Number == 3], Integral[FourMomentum[Internal, 1]], 
  lam*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MW]]], FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, 
  ...
  (-I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (((4*I)*Lam*(G1^2*TphiB + GW^2*TphiW + G1*GW*TphiWB)*
    ...
    ((4*I)*Lam*(G1^2*TphiB + GW^2*TphiW + G1*GW*TphiWB)*
      ...
      ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[Internal, 1]])/
     (G1^2 + GW^2))], FeynAmp[GraphID[Topology == 1, Generic == 2, 
   Particles == 3, Number == 6], Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 12, Number == 18], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MU], 
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 13, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MC], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MU]]*
   MatrixTrace[NonCommutative[MC + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmu[2, 1]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmu[1, 2]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 14, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MT], 
   ...
   MatrixTrace[NonCommutative[MT + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmu[3, 3]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmu[3, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 15, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MU], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MT]]*
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 16, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MT], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MU]]*
   MatrixTrace[NonCommutative[MT + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmu[3, 1]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmu[1, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 17, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MC], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MT]]*
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 18, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MT], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MC]]*
   MatrixTrace[NonCommutative[MT + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmu[3, 2]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmu[2, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 19, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MD], 
   ...
   MatrixTrace[NonCommutative[MD + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[1, 1]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[1, 1]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 20, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MS], 
   ...
   MatrixTrace[NonCommutative[MS + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[2, 2]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[2, 2]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 21, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MD], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MS]]*
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 22, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MS], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MD]]*
   MatrixTrace[NonCommutative[MS + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[2, 1]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[1, 2]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 23, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MB], 
   ...
   MatrixTrace[NonCommutative[MB + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[3, 3]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[3, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 24, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MD], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MB]]*
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 25, Number == 31], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MB], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MD]]*
   MatrixTrace[NonCommutative[MB + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[3, 1]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[1, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 26, Number == 32], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MS], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MB]]*
   ...
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 27, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MB], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MS]]*
   MatrixTrace[NonCommutative[MB + DiracSlash[-FourMomentum[Internal, 1]]], 
    ...
    ((-I)*Conjugate[fmd[3, 2]]*NonCommutative[ChiralityProjector[-1]])/vev - 
     (I*fmd[2, 3]*NonCommutative[ChiralityProjector[1]])/vev]*
   SumOver[Index[Colour, 3], 3]], 
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 1, Number == 34], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 2, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  (lam^2*vev^2*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MZ], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MZ]])/2], 
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 3, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  lam^2*vev^2*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MW], PropagatorDenominator[
     FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]], 
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 1, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  -(vev^2*(G1^2 + GW^2 + 2*G1*GW*Lam*TphiWB*vev^2)^2*xiZ^2*
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       MghZ], PropagatorDenominator[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], MghZ]])/16], 
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 2, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  -(GW^4*vev^2*xiW^2*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MghWp], PropagatorDenominator[
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MghWp]])/16], 
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 3, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  -(GW^4*vev^2*xiW^2*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MghWm], PropagatorDenominator[
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MghWm]])/16], 
 FeynAmp[GraphID[Topology == 2, Generic == 4, Particles == 1, Number == 40], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 4, Particles == 2, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MZ], 
     ...
     (((4*I)*Lam*(G1^2*TphiB + GW^2*TphiW + G1*GW*TphiWB)*vev*
      ...
      ((4*I)*Lam*(G1^2*TphiB + GW^2*TphiW + G1*GW*TphiWB)*vev*
        ...
        ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]])/(G1^2 + GW^2)))/2], 
 FeynAmp[GraphID[Topology == 2, Generic == 4, Particles == 3, Number == 42], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MF], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], MZ]]*MetricTensor[Index[Lorentz, 1], 
    ...
    (((2*I)*Lam*(2*G1*GW*(-TphiB + TphiW) + G1^2*TphiWB - GW^2*TphiWB)*vev*
     ...
     ((2*I)*Lam*(2*G1*GW*(-TphiB + TphiW) + G1^2*TphiWB - GW^2*TphiWB)*vev*
       ...
       ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1]])/(G1^2 + GW^2)))], 
 FeynAmp[GraphID[Topology == 2, Generic == 4, Particles == 4, Number == 43], 
  Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    ...
    ((4*I)*Lam*TphiW*vev*FourVector[FourMomentum[Internal, 1], 
     ...
     (4*I)*Lam*TphiW*vev*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]]))], 
 FeynAmp[GraphID[Topology == 2, Generic == 5, Particles == 1, Number == 44], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MZ], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MZ]]*
   (((G1^2 + GW^2 + G1*GW*Lam*TphiWB*vev^2)*FourVector[
       FourMomentum[Incoming, 1], Index[Lorentz, 1]])/(2*Sqrt[G1^2 + GW^2]) - 
    ((G1^2 + GW^2 + G1*GW*Lam*TphiWB*vev^2)*FourVector[
       -FourMomentum[Internal, 1], Index[Lorentz, 1]])/(2*Sqrt[G1^2 + GW^2]))*
   (-((G1^2 + GW^2 + G1*GW*Lam*TphiWB*vev^2)*FourVector[
        FourMomentum[Internal, 1], Index[Lorentz, 2]])/
     (2*Sqrt[G1^2 + GW^2]) + ((G1^2 + GW^2 + G1*GW*Lam*TphiWB*vev^2)*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/
     (2*Sqrt[G1^2 + GW^2]))*MetricTensor[Index[Lorentz, 1], 
    Index[Lorentz, 2]]], FeynAmp[GraphID[Topology == 2, Generic == 5, 
   Particles == 2, Number == 45], Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MW]]*
   ((I/2)*GW*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 1]] - 
    (I/2)*GW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])*
   ((I/2)*GW*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]] - 
    (I/2)*GW*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 2]])*
   MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]], 
 FeynAmp[GraphID[Topology == 2, Generic == 5, Particles == 3, Number == 46], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MW]]*
   ...
   MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]]]
ins1=
TopologyList[Process -> {S[1]} -> {S[1]}, Model -> {"Mine/smeft_rxi"}, 
