...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], ME], 
   ...
   MatrixTrace[NonCommutative[ME + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]], 
    ((-I/2)*EL*ME*NonCommutative[ChiralityProjector[-1]])/(MW*SW) - 
     ((I/2)*EL*ME*NonCommutative[ChiralityProjector[1]])/(MW*SW), 
    NonCommutative[ME + DiracSlash[FourMomentum[Incoming, 2] + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 2, Number == 2], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MM], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MM], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MM]]*
   MatrixTrace[NonCommutative[MM + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], ML], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], ML], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], ML]]*
   MatrixTrace[NonCommutative[ML + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]], 
    ((-I/2)*EL*ML*NonCommutative[ChiralityProjector[-1]])/(MW*SW) - 
     ((I/2)*EL*ML*NonCommutative[ChiralityProjector[1]])/(MW*SW), 
    NonCommutative[ML + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1]]], 
    (-I)*EL*NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ChiralityProjector[-1]] - I*EL*NonCommutative[
       DiracMatrix[Index[Lorentz, 2]], ChiralityProjector[1]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 7, Number == 7], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MU], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MU], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MU]]*
   MatrixTrace[NonCommutative[MU + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 13, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MD], 
    PropagatorDenominator[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1], MD], PropagatorDenominator[
     FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MD]]*
   MatrixTrace[NonCommutative[MD + DiracSlash[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MB], 
   ...
   MatrixTrace[NonCommutative[MB + DiracSlash[FourMomentum[Incoming, 2] + 
    ...
    (I/3)*EL*NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
       ...
       DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[1]]]*
   SumOver[Index[Colour, 4], 3]], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 19], 
  Integral[FourMomentum[Internal, 1]], EL*(-MH^2/(2*MW*SW) - MW/SW)*
   ...
   (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 2]] - I*EL*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 2]])*(I*EL*FourVector[-FourMomentum[Internal, 1], 
  ...
  EL*(-MH^2/(2*MW*SW) - MW/SW)*FeynAmpDenominator[
   ...
   ((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1], Index[Lorentz, 2]] + I*EL*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 2]])*((-I)*EL*FourVector[-FourMomentum[Internal, 1], 
      Index[Lorentz, 1]] + I*EL*FourVector[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      Index[Lorentz, 1]])], FeynAmp[GraphID[Topology == 1, Generic == 3, 
  ...
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 1]] - I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]]))/SW], FeynAmp[GraphID[Topology == 1, Generic == 3, 
  ...
  (EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (I*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 1]] - I*EL*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]]))/SW], FeynAmp[GraphID[Topology == 1, Generic == 4, 
   Particles == 1, Number == 25], Integral[FourMomentum[Internal, 1]], 
  -((EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
        1], MW], PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], MW], PropagatorDenominator[
       FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      ...
      Index[Lorentz, 4]]*(I*EL*FourVector[FourMomentum[Incoming, 2] + 
        ...
        Index[Lorentz, 3]] - I*EL*FourVector[-FourMomentum[Internal, 1], 
     ...
     ((-I)*EL*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
      ...
      I*EL*(FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
        ...
        FourVector[-FourMomentum[Incoming, 2] - 2*FourMomentum[Internal, 1], 
          ...
          Index[Lorentz, 7]]))*MetricTensor[Index[Lorentz, 5], 
      Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 6], Index[Lorentz, 8]]*
     MetricTensor[Index[Lorentz, 7], Index[Lorentz, 8]])/SW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  -((EL*MW*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
        1], MW], PropagatorDenominator[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], MW], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 2*EL^3*(-MH^2/(2*MW*SW) - MW/SW)*
   FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 1], 
    Index[Lorentz, 2]]], FeynAmp[GraphID[Topology == 2, Generic == 2, 
   Particles == 1, Number == 28], Integral[FourMomentum[Internal, 1]], 
  (2*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
    MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/SW], 
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 2, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  (2*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
    MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/SW], 
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 1, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  (-2*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], MW]]*
    ...
    MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]])/SW]]
ins1=
TopologyList[Process -> {V[10], V[10]} -> {S[10]}, Model -> {"SMbgf"}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[10], 
     Field[2] -> V[10], Field[3] -> S[10], Field[4] -> F, Field[5] -> F, 
     Field[6] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
      Field[4] -> -F[2, {1}], Field[5] -> F[2, {1}], Field[6] -> -F[2, {1}]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[2, {2}], Field[5] -> F[2, {2}], 
      Field[6] -> -F[2, {2}]], FeynmanGraph[1, Particles == 3][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
      Field[4] -> -F[2, {3}], Field[5] -> F[2, {3}], Field[6] -> -F[2, {3}]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[2, {1}], Field[5] -> -F[2, {1}], 
      Field[6] -> F[2, {1}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
      Field[4] -> F[2, {2}], Field[5] -> -F[2, {2}], Field[6] -> F[2, {2}]], 
     FeynmanGraph[1, Particles == 6][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[2, {3}], Field[5] -> -F[2, {3}], 
      Field[6] -> F[2, {3}]], FeynmanGraph[1, Particles == 7][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
      Field[4] -> -F[3, {1, Index[Colour, 4]}], 
      Field[5] -> F[3, {1, Index[Colour, 4]}], 
      Field[6] -> -F[3, {1, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 8][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[3, {2, Index[Colour, 4]}], 
      Field[5] -> F[3, {2, Index[Colour, 4]}], 
      Field[6] -> -F[3, {2, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 9][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[3, {3, Index[Colour, 4]}], 
      Field[5] -> F[3, {3, Index[Colour, 4]}], 
      Field[6] -> -F[3, {3, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 10][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[3, {1, Index[Colour, 4]}], 
      Field[5] -> -F[3, {1, Index[Colour, 4]}], 
      Field[6] -> F[3, {1, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 11][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[3, {2, Index[Colour, 4]}], 
      Field[5] -> -F[3, {2, Index[Colour, 4]}], 
      Field[6] -> F[3, {2, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 12][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[3, {3, Index[Colour, 4]}], 
      Field[5] -> -F[3, {3, Index[Colour, 4]}], 
      Field[6] -> F[3, {3, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 13][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[4, {1, Index[Colour, 4]}], 
      Field[5] -> F[4, {1, Index[Colour, 4]}], 
      Field[6] -> -F[4, {1, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 14][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[4, {2, Index[Colour, 4]}], 
      Field[5] -> F[4, {2, Index[Colour, 4]}], 
      Field[6] -> -F[4, {2, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 15][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> -F[4, {3, Index[Colour, 4]}], 
      Field[5] -> F[4, {3, Index[Colour, 4]}], 
      Field[6] -> -F[4, {3, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 16][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[4, {1, Index[Colour, 4]}], 
      Field[5] -> -F[4, {1, Index[Colour, 4]}], 
      Field[6] -> F[4, {1, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 17][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[4, {2, Index[Colour, 4]}], 
      Field[5] -> -F[4, {2, Index[Colour, 4]}], 
      Field[6] -> F[4, {2, Index[Colour, 4]}]], 
     FeynmanGraph[1, Particles == 18][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> S[10], Field[4] -> F[4, {3, Index[Colour, 4]}], 
      Field[5] -> -F[4, {3, Index[Colour, 4]}], 
      Field[6] -> F[4, {3, Index[Colour, 4]}]]], 
   FeynmanGraph[1, Generic == 2][Field[1] -> V[10], Field[2] -> V[10], 
     Field[3] -> S[10], Field[4] -> S, Field[5] -> S, Field[6] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> -S[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> S[10], 
   ...
   FeynmanGraph[1, Generic == 3][Field[1] -> V[10], Field[2] -> V[10], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> -U[3], 
     ...
     FeynmanGraph[1, Particles == 3][Field[1] -> V[10], Field[2] -> V[10], 
      ...
      Field[6] -> -U[4]], FeynmanGraph[1, Particles == 4][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> S[10], Field[4] -> U[4], 
