...
ins1 = InsertFields[ top, process1, Model -> "Mine/1505.02646.nobgf.2", GenericModel -> "Mine/1505.02646.nobgf.2", ExcludeParticles -> {S[2], S[3], U[_]}, InsertionLevel->{Particles} ];
