...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  -(gw^2*(cw^2*g1^2 + (4*cw^2*g1^2*lam)/gw^2)*vev*FeynAmpDenominator[
     ...
     ((I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*v2flag*
          vev^2)/(gw*LAMBDA^2))*FourVector[-FourMomentum[Incoming, 2] - 
         FourMomentum[Internal, 1], Index[Lorentz, 2]] - 
      (I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*v2flag*
          vev^2)/(gw*LAMBDA^2))*FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])*
     (((I/2)*((2 - AAAA)*cw*g1*LAMBDA^2 + AAAA*cw*g1*LAMBDA^2 - 
      ...
      ((I/2)*((2 - AAAA)*cw*g1*LAMBDA^2 + AAAA*cw*g1*LAMBDA^2 - 
         ...
         Index[Lorentz, 1]])/LAMBDA^2))/(2*cw^2*g1^2)], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 5], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (I*cw*(gw + (cw^2*cWB*g1^3*OO*v2flag*vev^2)/LAMBDA^2)*
     ...
     ((-I)*cw*gw - (I*cw^3*cWB*g1^4*v2flag*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] + (I*cw*gw + (I*cw^3*cWB*g1^4*v2flag*vev^2)/
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 3, Number == 7], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
    (((-I)*cw*(gw*LAMBDA^2 + cw^2*cWB*g1^3*OO*v2flag*vev^2)*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 2]])/LAMBDA^2 + 
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*v2flag*vev^2)*
       FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/(gw*LAMBDA^2) - 
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*v2flag*vev^2)*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2))*(((-I)*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*v2flag*vev^2)*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 8], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (((-I)*cw*(gw*LAMBDA^2 + cw^2*cWB*g1^3*OO*v2flag*vev^2)*
     ...
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*v2flag*vev^2)*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2))*(((-I)*cw*g1 + (I*cw^3*cWB*g1^3*v2flag*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 12], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   (-(gw*xxx*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
          1], Index[Lorentz, 4]])/2 + 
    (gw*(2 - xxx)*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]])/
     2 - (gw*xxx*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 1, Number == 17], 
  ...
  (gw^2*(cw^2*g1^2 + (4*cw^2*g1^2*lam)/gw^2)*vev*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 23], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   (-(gw*xxx*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
          1], Index[Lorentz, 6]])/2 + 
    (gw*(2 - xxx)*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 6]])/
     2 - (gw*xxx*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
   ...
   (-(gw*xxx*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
    ...
    (gw*(2 - xxx)*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 6]])/
     2 - (gw*xxx*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]])/2)*MetricTensor[Index[Lorentz, 3], 
    Index[Lorentz, 4]]*(((-I)*cw*gw - (I*cw^3*cWB*g1^4*v2flag*vev^2)/
       (gw*LAMBDA^2) + (I*cw*cWB*g1^2*gw*v2flag*vev^2)/LAMBDA^2)*
     FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
    (I*cw*gw + (I*cw^3*cWB*g1^4*v2flag*vev^2)/(gw*LAMBDA^2))*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     (I*cw*gw + (I*cw^3*cWB*g1^4*v2flag*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 3]] + (I*cw*gw + (I*cw^3*cWB*g1^4*v2flag*vev^2)/
        (gw*LAMBDA^2) - (I*cw*cWB*g1^2*gw*v2flag*vev^2)/LAMBDA^2)*
     ...
     ((-I)*cw*gw - (I*cw^3*cWB*g1^4*v2flag*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 5]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*v2flag*vev^2)/
        (gw*LAMBDA^2))*FourVector[-FourMomentum[Internal, 1], 
    ...
    MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]])], 
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 1, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    PropagatorDenominator[-FourMomentum[Incoming, 2] + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 36], 
  ...
  ((I/4)*gw^2*(g1^2 + (4*cw^2*g1^2*lam)/gw^2)*vev*
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 3, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  ((I/2)*gw^2*(cw^2*g1^2 + (4*cw^2*g1^2*lam)/gw^2)*vev*
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MW]]*
    (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(g1^2 - gw^2))*
      ...
      (gw*LAMBDA^2) + ((I/2)*(-(cw^2*g1^3*LAMBDA^2) + cw^2*g1*gw^2*LAMBDA^2 + 
        cw^2*g1*(-g1^2 + gw^2)*LAMBDA^2 + 4*cw^4*cWB*g1^3*(g1^2 - gw^2)*
         v2flag*vev^2)*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2) + ((2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + 
        cWB*(g1^2 - gw^2))*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
       ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 39], 
  Integral[FourMomentum[Internal, 1]], (-I/2)*gw^2*vev*
   ((2*I)*cw^2*g1*gw + ((2*I)*cw^4*cWB*g1^3*(g1 - gw)*(g1 + gw)*v2flag*vev^2)/
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 41], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]]*((((-I)*cw^4*cWB*g1^3*(g1^2 - gw^2)*v2flag*vev^2 - 
        I*(-(cw^2*g1*gw^2*LAMBDA^2) + cw^4*cWB*g1^3*(-g1^2 + gw^2)*v2flag*
           vev^2))*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/(gw*LAMBDA^2) + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 4, Particles == 1, Number == 42], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   (-(gw*xxx*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]])/2 + 
    (gw*(2 - xxx)*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/
     2 - (gw*xxx*FourVector[FourMomentum[Internal, 1] + 
