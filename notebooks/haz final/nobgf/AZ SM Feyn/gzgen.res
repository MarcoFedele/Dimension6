...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], MF, {}}} -> 
    {{V[2], FourMomentum[Outgoing, 1], MZ, {}}}, Model -> {"Mine/smeft_rxi"}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MZ]]*(((2*I)*Lam*(2*G1*GW*(-TphiB + TphiW) + G1^2*TphiWB - GW^2*TphiWB)*
      FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/
     (G1^2 + GW^2) - ((2*I)*Lam*(2*G1*GW*(-TphiB + TphiW) + G1^2*TphiWB - 
       GW^2*TphiWB)*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW]]*
   (((-2*I)*Lam*(2*G1*GW*(TphiB - TphiW) + G1^2*TphiWB - GW^2*TphiWB)*
      FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/
     (G1^2 + GW^2) - (I*G1*(G1 - GW)*GW*(G1 + GW)*
      (G1^2 + GW^2 - 2*G1*GW*Lam*TphiWB*vev^2)*MetricTensor[
       Index[Lorentz, 1], Index[Lorentz, 2]])/(G1^2 + GW^2)^2 + 
    ((2*I)*Lam*(2*G1*GW*(TphiB - TphiW) + G1^2*TphiWB - GW^2*TphiWB)*
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 5], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
    ...
    (((-I/2)*(G1 - GW)*(G1 + GW)*(G1^2 + GW^2 - G1*GW*Lam*TphiWB*vev^2)*
      ...
      (G1^2 + GW^2)^(3/2) + ((I/2)*(G1 - GW)*(G1 + GW)*
       (G1^2 + GW^2 - G1*GW*Lam*TphiWB*vev^2)*FourVector[
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  (G1*GW^2*(G1^2*GW + GW^3 + G1^3*Lam*TphiWB*vev^2)*
    (G1^2 + GW^2 - G1*GW*Lam*TphiWB*vev^2)*FeynAmpDenominator[
     PropagatorDenominator[FourMomentum[Internal, 1], MghWp], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 3, Particles == 2, Number == 28], 
  ...
  (G1*GW^2*(G1^2*GW + GW^3 + G1^3*Lam*TphiWB*vev^2)*
    (G1^2 + GW^2 - G1*GW*Lam*TphiWB*vev^2)*FeynAmpDenominator[
     PropagatorDenominator[FourMomentum[Internal, 1], MghWm], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 5, Particles == 3, Number == 32], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
   ...
   (((-2*I)*G1*Lam*TphiWB*vev*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]])/Sqrt[G1^2 + GW^2] - 
    ((I/2)*G1*GW*vev*(G1^3 + G1*GW^2 + GW^3*Lam*TphiWB*vev^2)*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/
     (G1^2 + GW^2)^(3/2) + ((2*I)*G1*Lam*TphiWB*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[-FourMomentum[Outgoing, 1], -FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/Sqrt[G1^2 + GW^2])], 
    ...
    ((I/2)*G1*GW*vev*(G1^3 + G1*GW^2 + GW^3*Lam*TphiWB*vev^2)*
     ...
     (G1^2 + GW^2)^(3/2) + ((2*I)*G1*Lam*TphiWB*vev*
      ...
      ScalarProduct[-FourMomentum[Outgoing, 1], -FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1]])/Sqrt[G1^2 + GW^2])]]
ins1=
TopologyList[Process -> {V[1]} -> {V[2]}, Model -> {"Mine/smeft_rxi"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][3], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[1], 
     ...
     FeynmanGraph[2, Particles == 1][Field[1] -> V[1], Field[2] -> V[2], 
      ...
      Field[2] -> V[2], Field[3] -> S[2]], FeynmanGraph[1, Particles == 3][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> -S[3]]], 
   FeynmanGraph[2, Generic == 2][Field[1] -> V[1], Field[2] -> V[2], 
     Field[3] -> V] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> -V[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][3], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[1], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
     ...
     FeynmanGraph[1, Particles == 10][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[3, {3, 1}], Field[4] -> F[3, {3, 1}]], 
     FeynmanGraph[1, Particles == 11][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[3, {3, 2}], Field[4] -> F[3, {3, 2}]], 
     FeynmanGraph[1, Particles == 12][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[3, {3, 3}], Field[4] -> F[3, {3, 3}]], 
     FeynmanGraph[1, Particles == 13][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {1, 1}], Field[4] -> F[4, {1, 1}]], 
     FeynmanGraph[1, Particles == 14][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {1, 2}], Field[4] -> F[4, {1, 2}]], 
     FeynmanGraph[1, Particles == 15][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {1, 3}], Field[4] -> F[4, {1, 3}]], 
     FeynmanGraph[1, Particles == 16][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {2, 1}], Field[4] -> F[4, {2, 1}]], 
     FeynmanGraph[1, Particles == 17][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {2, 2}], Field[4] -> F[4, {2, 2}]], 
     FeynmanGraph[1, Particles == 18][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {2, 3}], Field[4] -> F[4, {2, 3}]], 
     FeynmanGraph[1, Particles == 19][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {3, 1}], Field[4] -> F[4, {3, 1}]], 
     FeynmanGraph[1, Particles == 20][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -F[4, {3, 2}], Field[4] -> F[4, {3, 2}]], 
     FeynmanGraph[1, Particles == 21][Field[1] -> V[1], Field[2] -> V[2], 
   ...
   FeynmanGraph[2, Generic == 3][Field[1] -> V[1], Field[2] -> V[2], 
     Field[3] -> U, Field[4] -> U] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> -U[31], Field[4] -> U[31]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> -U[32], 
      Field[4] -> U[32]]], FeynmanGraph[2, Generic == 4][Field[1] -> V[1], 
     Field[2] -> V[2], Field[3] -> V, Field[4] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      Field[2] -> V[2], Field[3] -> -V[3], Field[4] -> V[3]]], 
   FeynmanGraph[1, Generic == 5][Field[1] -> V[1], Field[2] -> V[2], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[1], Field[2] -> V[2], 
      ...
      Field[2] -> V[2], Field[3] -> -S[3], Field[4] -> V[3]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> V[1], Field[2] -> V[2], 
