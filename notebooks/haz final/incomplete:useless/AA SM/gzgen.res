...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}} -> 
    {{V[10], FourMomentum[Outgoing, 1], 0, {}}}, Model -> {"SMbgf"}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  -2*EL^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MW*Sqrt[GaugeXi[Q]]]]*MetricTensor[Index[Lorentz, 1], 
    Index[Lorentz, 2]]], FeynAmp[GraphID[Topology == 1, Generic == 2, 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 2, Particles == 1, Number == 14], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (I*EL*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
  ...
  -(((I*EL*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       ...
       Index[Lorentz, 6]]))]]
ins1=
TopologyList[Process -> {V[10]} -> {V[10]}, Model -> {"SMbgf"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][3], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[10], 
     Field[2] -> V[10], Field[3] -> S] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> -S[3]]], FeynmanGraph[2, Generic == 2][Field[1] -> V[10], 
     Field[2] -> V[10], Field[3] -> U] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> -U[3]], FeynmanGraph[1, Particles == 2][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> -U[4]]], 
   FeynmanGraph[2, Generic == 3][Field[1] -> V[10], Field[2] -> V[10], 
     Field[3] -> V] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> -V[3]]]], 
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][3], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[10], 
     Field[2] -> V[10], Field[3] -> F, Field[4] -> F] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> -F[2, {1}], Field[4] -> F[2, {1}]], 
     ...
     FeynmanGraph[1, Particles == 5][Field[1] -> V[10], Field[2] -> V[10], 
     ...
     FeynmanGraph[1, Particles == 7][Field[1] -> V[10], Field[2] -> V[10], 
   ...
   FeynmanGraph[2, Generic == 2][Field[1] -> V[10], Field[2] -> V[10], 
   ...
   FeynmanGraph[2, Generic == 3][Field[1] -> V[10], Field[2] -> V[10], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[10], Field[2] -> V[10], 
      Field[3] -> -U[3], Field[4] -> U[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[10], Field[2] -> V[10], Field[3] -> -U[4], 
      Field[4] -> U[4]]], FeynmanGraph[2, Generic == 4][Field[1] -> V[10], 
     Field[2] -> V[10], Field[3] -> V, Field[4] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[10], Field[3] -> -V[3], Field[4] -> V[3]]]]]
