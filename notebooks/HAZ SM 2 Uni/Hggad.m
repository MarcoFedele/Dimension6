...
diag = diagSimplify[diag] /. {Power[q1, n_] :> 0 /; n > 0};
          ...
          If[checkdiag[[DIAG]] == 1,
                      ...
                      If[count[[DIAG, TERM]] == {1, 0},
                         ...
                         If[count[[DIAG, TERM]] == {1, 1},
                            ...
                            If[count[[DIAG, TERM]] == {1, 2},
                               ...
                               temp1 = temp1 //. PVsub;
                               temp0 = Append[temp0, temp1[[1]]],
                               If[count[[DIAG, TERM]] == {1, 3},
                                  temp1 = ExpandSProducts[temp[[DIAG,TERM]] /. rule13 /. rule12shift /. rule12];
                                  temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0};
                                  temp1 = temp1 //. PVsub;
                                  temp0 = Append[temp0, temp1[[1]]],
                                  If[count[[DIAG, TERM]] == {1, 4},
                                     temp1 = ExpandSProducts[temp[[DIAG,TERM]] /. rule14shift /. rule13 /. rule12shift /. rule12];
                                     temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0};
                                     temp1 = temp1 //. PVsub;
                                     temp0 = Append[temp0, temp1[[1]]],
             ...
             If[count[[DIAG]][[1]] == {0, 0},
                ...
                If[count[[DIAG]][[1]] == {0, 2},
                   temp0 = Append[temp0, 0],
                   If[count[[DIAG]][[1]] == {1, 0},
                      temp1 = temp[[DIAG]] /. {Power[q1, n_] :> 0 /; n > 0};
                      temp1 = temp1 //. PVsub;
                      temp0 = Append[temp0, temp1],
                      If[count[[DIAG]] == {1, 1},
                         ...
                         If[count[[DIAG]][[1]] == {1, 2},
                            ...
                            temp0 = Append[temp0, temp1[[1]]],
                            If[count[[DIAG]][[1]] == {1, 3},
                               temp1 = ExpandSProducts[temp[[DIAG]] /. rule13 /. rule12shift /. rule12];
                               temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0};
                               temp1 = temp1 //. PVsub;
                               temp0 = Append[temp0, temp1[[1]]],
                               If[count[[DIAG]][[1]] == {1, 4},
                                  temp1 = ExpandSProducts[temp[[DIAG]] /. rule14shift /. rule13 /. rule12shift /. rule12];
                                  temp1 = diagSimplify[{temp1}] /. {Power[q1, n_] :> 0 /; n > 0};
                                  temp1 = temp1 //. PVsub;
                                  temp0 = Append[temp0, temp1[[1]]],
                                  If[count[[DIAG]][[1]] == {2, 0},
