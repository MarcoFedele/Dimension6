...
FeynAmpList[Process -> {{V[10], FourMomentum[Incoming, 1], 0, {}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  -(gw^2*vev*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
     ...
     ((I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*vev^2)/
      ...
      (I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*vev^2)/
        ...
        Index[Lorentz, 2]])*
     (((I/2)*(2*cw*g1*LAMBDA^2 - 2*cw^3*cWB*g1^3*vev^2)*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 5], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      MW*Sqrt[GaugeXi[Q]]]]*(I*cw*(gw + (cw^2*cWB*g1^3*OO*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 2]] + 
     ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])*
    (I*(-(cw*g1) + (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
     (I*cw*g1 - (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 6], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
       Index[Lorentz, 2]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
        (gw*LAMBDA^2))*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 2]])*((I*cw*g1 - (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
     I*(-(cw*g1) + (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*GaugeXi[Q])/2], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 3, Number == 7], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      MW*Sqrt[GaugeXi[Q]]]]*(((-I)*cw*(gw*LAMBDA^2 + cw^2*cWB*g1^3*OO*vev^2)*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 2]])/LAMBDA^2 + 
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*vev^2)*
       FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 2]])/(gw*LAMBDA^2) - 
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*vev^2)*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2))*(((-I)*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*vev^2)*
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/LAMBDA^2 + 
     ((-I)*cw*g1 + (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])*GaugeXi[Q])/2], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 8], 
  ...
  (gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
     ...
     (I*(cw*gw^2*LAMBDA^2 + cw^3*cWB*g1^4*vev^2)*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2))*(((-I)*cw*g1 + (I*cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]] - 
     (I*(-(cw*g1*LAMBDA^2) + cw^3*cWB*g1^3*vev^2)*
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
  ...
  I*(((-I)*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     ((I*cw*g1)/GaugeXi[Q] - (I*cw^3*cWB*g1^3*vev^2)/(LAMBDA^2*GaugeXi[Q]))*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
    (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]]*
     (((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 5]] - (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
   ...
   ((I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2) - 
      (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*FourVector[FourMomentum[Incoming, 
       2], Index[Lorentz, 7]]*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2))*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 7]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
    FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 7]]*(((-I)*cw*gw)/GaugeXi[Q] - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2) + (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     ((I*cw*gw)/GaugeXi[Q] + (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 7]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2))*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 2, Number == 10], 
  ...
  I*((I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + cw*cWB*g1*gw^2*vev^2)*
    ...
    FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     (((-I)*cw*g1)/GaugeXi[Q] + (I*cw^3*cWB*g1^3*vev^2)/
       (LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 1], 
      Index[Lorentz, 3]] - (I*(cw*g1*LAMBDA^2 - cw^3*cWB*g1^3*vev^2 + 
       cw*cWB*g1*gw^2*vev^2)*FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]])/
     LAMBDA^2 + I*(cw*g1 - (cw^3*cWB*g1^3*vev^2)/LAMBDA^2)*
     FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] + 
    FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]]*
   ...
   (((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2) + 
      (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*FourVector[FourMomentum[Incoming, 
       2], Index[Lorentz, 7]]*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     (((-I)*cw*gw)/GaugeXi[Q] - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 7]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 2, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  I*(((I/2)*(2*cw*g1*LAMBDA^2 - 2*cw^3*cWB*g1^3*vev^2)*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/LAMBDA^2 - 
    ((I/2)*(2*cw*g1*LAMBDA^2 - 2*cw^3*cWB*g1^3*vev^2)*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/LAMBDA^2)*
   ...
   (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(-g1^2 + gw^2))*vev*
    ...
    ((2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(-g1^2 + gw^2))*vev*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]])/
     (gw*LAMBDA^2))], FeynAmp[GraphID[Topology == 1, Generic == 5, 
   Particles == 2, Number == 15], Integral[FourMomentum[Internal, 1]], 
  I*((I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*vev^2)/
       (gw*LAMBDA^2))*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]] - 
    (I/2)*(-((cw*g1^2)/gw) + cw*gw + (cw^3*cWB*g1^2*(g1^2 - gw^2)*vev^2)/
       (gw*LAMBDA^2))*FourVector[FourMomentum[Internal, 1], 
  ...
  6*lam*vev*(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
   ...
   (((4*I)*cw^2*(cB*g1^4 + cWB*g1^2*gw^2 + cW*gw^4)*vev*
    ...
    ((4*I)*cw^2*(cB*g1^4 + cWB*g1^2*gw^2 + cW*gw^4)*vev*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 2], FourMomentum[Internal, 1]])/
     (gw^2*LAMBDA^2))], FeynAmp[GraphID[Topology == 1, Generic == 6, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 23], 
  ...
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
   ...
   ((I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2) - 
      (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*FourVector[FourMomentum[Incoming, 
       2], Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2))*FourVector[FourMomentum[Internal, 1], 
      Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
    FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      Index[Lorentz, 5]]*(((-I)*cw*gw)/GaugeXi[Q] - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 4]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2) + (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*
     FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     ((I*cw*gw)/GaugeXi[Q] + (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 5]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2))*FourVector[-FourMomentum[Incoming, 2] - 
       FourMomentum[Internal, 1], Index[Lorentz, 2]]*
  ...
  (-I)*(-(gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
   ...
   (((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2) + 
    ...
    FourVector[FourMomentum[Internal, 1], Index[Lorentz, 4]]*
     (((-I)*cw*gw)/GaugeXi[Q] - (I*cw^3*cWB*g1^4*vev^2)/
       (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
      Index[Lorentz, 5]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(-g1^2 + gw^2))*vev*
    ...
    (I/2)*((cw*g1^2)/gw + cw*gw)^2*MetricTensor[Index[Lorentz, 2], 
      ...
      ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]])/
     (gw^2*LAMBDA^2))], FeynAmp[GraphID[Topology == 3, Generic == 2, 
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 32], 
  ...
  -((((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2) + 
       (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*FourVector[FourMomentum[Incoming, 
        2], Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 3]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]] + 
     FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*((I*cw*gw)/GaugeXi[Q] + (I*cw^3*cWB*g1^4*vev^2)/
        (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 3]] + (I*cw*gw + (I*cw^3*cWB*g1^4*vev^2)/
        (gw*LAMBDA^2) - (I*cw*cWB*g1^2*gw*vev^2)/LAMBDA^2)*
     ...
     ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/(gw*LAMBDA^2))*
      FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
       ...
       Index[Lorentz, 5]] + FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 3]]*(((-I)*cw*gw)/GaugeXi[Q] - (I*cw^3*cWB*g1^4*vev^2)/
        (gw*LAMBDA^2*GaugeXi[Q]))*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 5]] + ((-I)*cw*gw - (I*cw^3*cWB*g1^4*vev^2)/
        (gw*LAMBDA^2))*FourVector[-FourMomentum[Internal, 1], 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 36], 
  ...
  (3*I)*lam*vev*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(-g1^2 + gw^2))*
     ...
     (gw*LAMBDA^2) + ((2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + 
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
     (gw*LAMBDA^2))], FeynAmp[GraphID[Topology == 5, Generic == 1, 
   Particles == 2, Number == 37], Integral[FourMomentum[Internal, 1]], 
  ((I/4)*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(-g1^2 + gw^2))*
       ...
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]])/
      (gw*LAMBDA^2) + ((2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + 
        cWB*(-g1^2 + gw^2))*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 2]]*ScalarProduct[FourMomentum[Incoming, 1], 
        FourMomentum[Incoming, 2]])/(gw*LAMBDA^2)))/(cw^2*g1^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 3, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  ((I/2)*gw^2*vev*FeynAmpDenominator[PropagatorDenominator[
    ...
    (((-2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + cWB*(g1^2 - gw^2))*
       FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]])/
      (gw*LAMBDA^2) + ((I/2)*(-(cw^2*g1^3*LAMBDA^2) + cw^2*g1*gw^2*LAMBDA^2 + 
        cw^2*g1*(-g1^2 + gw^2)*LAMBDA^2 + 4*cw^4*cWB*g1^3*(g1^2 - gw^2)*
         vev^2)*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/
      (gw*LAMBDA^2) + ((2*I)*cw^2*g1*(2*cB*g1^2 - 2*cW*gw^2 + 
        cWB*(g1^2 - gw^2))*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
       ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
      (gw*LAMBDA^2)))/(cw^2*g1^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 2, Particles == 1, Number == 39], 
  Integral[FourMomentum[Internal, 1]], (-I/2)*gw^2*vev*
   ((2*I)*cw^2*g1*gw + ((2*I)*cw^4*cWB*g1^3*(g1 - gw)*(g1 + gw)*vev^2)/
     (gw*LAMBDA^2))*FeynAmpDenominator[PropagatorDenominator[
     FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[Q]]], 
    PropagatorDenominator[FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 3, Particles == 1, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  -(((((-I)*cw^4*cWB*g1^3*(g1^2 - gw^2)*vev^2 - 
        I*(-(cw^2*g1*gw^2*LAMBDA^2) + cw^4*cWB*g1^3*(-g1^2 + gw^2)*vev^2)*
         GaugeXi[Q])*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/
      (gw*LAMBDA^2*GaugeXi[Q]) + 
     (I*(I*cw^3*g1^2*((2*I)*gw*LAMBDA^2 + (I*cw^2*cWB*g1^4*vev^2)/gw - 
          I*cw^2*cWB*g1^2*gw*vev^2) + (cw^2*g1*(cw*g1*gw^2*LAMBDA^2 + 
           cw^3*cWB*g1^5*vev^2 - cw^3*cWB*g1^3*gw^2*vev^2)*GaugeXi[Q])/gw)*
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]])/
      (cw*g1*LAMBDA^2*GaugeXi[Q]) + 
     ((2*I)*cw*(-(cw*g1*gw^2*LAMBDA^2) - cw^3*cWB*g1^5*vev^2 + 
        cw^3*cWB*g1^3*gw^2*vev^2)*MetricTensor[Index[Lorentz, 1], 
        Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 4], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[10], 
   ...
   FeynmanGraph[1, Generic == 2][Field[1] -> V[10], Field[2] -> V[20], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[10], 
      Field[2] -> V[20], Field[3] -> S[10], Field[4] -> -U[31], 
   ...
   FeynmanGraph[1, Generic == 8][Field[1] -> V[10], Field[2] -> V[20], 
