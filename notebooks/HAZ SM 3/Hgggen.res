...
FeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
    ...
    {{S[1], FourMomentum[Outgoing, 1], MH, {}}}, Model -> {"SM"}, 
  ...
  -(EL^3*MH^2*(-CW^2 + SW^2)*FeynAmpDenominator[PropagatorDenominator[
     ...
     FourVector[-FourMomentum[Incoming, 2] - 2*FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], Index[Lorentz, 1]])/(4*CW*MW*SW^2)], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 1, Number == 3], 
  Integral[FourMomentum[Internal, 1]], 
  (CW*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[W]]], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[W]]], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
     ...
     Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
     Index[Lorentz, 1]]*GaugeXi[W])/(2*SW^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 2, Number == 4], 
  ...
  (CW*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
    ...
    FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*GaugeXi[W])/
   (2*SW^2)], FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 3, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 4, Number == 6], 
  ...
  (CW*EL^3*MW*FeynAmpDenominator[PropagatorDenominator[
     ...
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
      ...
      FourMomentum[Internal, 1], Index[Lorentz, 2]]*
    FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*GaugeXi[W])/
   (2*SW^2)], FeynAmp[GraphID[Topology == 1, Generic == 3, Particles == 1, 
   Number == 7], Integral[FourMomentum[Internal, 1]], 
  (CW*EL^3*MW*(FourVector[-FourMomentum[Incoming, 1] - FourMomentum[Internal, 
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 7], Index[Lorentz, 8]]))/SW^2], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 4, Particles == 1, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
        1] - 2*FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
     FourVector[-FourMomentum[Incoming, 2] - 2*FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], Index[Lorentz, 1]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 5, Particles == 1, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*(-CW^2 + SW^2)*FourVector[FourMomentum[Incoming, 2] + 
       2*FourMomentum[Internal, 1], Index[Lorentz, 2]]*
     FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] - 
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
         ...
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
        Index[Lorentz, 4]]))/(4*CW*SW^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 6, Particles == 1, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MH^2*MW*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       ...
       (1 - GaugeXi[W]) + FeynAmpDenominator[PropagatorDenominator[
         ...
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[W]]]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]))/(2*CW)], 
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       ...
       (1 - GaugeXi[W]) + FeynAmpDenominator[PropagatorDenominator[
         ...
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[W]]]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 1, Number == 15], 
  Integral[FourMomentum[Internal, 1]], 
  -((EL^3*MW^3*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
        ...
        Index[Lorentz, 6]]))/CW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 7, Particles == 2, Number == 16], 
  Integral[FourMomentum[Internal, 1]], 
  -((EL^3*MW^3*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 5]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]]*
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
        ...
        Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 5], 
        Index[Lorentz, 6]]))/CW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 1, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (CW*EL^3*MW*FourVector[FourMomentum[Incoming, 2] + 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Incoming, 2] + 
        ...
        FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[W]]]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))/(2*SW^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 8, Particles == 2, Number == 18], 
  Integral[FourMomentum[Internal, 1]], 
  (CW*EL^3*MW*FourVector[FourMomentum[Incoming, 2] + 
      FourMomentum[Internal, 1] - 2*FourMomentum[Outgoing, 1], 
     Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
    ...
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
      ...
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))/(2*SW^2)], 
 FeynAmp[GraphID[Topology == 1, Generic == 9, Particles == 1, Number == 19], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
        ...
        PropagatorDenominator[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], MW]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 1, Generic == 9, Particles == 2, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
        1] - FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
       ...
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
         ...
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1], MW]]*MetricTensor[Index[Lorentz, 3], 
        Index[Lorentz, 4]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
     ...
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
         ...
         -FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MW]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MW*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 3]]*
     (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      ...
      FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
         ...
         -FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MW]]*
       MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]))/(2*CW)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  -(EL^3*MH^2*(-CW^2 + SW^2)*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[W]]], 
      PropagatorDenominator[FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], MW*Sqrt[GaugeXi[W]]]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/(2*CW*MW*SW^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 2, Particles == 1, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*EL*MW*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
    (((-I)*CW*EL^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])/SW - 
     (I*CW*EL^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]])/SW + 
     ((2*I)*CW*EL^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
       MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])/SW)*
    (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       PropagatorDenominator[FourMomentum[Internal, 1], MW*Sqrt[GaugeXi[W]]], 
       PropagatorDenominator[FourMomentum[Internal, 1] + 
         FourMomentum[Outgoing, 1], MW], PropagatorDenominator[
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MW], 
       ...
       Index[Lorentz, 6]]))/SW]]
ins1=
TopologyList[Process -> {V[1], V[2]} -> {S[1]}, Model -> {"SM"}, 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[1], 
     ...
     Field[2] -> V[2], Field[3] -> S[1], Field[4] -> U, Field[5] -> U, 
     Field[6] -> U] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], 
      Field[4] -> -U[3], Field[5] -> U[3], Field[6] -> -U[3]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> V[1], Field[2] -> V[2], 
      Field[3] -> S[1], Field[4] -> U[3], Field[5] -> -U[3], 
      Field[6] -> U[3]], FeynmanGraph[1, Particles == 3][Field[1] -> V[1], 
      Field[2] -> V[2], Field[3] -> S[1], Field[4] -> -U[4], 
      Field[5] -> U[4], Field[6] -> -U[4]], FeynmanGraph[1, Particles == 4][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], Field[4] -> U[4], 
   ...
   FeynmanGraph[1, Generic == 3][Field[1] -> V[1], Field[2] -> V[2], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      ...
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], Field[4] -> V[3], 
      Field[5] -> -V[3], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 4][Field[1] -> V[1], Field[2] -> V[2], 
     Field[3] -> S[1], Field[4] -> S, Field[5] -> S, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      Field[2] -> V[2], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> -V[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], Field[4] -> S[3], 
   ...
   FeynmanGraph[1, Generic == 6][Field[1] -> V[1], Field[2] -> V[2], 
   ...
   FeynmanGraph[1, Generic == 7][Field[1] -> V[1], Field[2] -> V[2], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      ...
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], Field[4] -> S[3], 
      Field[5] -> -V[3], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 8][Field[1] -> V[1], Field[2] -> V[2], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[1], 
      ...
      Field[1] -> V[1], Field[2] -> V[2], Field[3] -> S[1], Field[4] -> V[3], 
      Field[5] -> -S[3], Field[6] -> V[3]]], 
   FeynmanGraph[1, Generic == 9][Field[1] -> V[1], Field[2] -> V[2], 
