...
FeynAmpList[Process -> {{F[6], FourMomentum[Incoming, 1], 0, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 4, Number == 4], 
  Integral[FourMomentum[Internal, 1]], 
  (cHD*FermionChain[(-(HC[yl[3, 3]]*NonCommutative[ChiralityProjector[-1]]) + 
       NonCommutative[ChiralityProjector[1]]*yl[3, 3])/Sqrt[2]]*
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], MGP]]*
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     cHD*ScalarProduct[-FourMomentum[Outgoing, 2], 
       ...
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2], FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]]))/
   (4*LAMBDA^4)], FeynAmp[GraphID[Topology == 2, Generic == 1, 
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     cHD*ScalarProduct[-FourMomentum[Outgoing, 3], 
       ...
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 3], FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 3]]))/
   (4*LAMBDA^4)], FeynAmp[GraphID[Topology == 3, Generic == 1, 
 ...
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 4, Number == 12], 
  Integral[FourMomentum[Internal, 1]], 
  -(cHD*FermionChain[(-(HC[yl[3, 3]]*NonCommutative[ChiralityProjector[
...
TopologyList[Process -> {F[6], -F[6]} -> {S[1], S[1], S[1]}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][6], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> F[6], 
    ...
    Insertions[Particles][FeynmanGraph[2, Particles == 1][Field[1] -> F[6], 
      Field[2] -> -F[6], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[1], Field[6] -> S[1], Field[7] -> S[1], 
      Field[8] -> S[1]], FeynmanGraph[2, Particles == 2][Field[1] -> F[6], 
      Field[2] -> -F[6], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[1], Field[6] -> S[1], Field[7] -> S[2], 
      Field[8] -> S[2]], FeynmanGraph[1, Particles == 3][Field[1] -> F[6], 
      Field[2] -> -F[6], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> S[1], Field[6] -> S[1], Field[7] -> -S[3], 
      Field[8] -> S[3]], FeynmanGraph[1, Particles == 4][Field[1] -> F[6], 
      Field[2] -> -F[6], Field[3] -> S[1], Field[4] -> S[1], 
