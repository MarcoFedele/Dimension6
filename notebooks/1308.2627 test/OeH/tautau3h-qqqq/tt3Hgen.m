...
process1 = {F[6], -F[6]} -> {S[1], S[1], S[1]};

top = CreateTopologies[1, 2 -> 3, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, SelfEnergies, Boxes, Pentagons}];

ins1 = InsertFields[ top[[73]], process1, Model -> "Mine/1308.2627.4f", GenericModel -> "Mine/1308.2627.4f", ExcludeParticles -> {V, F[1|2|3]}, InsertionLevel->{Particles} ];
