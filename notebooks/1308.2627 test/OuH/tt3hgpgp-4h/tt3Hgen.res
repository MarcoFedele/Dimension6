...
FeynAmpList[Process -> {{F[9, {Index[Colour, 1]}], FourMomentum[Incoming, 1], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((I/4)*FermionChain[((-I)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     4*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2]] + 2*cHBOX*ScalarProduct[
       FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
  ...
  ((-I/4)*cHD^2*FermionChain[((-I)*IndexDelta[Index[Colour, 1], 
        Index[Colour, 2]]*(HC[yu[3, 3]]*NonCommutative[ChiralityProjector[
    ...
    (ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] - 
     ...
     ScalarProduct[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
       ...
       FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]] + 
     ScalarProduct[-FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
       FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/LAMBDA^4], FeynAmp[GraphID[Topology == 1, Generic == 1, 
   Particles == 3, Number == 3], Integral[FourMomentum[Internal, 1]], 
  (cHD*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
       (HC[yu[3, 3]]*NonCommutative[ChiralityProjector[-1]] - 
        NonCommutative[ChiralityProjector[1]]*yu[3, 3]))/Sqrt[2]]*
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
    ...
    (ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] - 
     ...
     ScalarProduct[-FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
       FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/(4*LAMBDA^4)], FeynAmp[GraphID[Topology == 1, Generic == 1, 
     ...
     (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
      ...
      cHD*ScalarProduct[-FourMomentum[Outgoing, 3], 
        ...
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2] + 
         ...
         FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
     SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
      External])/(4*LAMBDA^4)], FeynAmp[GraphID[Topology == 2, Generic == 1, 
  ...
  ((I/4)*FermionChain[((-I)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
     ...
     2*cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/LAMBDA^4], FeynAmp[GraphID[Topology == 2, Generic == 1, 
  ...
  ((I/4)*cHD^2*FermionChain[((-I)*IndexDelta[Index[Colour, 1], 
    ...
    (ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Outgoing, 2]] - 
     ScalarProduct[FourMomentum[Internal, 1], -FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 3]] - 
     ScalarProduct[-FourMomentum[Outgoing, 2], FourMomentum[Outgoing, 1] + 
       FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]] + 
     ScalarProduct[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
       FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
       FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
  ...
  (cHD*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
     ...
     2*cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/(4*LAMBDA^4)], FeynAmp[GraphID[Topology == 3, Generic == 1, 
  ...
  ((I/4)*FermionChain[((-I)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (6*lam*LAMBDA^2 + 3*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     cHD*ScalarProduct[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
         2] - FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]] + 
     3*cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
         2] + FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/LAMBDA^4], FeynAmp[GraphID[Topology == 3, Generic == 1, 
  ...
  ((I/4)*FermionChain[((-I)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (2*lam*LAMBDA^2 + cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     cHBOX*ScalarProduct[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] - FourMomentum[Outgoing, 3]] + 
     cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
         2] + FourMomentum[Outgoing, 3], FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/LAMBDA^4], FeynAmp[GraphID[Topology == 3, Generic == 1, 
   Particles == 3, Number == 11], Integral[FourMomentum[Internal, 1]], 
  ((I/2)*FermionChain[((-I)*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
       (HC[yu[3, 3]]*NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]*yu[3, 3]))/Sqrt[2]]*
    ...
    (4*lam*LAMBDA^2 + 2*cHBOX*ScalarProduct[FourMomentum[Internal, 1], 
     ...
     2*cHBOX*ScalarProduct[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3], 
       -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2] + 
        FourMomentum[Outgoing, 3]])*(4*lam*LAMBDA^2 + 
     2*cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
       -FourMomentum[Internal, 1]] + 
     cHD*ScalarProduct[-FourMomentum[Internal, 1], 
  ...
  (cHD*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
    ...
    (2*lam*LAMBDA^2 + cHBOX*ScalarProduct[-FourMomentum[Internal, 1], 
     ...
     cHBOX*ScalarProduct[FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 2] + FourMomentum[Outgoing, 3]])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External])/(2*LAMBDA^4)], FeynAmp[GraphID[Topology == 3, Generic == 1, 
   Particles == 5, Number == 13], Integral[FourMomentum[Internal, 1]], 
  -(cHD*FermionChain[(IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
        (HC[yu[3, 3]]*NonCommutative[ChiralityProjector[-1]] - 
         NonCommutative[ChiralityProjector[1]]*yu[3, 3]))/Sqrt[2]]*
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     SumOver[Index[Colour, 2], 3, External])/(2*LAMBDA^4)]]
ins1=
TopologyList[Process -> {F[9, {Index[Colour, 1]}], 
     -F[9, {Index[Colour, 2]}]} -> {S[1], S[3], -S[3]}, 
  Model -> {"Mine/1308.2627.4f"}, GenericModel -> {"Mine/1308.2627.4f"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][6], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
     Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
      -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[8] -> -S[3]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[1], Field[7] -> S[2], 
      Field[8] -> -S[3]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[2], Field[7] -> S[1], 
      Field[8] -> -S[3]], FeynmanGraph[1, Particles == 4][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
    ...
    Insertions[Particles][FeynmanGraph[2, Particles == 1][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[1], Field[7] -> S[1], 
      Field[8] -> S[1]], FeynmanGraph[2, Particles == 2][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[1], Field[7] -> S[2], 
      ...
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[2], Field[7] -> S[1], 
      Field[8] -> S[2]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
       -F[9, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> -S[3], 
      Field[5] -> S[3], Field[6] -> S[2], Field[7] -> -S[3], 
      Field[8] -> S[3]]]]]
