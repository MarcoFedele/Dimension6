...
spReabs[exp_] := Module[{temp},
                        ...
                        temp = temp /. rule;
                        temp = ppAbsorbMomenta[temp] // Simplify;
                        
                        Return [temp]
                        ];

spRules = {
        (n_Integer: 1) sp[q3, q4] + (n_Integer: 1) sp[q4, q5] + (n_Integer: 1) sp[q3, q5] ->
            n sp[q3 + q4 + q5, q3 + q4 + q5]/2 - 3 n h /2,
        (n_Integer: 1) sp[q3, q4] + (n_Integer: 1) sp[q4, q5] ->
            n sp[q3 + q4 + q5, q3 + q4 + q5]/2 - 3 n h /2 - n sp[q3, q5],
        (n_Integer: 1) sp[q3, q4] + (n_Integer: 1) sp[q3, q5] ->
            n sp[q3 + q4 + q5, q3 + q4 + q5]/2 - 3 n h /2 - n sp[q4, q5],
        (n_Integer: 1) sp[q4, q5] + (n_Integer: 1) sp[q3, q5] ->
            n sp[q3 + q4 + q5, q3 + q4 + q5]/2 - 3 n h /2 - n sp[q3, q4]
        };
