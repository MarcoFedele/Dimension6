...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OB."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] * (1/2/(sp[q1,Ep2] sp[q2,Ep1]-sp[Ep1,Ep2] sp[q1,q2])) ] ],"\n"],{c,{cB,cW,cWB}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OBtilde."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n",
            Expand[ -2 Simplify[ Coefficient[total, c] *(1/2/(LeviCivita[FourVector[q1], FourVector[q2], Index[Lorentz, 1], Index[Lorentz, 2]]sp[{Index[Lorentz,1]},Ep1] sp[{Index[Lorentz,2]},Ep2])) ] ],"\n"],{c,{cBt,cWt,cWBt}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Simplify[ Coefficient[total, c] * (1/2/(sp[q1,Ep2] sp[q2,Ep1]-sp[Ep1,Ep2] sp[q1,q2])) ]  ] ];
   WriteString[FILE,"\n"];
   ,{c,{cB,cW,cWB}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Simplify[ Coefficient[total, c] *
                                   (1/2/(LeviCivita[FourVector[q1], FourVector[q2], Index[Lorentz, 1], Index[Lorentz, 2]]sp[{Index[Lorentz,1]},Ep1] sp[{Index[Lorentz,2]},Ep2])) ]  ] ];
   WriteString[FILE,"\n"];
   ,{c,{cBt,cWt,cWBt}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
