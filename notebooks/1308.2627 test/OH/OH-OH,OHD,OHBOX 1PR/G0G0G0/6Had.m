...
diag = diag /. a_^2 :> h /; MemberQ[{q1, q2, q3, q4, q5, q12345}, a];
diag = diag /. a_ b_ :> sp[a, b] /; MemberQ[{q1, q2, q3, q4, q5, q12345}, a] && MemberQ[{q1, q2, q3, q4, q5, q12345}, b];
diag = Collect[Simplify[diag /. Qrepl], {cHBOX, cHD}];
diag = Collect[Simplify[diag /. Qrepl], {cHBOX, cHD}];
postPVdiag = diag;
...
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Coefficient[total, c] * (1/90)  ],"\n"],{c,{cH,cHD,cHBOX}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Coefficient[total,c]* (1/90) ] ];
   WriteString[FILE,"\n"];
   ,{c,{cH,cHD,cHBOX}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
