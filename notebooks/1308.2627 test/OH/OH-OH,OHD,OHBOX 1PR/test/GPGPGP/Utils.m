...
spReabs[exp_] := Module[{temp,TEMP},
                        ...
                        rule1ab := {
                            (d_Integer: 1) sp[a_, b_] + (e_Integer: 1) sp[b_,c_] + (f_Integer: 1) sp[a_, c_] :>
                                ...
                                sp[-Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c,
                                   -Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c]/2
                            - Abs[d] Sign[d] Sign[e] Sign[f] 3 h/2 +  Sign[e] (Abs[e] - Abs[f]) sp[b, c] /; Abs[d] === Abs[f],
                            
                            (d_Integer: 1) sp[a_, b_] + (e_Integer: 1) sp[b_,c_] + (f_Integer: 1) sp[a_, c_] :>
                                Abs[d] Sign[d] Sign[e] Sign[f]
                                sp[-Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c,
                                   -Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c]/2
                            - Abs[d] Sign[d] Sign[e] Sign[f] 3 h/2 +  Sign[f] (Abs[f] - Abs[d]) sp[b, c] /; Abs[d] === Abs[e],
                            
                            (d_Integer: 1) sp[a_, b_] + (e_Integer: 1) sp[b_,c_] + (f_Integer: 1) sp[a_, c_] :>
                                Abs[d] Sign[d] Sign[e] Sign[f]
                                sp[-Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c,
                                   -Sign[d] Sign[f] a - Sign[d] Sign[e] b - Sign[e] Sign[f] c]/2
                            - Abs[d] Sign[d] Sign[e] Sign[f] 3 h/2 +  Sign[d] (Abs[d] - Abs[f]) sp[b, c] /; Abs[e] === Abs[f]
                            };
                        ...
                        diagarg = Table[arg = 0;
                                        Do[
                                           If[ Coefficient[temp[[j]], pp[pparg[[i]], h]] =!= 0,
                                              arg = ppres[[i]];
                                              temp[[j]] = Collect[temp[[j]],pp[pparg[[i]], h]];
                                              ], {i, Length[pparg]}
                                           ];
                                        arg
                                        ,{j, Length[temp]}
                        ...
                        TEMP = TEMP /. {q1^2 -> h, q2^2 -> h, q3^2 -> h, q4^2 -> h, q5^2 -> h, q6^2 -> h,  sp[-q1-q2-q3,-q1-q2-q3] ->  sp[q1+q2+q3,q1+q2+q3] };
