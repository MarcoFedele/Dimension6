...
diag = diag/.{MH->Sqrt[h],MT->Sqrt[t],MB->Sqrt[b],MTA->Sqrt[tau]};
...
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/90) ] ] ],"\n"],{c,{cuH33,cdH33,ceH33}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/90) ] ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cuH33,cdH33,ceH33}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
