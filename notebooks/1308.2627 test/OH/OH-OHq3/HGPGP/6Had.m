...
diag = diag/.{MH->Sqrt[h],MTAU->Sqrt[tt]};
...
Table[Print["Entry relative to ", c, " : \n", FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/12) ] ] ],"\n"],{c,{cHu33,cHd33,cHq133,cHq333,cHud33}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, FullSimplify[ Expand[ -2 Simplify[ Coefficient[total, c] * (1/12) ] ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cHu33,cHd33,cHq133,cHq333,cHud33}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
