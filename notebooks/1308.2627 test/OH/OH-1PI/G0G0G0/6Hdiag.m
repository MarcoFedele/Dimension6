...
SetAttributes[ Pair, Orderless];
  ...
  DEConvention = {FourMomentum[Internal, 1]->p,
                  ...
                  FourMomentum[Incoming, 3]->q3,
                  FourMomentum[Outgoing, 1]->q4,
                  FourMomentum[Outgoing, 2]->q5,
                  FourMomentum[Outgoing, 3]->q1 + q2 + q3 - q4 - q5 };
...
Do[check = 0;
   ...
   Do[
      ...
      If[MatchQ[amp2[[DIAG,TERM]], Times[lam^2/LAMBDA^2, ___]],
         temp += amp2[[DIAG,TERM]];
         check++;
         ],
