...
kinesub := {Pair[Momentum[q1, D], Momentum[q1, D]] -> h^2,
    Pair[Momentum[q2, D], Momentum[q2, D]] -> h^2,
    Pair[Momentum[q3, D], Momentum[q3, D]] -> h^2,
    Pair[Momentum[q4, D], Momentum[q4, D]] -> h^2,
    Pair[Momentum[q5, D], Momentum[q5, D]] -> h^2};
