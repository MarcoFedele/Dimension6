...
{4*cHBOX*lam*pp[p, h] + 4*cHBOX*lam*pp[p + q23, h] + 
 ...
 2*cHBOX*lam*pp[p, h] + 2*cHBOX*lam*pp[p + q24, h] + 
  ...
  3*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q2, q2] - 
  2*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q2, q24] - 
  2*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q2, q4] + 
  6*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q24, q24] + 
  2*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q24, q4] + 
  3*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q3, q3] + 
  3*cHBOX*lam*pp[p, h]*pp[p + q24, h]*sp[q4, q4]}
...
{8*cHBOX*lam*A0[h] + 8*cHBOX*h*lam*B0[q2 - q3, h, h] + 
 ...
 4*cHBOX*lam*A0[h] + 4*cHBOX*h*lam*B0[q2 - q4, h, h] + 
  3*cHBOX*lam*B0[q2 - q4, h, h]*sp[q1, q1] - 6*cHBOX*lam*B0[q2 - q4, h, h]*
   sp[q1, q3] + 5*cHBOX*lam*B0[q2 - q4, h, h]*sp[q2, q2] - 
  6*cHBOX*lam*B0[q2 - q4, h, h]*sp[q2, q4] + 3*cHBOX*lam*B0[q2 - q4, h, h]*
   sp[q3, q3] + 5*cHBOX*lam*B0[q2 - q4, h, h]*sp[q4, q4]}

diagdiv=
{2*cHBOX*lam*(8*h + sp[q1, q1] + sp[q1, q2] - sp[q1, q3] + 2*sp[q2, q3] - 
   sp[q2, q4] + sp[q3, q4] + sp[q4, q4]), 
 2*cHBOX*lam*(sp[q1, q1] - 2*sp[q1, q3] + 3*sp[q2, q2] - 6*sp[q2, q4] + 
   sp[q3, q3] + 3*sp[q4, q4]), 2*cHBOX*lam*(8*h + sp[q1, q1] - sp[q1, q3] - 
   sp[q1, q4] + sp[q2, q2] - sp[q2, q3] - sp[q2, q4] - 2*sp[q3, q4]), 
 ...
 cHBOX*lam*(8*h + 3*sp[q1, q1] - 6*sp[q1, q3] + 5*sp[q2, q2] - 6*sp[q2, q4] + 
   3*sp[q3, q3] + 5*sp[q4, q4])}
