amp0=
FeynAmpList[Process -> {{-F[12, {Index[Colour, 1]}], 
      FourMomentum[Incoming, 1], 0, {Q/3}}, {F[18, {Index[Colour, 2]}], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     Index[Colour, 2]]*(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      (2*clequ11133*MatrixTrace[HC[yl[1, 1]]*
          (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
           ...
           -1]], NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1]]]] + 2*clequ11133*
        MatrixTrace[HC[yl[1, 1]]*(NonCommutative[ChiralityProjector[-1]] + 
           NonCommutative[ChiralityProjector[1]]), NonCommutative[
          DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
          ChiralityProjector[1]], NonCommutative[DiracSlash[
           -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]]] + 
       clequ31133*(MatrixTrace[HC[yl[1, 1]]*(NonCommutative[
  ...
  ((I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*IndexDelta[Index[Colour, 1], 
     Index[Colour, 2]]*(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      (2*clequ12233*MatrixTrace[HC[yl[2, 2]]*
          (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]]), NonCommutative[DiracSlash[
           -FourMomentum[Internal, 1]]], NonCommutative[ChiralityProjector[
           -1]], NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1]]]] + 2*clequ12233*
        MatrixTrace[HC[yl[2, 2]]*(NonCommutative[ChiralityProjector[-1]] + 
           NonCommutative[ChiralityProjector[1]]), NonCommutative[
          DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
          ChiralityProjector[1]], NonCommutative[DiracSlash[
           -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]]] + 
       clequ32233*(MatrixTrace[HC[yl[2, 2]]*(NonCommutative[
             ChiralityProjector[-1]] + NonCommutative[ChiralityProjector[
              1]]), NonCommutative[DiracSlash[-FourMomentum[Internal, 1]]], 
          NonCommutative[DiracMatrix[Index[Lorentz, a]], 
           DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
  ...
  ((I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*IndexDelta[Index[Colour, 1], 
     Index[Colour, 2]]*(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      (2*clequ13333*MatrixTrace[HC[yl[3, 3]]*
          (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]]), NonCommutative[DiracSlash[
           -FourMomentum[Internal, 1]]], NonCommutative[ChiralityProjector[
           -1]], NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1]]]] + 2*clequ13333*
        MatrixTrace[HC[yl[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
           NonCommutative[ChiralityProjector[1]]), NonCommutative[
          DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
          ChiralityProjector[1]], NonCommutative[DiracSlash[
           -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]]] + 
       clequ33333*(MatrixTrace[HC[yl[3, 3]]*(NonCommutative[
             ChiralityProjector[-1]] + NonCommutative[ChiralityProjector[
              1]]), NonCommutative[DiracSlash[-FourMomentum[Internal, 1]]], 
          NonCommutative[DiracMatrix[Index[Lorentz, a]], 
           DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]], 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 7, Number == 7], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (cquqd11331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]]], HC[yd[1, 1]]*
        (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]]), NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
     ...
     cquqd81331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       ...
       Index[Colour, 2]]*MatrixTrace[HC[yd[1, 1]]*
        (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]]), NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
        ChiralityProjector[-1]], NonCommutative[DiracSlash[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 8, Number == 8], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (cquqd12332*FermionChain[NonCommutative[ChiralityProjector[1]], 
       NonCommutative[DiracSlash[-FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]]], HC[yd[2, 2]]*
        (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]]), NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
        ChiralityProjector[-1]]]*IndexDelta[Index[Colour, 1], 
     ...
     cquqd82332*FermionChain[NonCommutative[ChiralityProjector[1]], 
       ...
       NonCommutative[ChiralityProjector[-1]]]*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*MatrixTrace[HC[yd[2, 2]]*
        (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]]), NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
        ChiralityProjector[-1]], NonCommutative[DiracSlash[
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (cquqd13333*FermionChain[NonCommutative[ChiralityProjector[1]], 
     ...
     cquqd83333*FermionChain[NonCommutative[ChiralityProjector[1]], 
       ...
       NonCommutative[ChiralityProjector[-1]]]*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*MatrixTrace[HC[yd[3, 3]]*
        (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
          ChiralityProjector[1]]), NonCommutative[
        DiracSlash[-FourMomentum[Internal, 1]]], NonCommutative[
        ChiralityProjector[-1]], NonCommutative[DiracSlash[
...
TopologyList[Process -> {-F[12, {Index[Colour, 1]}], 
     F[18, {Index[Colour, 2]}]} -> {S[3]}, Model -> {"Mine/1310.4838.LR"}, 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
     ...
     Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], Field[4] -> F, 
     Field[5] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> -F[1], Field[5] -> F[13]], FeynmanGraph[1, Particles == 2][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> -F[2], Field[5] -> F[14]], FeynmanGraph[1, Particles == 3][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> -F[3], Field[5] -> F[15]], FeynmanGraph[1, Particles == 4][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> F[10, {Index[Colour, 4]}], Field[5] -> 
       -F[16, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> F[11, {Index[Colour, 4]}], Field[5] -> 
      ...
      Field[4] -> -F[7, {Index[Colour, 4]}], Field[5] -> 
       F[19, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 8][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
      Field[4] -> -F[8, {Index[Colour, 4]}], Field[5] -> 
       F[20, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 9][
      Field[1] -> -F[12, {Index[Colour, 1]}], 
      Field[2] -> F[18, {Index[Colour, 2]}], Field[3] -> -S[3], 
