...
diag = diag /. {B0[ - q1_ - q2_ , m1_ , m2_ ] -> B0[ q1 + q2 , m1 , m2 ], q1^2 -> 0, q2^2 -> 0, q1^4 -> 0, q2^4 -> 0, q3^2 -> h};
...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES."]; (* il fattore 2 viene dalla base LR *)
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Collect[ Simplify[ Expand[ -2 Coefficient[total, h c] * (Sqrt[2]) / 2 ] ], lam],"\n"],{c,{cqu13333,cqu83333,clequ13333,cquqd13333,cquqd83333}}];
