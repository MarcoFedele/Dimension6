...
FeynAmpList[Process -> {{F[9, {Index[Colour, 1]}], FourMomentum[Incoming, 1], 
      0, {(2*Q)/3}}, {-F[18, {Index[Colour, 2]}], FourMomentum[Incoming, 2], 
      0, {(-2*Q)/3}}} -> {{S[1], FourMomentum[Outgoing, 1], MH, {}}}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  ((-I/2)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     Index[Colour, 2]]*(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      (2*clequ11133*MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[
       ...
       2*clequ11133*MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[
          ...
          Sqrt[2], NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
            FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
           1]], NonCommutative[DiracSlash[FourMomentum[Internal, 1]]]] + 
       clequ31133*(MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[
               -1]] + NonCommutative[ChiralityProjector[1]])*yl[1, 1])/
           Sqrt[2], NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
           ...
           ChiralityProjector[-1]], NonCommutative[DiracSlash[
            FourMomentum[Internal, 1]]]] + MatrixTrace[
       ...
       2*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ...
        (MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
          ...
          NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
           ...
           DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, b]], 
           ChiralityProjector[1]], NonCommutative[DiracSlash[
            FourMomentum[Internal, 1]]]])))*SumOver[Index[Colour, 1], 3, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 2, Number == 2], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*IndexDelta[Index[Colour, 1], 
     Index[Colour, 2]]*(clequ12233*FermionChain[NonCommutative[
      ...
      (MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
       ...
       MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
        ...
        NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
           FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
          1]], NonCommutative[DiracSlash[FourMomentum[Internal, 1]]]]) + 
     clequ12233*FermionChain[NonCommutative[ChiralityProjector[1]]]*
      (MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
           NonCommutative[ChiralityProjector[1]])*yl[2, 2])/Sqrt[2], 
        NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
           FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  ((-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*IndexDelta[Index[Colour, 1], 
     Index[Colour, 2]]*(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      ((clequ13333 - 4*clequ33333)*MatrixTrace[
         ((-I)*(NonCommutative[ChiralityProjector[-1]] + NonCommutative[
       ...
       (clequ13333 - 4*clequ33333)*MatrixTrace[
         ...
         NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
            FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
           1]], NonCommutative[DiracSlash[FourMomentum[Internal, 1]]]] + 
       clequ33333*(MatrixTrace[((-I)*(NonCommutative[ChiralityProjector[
               -1]] + NonCommutative[ChiralityProjector[1]])*yl[3, 3])/
           Sqrt[2], NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
             FourMomentum[Outgoing, 1]]], NonCommutative[
           DiracMatrix[Index[Lorentz, a]], DiracMatrix[Index[Lorentz, a]], 
           ChiralityProjector[-1]], NonCommutative[DiracSlash[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 4, Number == 4], 
  ...
  ((-I)*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    (cqu11331*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 5, Number == 5], 
  ...
  ((-I)*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0]]*
    (cqu12332*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     cqu82332*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 4], 3]*SumOver[Index[Colour, 1], 3, External]*
    SumOver[Index[Colour, 2], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 6, Number == 6], 
  ...
  ((-I)*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    (cqu13333*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     cqu83333*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 4], 3]*SumOver[Index[Colour, 1], 3, External]*
    SumOver[Index[Colour, 2], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 7, Number == 7], 
  ...
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (cquqd11331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
         -1]]]*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     cquqd11331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
       ((-I)*(NonCommutative[ChiralityProjector[-1]] + NonCommutative[
      ...
      IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     cquqd81331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
         -1]]]*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}] + 
     cquqd81331*FermionChain[NonCommutative[ChiralityProjector[1]], 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
       ((-I)*(NonCommutative[ChiralityProjector[-1]] + NonCommutative[
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[1]]]*
      IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
        SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], {Gluon$1, 1, 8}] + 
     FermionChain[NonCommutative[ChiralityProjector[-1]], 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1]]], 
       ((-I)*(NonCommutative[ChiralityProjector[-1]] + NonCommutative[
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
         -1]]]*(cquqd11331*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cquqd81331*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
  ...
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (cquqd12332*FermionChain[NonCommutative[ChiralityProjector[1]], 
     ...
     FermionChain[NonCommutative[ChiralityProjector[-1]], 
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
         -1]]]*(cquqd12332*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cquqd82332*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) + FermionChain[NonCommutative[
        ChiralityProjector[-1]], NonCommutative[DiracSlash[
         FourMomentum[Internal, 1]]], 
  ...
  (I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (cquqd13333*FermionChain[NonCommutative[ChiralityProjector[1]], 
     ...
     FermionChain[NonCommutative[ChiralityProjector[-1]], 
       ...
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
         -1]]]*(cquqd13333*IndexDelta[Index[Colour, 1], Index[Colour, 4]]*
        IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
       cquqd83333*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
          SUNT[Gluon$1, Index[Colour, 4], Index[Colour, 1]], 
         {Gluon$1, 1, 8}]) + FermionChain[NonCommutative[
        ChiralityProjector[-1]], NonCommutative[DiracSlash[
         FourMomentum[Internal, 1]]], 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[4][4], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][
     Field[1] -> F[9, {Index[Colour, 1]}], Field[2] -> 
      -F[18, {Index[Colour, 2]}], Field[3] -> S[1], Field[4] -> F, 
