...
process1 = {F[12], -F[18]} -> {-S[3]};

top = CreateTopologies[1, 2 -> 1, Adjacencies -> {3, 4}, ExcludeTopologies -> {Tadpoles, SelfEnergies, Boxes, Pentagons}];

 ins1 = InsertFields[ top[[4]], process1, Model -> "Mine/1310.4838.LR", GenericModel -> "Mine/1310.4838.LR", ExcludeParticles -> {V}, InsertionLevel->{Particles} ];
