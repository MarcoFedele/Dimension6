...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHB."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c (sp[Ep1, Ep2] sp[q1, q2] - sp[q1, Ep2] sp[q2, Ep1]) ] / (-4) ] + If[c === cHB,HWF,0] ],"\n"],{c,{cHB,cHWB}}];
(*Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHBtilde."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n",
...
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
WriteString[FILE,"########  ANOMALOUS DIMENSION ENTRIES FOR OB ########"];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   ...
   WriteString[FILE,"\n"];
   ,{c,{ceB22,ceB23,ceB32,ceB33,cuB22,cuB23,cuB32,cuB33,cdB22,cdB23,cdB32,cdB33}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
WriteString[FILE,"########  ANOMALOUS DIMENSION ENTRIES FOR OBtilde ########"];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
