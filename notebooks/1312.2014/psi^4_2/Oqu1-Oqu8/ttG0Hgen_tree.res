...
TopologyList[Process -> {F[7, {Index[Colour, 1]}], 
     -F[9, {Index[Colour, 2]}]} -> {F[16, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
      -F[9, {Index[Colour, 2]}], Field[3] -> -F[16, {Index[Colour, 3]}], 
     Field[4] -> F[18, {Index[Colour, 4]}]] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> F[7, {Index[Colour, 1]}], 
      Field[2] -> -F[9, {Index[Colour, 2]}], Field[3] -> 
       -F[16, {Index[Colour, 3]}], Field[4] -> F[18, {Index[Colour, 4]}]]]]]
