...
FeynAmpList[Process -> {{F[4], FourMomentum[Incoming, 1], 0, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  Integral[], 
  ((-I)*(clequ11133*FermionChain[NonCommutative[ChiralityProjector[-1]]]^2 + 
     clequ11133*FermionChain[NonCommutative[ChiralityProjector[1]]]^2 + 
     ...
     FermionChain[NonCommutative[ChiralityProjector[-1]]]*
      (2*clequ11133*FermionChain[NonCommutative[ChiralityProjector[1]]] + 
       clequ31133*(FermionChain[NonCommutative[DiracMatrix[
