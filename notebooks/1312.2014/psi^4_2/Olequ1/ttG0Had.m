...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES."]; (* il fattore 4 viene dalla base LR *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] (-1) / 4 ] ],"\n"],{c,{cledq1111,cledq1133,ceu1133,ceu1331,clq11133,clq13113,clq31133,clq33113,clu1133,cqe3311}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   ...
   WriteString[FILE,"\n"];
   ,{c,{cHl111,cHl113,cHl131,cHl133,cHl311,cHl313,cHl331,cHl333,cle1133,cle1331,cle3113,cle3311,cle3322,cle3333}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
