 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
  ...
  (I*ceu1133*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
     External])/LAMBDA^2]]
ins1=
TopologyList[Process -> {F[13], -F[13]} -> {F[18, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[13], 
     Field[2] -> -F[13], Field[3] -> -F[18, {Index[Colour, 3]}], 
     Field[4] -> F[18, {Index[Colour, 4]}]] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> F[13], Field[2] -> -F[13], 
      Field[3] -> -F[18, {Index[Colour, 3]}], 
      Field[4] -> F[18, {Index[Colour, 4]}]]]]]
