...
Paint[DiagramExtract[ins1, finaldiag], DisplayFunction -> (Export["uubb_included.pdf",#]&), ColumnsXRows ->{3,4}];
Print["Included diagrams printed"];

(*If[Length[DiagramComplement[ins1, DiagramExtract[ins1, finaldiag]]] != 0,
     Paint[DiagramComplement[ins1, DiagramExtract[ins1, finaldiag]], DisplayFunction -> (Export["uubb_excluded.pdf",#]&), ColumnsXRows ->{3,4}];
...
Paint[DiagramExtract[ins2, finaldiag], DisplayFunction -> (Export["uutt_included.pdf",#]&), ColumnsXRows ->{3,4}];
Print["Included diagrams printed"];

(*If[Length[DiagramComplement[ins2, DiagramExtract[ins2, finaldiag]]] != 0,
     Paint[DiagramComplement[ins2, DiagramExtract[ins2, finaldiag]], DisplayFunction -> (Export["uutt_excluded.pdf",#]&), ColumnsXRows ->{3,4}];
     Print["Excluded diagrams printed"]
     ];*)
  Pair = sp;
  SW = Sqrt[s2];
