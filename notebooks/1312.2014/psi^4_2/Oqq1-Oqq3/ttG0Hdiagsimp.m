...
CRF5 := {    MatrixTrace[a___,
    ...
    MatrixTrace[y___,  x1_. NonCommutative[DiracSlash[a___], ChiralityProjector[n1_]] +
                ...
                x4_. NonCommutative[DiracSlash[d___],ChiralityProjector[n4_]] +
                x5_. NonCommutative[DiracSlash[e___],ChiralityProjector[n5_]] +
                x6_. NonCommutative[DiracSlash[f___],ChiralityProjector[n6_]] +
                x7_. NonCommutative[DiracSlash[g___],ChiralityProjector[n7_]] +
                x8_. NonCommutative[DiracSlash[h___],ChiralityProjector[n8_]] , z___] :>
    x1/2 MatrixTrace[y, G[l2, a, U + n1 G5], z] + x2/2 MatrixTrace[y, G[l2, b, U + n2 G5], z] +
    x3/2 MatrixTrace[y, G[l2, c, U + n3 G5], z] + x4/2 MatrixTrace[y, G[l2, d, U + n4 G5], z] +
    x5/2 MatrixTrace[y, G[l2, e, U + n5 G5], z] + x6/2 MatrixTrace[y, G[l2, f, U + n6 G5], z] +
    x7/2 MatrixTrace[y, G[l2, g, U + n7 G5], z] + x8/2 MatrixTrace[y, G[l2, h, U + n8 G5], z]
};
...
amp31 = diag1;
amp31 = amp31 /. cHq331 -> cHQ331;

amp32 = diag2;
amp32 = amp32 /. cHq331 -> cHQ331;
...
Do[
   ...
   amp31 = ReplacePart[amp31, temp1,{jjj}];
...
Do[
   ...
   amp32 = ReplacePart[amp32, temp1,{jjj}];
...
FILE = NotebookDirectory[]<>"ttG0Hdiagsimp.res";
