...
(*Print[""];
 ...
 Print[diag];*)
total = Total[diag];
total1 = Coefficient[total, DELTA[Index[Colour,1],Index[Colour,2]] DELTA[Index[Colour,3],Index[Colour,4]]];
total2 = Coefficient[total, DELTA[Index[Colour,1],Index[Colour,3]] DELTA[Index[Colour,2],Index[Colour,4]]];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES for Ouu1133-Ouu3311."]; (* il fattore 4 viene dalla base LR, il fattore 2 dal mixing aabb-bbaa *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total1, c] / 4 / 2 ] ],"\n"],{c,{cHu11,cHu33,cqu11133,cqu12233,cqu13311,cqu13333,cqu81133,cqu81331,cqu82233,cqu83113,cqu83311,cqu83333}}];
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES for Ouu1331-Ouu3113."]; (* il fattore 4 viene dalla base LR, il fattore 2 dal mixing abba-baab *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total2, c] / 4 / 2 ] ],"\n"],{c,{cHu13,cHu31,cqu11331,cqu13113,cqu81133,cqu81331,cqu82233,cqu83113,cqu83311,cqu83333}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   ...
   WriteString[FILE,"\n"];
   ,{c,{cHu11,cHu13,cHu31,cHu33,cqu11133,cqu11331,cqu12233,cqu13113,cqu13311,cqu13333,cqu81133,cqu81331,cqu82233,cqu83113,cqu83311,cqu83333}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
