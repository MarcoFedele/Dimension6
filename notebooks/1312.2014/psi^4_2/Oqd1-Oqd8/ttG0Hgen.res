...
FeynAmpList[Process -> {{F[7, {Index[Colour, 1]}], FourMomentum[Incoming, 1], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    ((cdd1331 + cdd3113)*FermionChain[NonCommutative[
     ...
     (cdd1331 + cdd3113)*FermionChain[NonCommutative[
      ...
      IndexDelta[Index[Colour, 1], Index[Colour, 3]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     (cdd1133 + cdd3311)*(FermionChain[NonCommutative[
         DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
       FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ChiralityProjector[1]]])*
      (FermionChain[-((NonCommutative[ChiralityProjector[-1]] + 
        ...
        NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
          1]], NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
           FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
           FourMomentum[Outgoing, 2]]], HC[yd[1, 1]]*
         (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    ((cdd2332 + cdd3223)*FermionChain[NonCommutative[
     ...
     (cdd2332 + cdd3223)*FermionChain[NonCommutative[
      ...
      IndexDelta[Index[Colour, 1], Index[Colour, 3]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     (cdd2233 + cdd3322)*(FermionChain[NonCommutative[
         DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
       FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ChiralityProjector[1]]])*
      (FermionChain[-((NonCommutative[ChiralityProjector[-1]] + 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 2, Particles == 7, Number == 16], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(-I)*cHd33*IndexDelta[Index[Colour, 3], 
     ...
     (FermionChain[NonCommutative[ChiralityProjector[-1]], 
      ...
      (cquqd11133*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
       ...
       cquqd81133*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
          SUNT[Gluon$1, Index[Colour, 3], Index[Colour, 4]], 
         {Gluon$1, 1, 8}]))*SumOver[Index[Colour, 1], 3, External]*
    SumOver[Index[Colour, 2], 3, External]*SumOver[Index[Colour, 3], 3, 
     External]*SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (-(FermionChain[NonCommutative[ChiralityProjector[-1]]]*
       (FermionChain[-((HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[
               -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2]), 
         NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
            FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
           -1]], NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
     ...
     (FermionChain[NonCommutative[ChiralityProjector[-1]], 
      ...
      (FermionChain[-((HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        ...
        NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
           FourMomentum[Outgoing, 1]]], NonCommutative[ChiralityProjector[
          1]]])*(cquqd11133*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
        IndexDelta[Index[Colour, 3], Index[Colour, 4]] + 
       cquqd81133*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 1]]*
          SUNT[Gluon$1, Index[Colour, 3], Index[Colour, 4]], 
         {Gluon$1, 1, 8}]))*SumOver[Index[Colour, 1], 3, External]*
    SumOver[Index[Colour, 2], 3, External]*SumOver[Index[Colour, 3], 3, 
     External]*SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 2, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
       ChiralityProjector[-1]], NonCommutative[
       DiracSlash[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
    ...
    FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
      ...
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    (cqd11133*IndexDelta[Index[Colour, 1], Index[Colour, 3]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     cqd81133*IndexSum[SUNT[Gluon$1, Index[Colour, 2], Index[Colour, 4]]*
        SUNT[Gluon$1, Index[Colour, 3], Index[Colour, 1]], {Gluon$1, 1, 8}])*
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 23], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]), NonCommutative[
       DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
      NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
        -1]]] + FermionChain[HC[yd[3, 3]]*
       (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ChiralityProjector[1]]), NonCommutative[
       DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 2, Number == 24], 
  Integral[FourMomentum[Internal, 1]], 
  ((FermionChain[HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
        NonCommutative[ChiralityProjector[1]]), NonCommutative[
       DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
      NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
        -1]]] + FermionChain[HC[yd[1, 3]]*
       (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
         ChiralityProjector[1]]), NonCommutative[
       DiracSlash[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
      NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
      ...
      (FermionChain[((-I)*(NonCommutative[ChiralityProjector[-1]] + 
        ...
        NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
          ...
          -1]]] + FermionChain[((-I)*(NonCommutative[ChiralityProjector[
             -1]] + NonCommutative[ChiralityProjector[1]])*yu[1, 1])/Sqrt[2], 
        NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
           FourMomentum[Internal, 1]]], NonCommutative[ChiralityProjector[
          1]]])*(cquqd11133*IndexDelta[Index[Colour, 1], Index[Colour, 2]]*
        IndexDelta[Index[Colour, 3], Index[Colour, 4]] + 
    ...
    SumOver[Index[Colour, 2], 3, External]*SumOver[Index[Colour, 3], 3, 
     External]*SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 26], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 1, Number == 27], 
  Integral[FourMomentum[Internal, 1]], 
  (2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    (2*cqq31111*FermionChain[((-I)*HC[yd[1, 3]]*
         (NonCommutative[ChiralityProjector[-1]] + NonCommutative[
           ChiralityProjector[1]]))/Sqrt[2], NonCommutative[
        DiracSlash[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
     ...
     2*cqq31111*FermionChain[((-I)*HC[yd[1, 3]]*
      ...
      IndexDelta[Index[Colour, 1], Index[Colour, 3]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     (cqq11111 - cqq31111)*(FermionChain[NonCommutative[
         DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
       FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ChiralityProjector[1]]])*
      (FermionChain[((-I)*HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[
             -1]] + NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
        NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 2, Number == 28], 
  ...
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    (2*(cqq31331 + cqq33113)*FermionChain[
       ((-I)*HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
          NonCommutative[ChiralityProjector[1]]))/Sqrt[2], 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[
     ...
     2*(cqq31331 + cqq33113)*FermionChain[
      ...
      IndexDelta[Index[Colour, 1], Index[Colour, 3]]*
      IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     (cqq11133 + cqq13311 - cqq31133 - cqq33311)*
      (FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
         ChiralityProjector[-1]]] + FermionChain[NonCommutative[
         DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
      (FermionChain[((-I)*HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 3, Number == 29], 
  Integral[FourMomentum[Internal, 1]], 
  (2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    (2*cqq31111*FermionChain[
       -((HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
           NonCommutative[ChiralityProjector[1]]))/Sqrt[2]), 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 4, Number == 30], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 5, Number == 31], 
  Integral[FourMomentum[Internal, 1]], 
  (2*(cqq11111 + cqq31111)*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0]]*
    (FermionChain[HC[yd[1, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
       ...
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
         ...
         ChiralityProjector[-1]], NonCommutative[DiracSlash[
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
        -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]])*yd[1, 3])] + FermionChain[
        NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
          1]], NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 2]]], 
        -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]])*yd[1, 3])])*IndexDelta[Index[Colour, 1], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 6, Number == 32], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    ((cqq11331 + cqq13113 + cqq31331 + cqq33113)*
      FermionChain[HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
         NonCommutative[ChiralityProjector[1]]), NonCommutative[
        DiracSlash[FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1]]], 
       NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
         ...
         ChiralityProjector[-1]], NonCommutative[DiracSlash[
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]], 
        -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]])*yd[3, 3])] + FermionChain[
        NonCommutative[DiracMatrix[Index[Lorentz, a]], ChiralityProjector[
          1]], NonCommutative[DiracSlash[FourMomentum[Internal, 1] - 
           FourMomentum[Outgoing, 2]]], 
        -((NonCommutative[ChiralityProjector[-1]] + NonCommutative[
            ChiralityProjector[1]])*yd[3, 3])])*IndexDelta[Index[Colour, 1], 
       Index[Colour, 3]]*IndexDelta[Index[Colour, 2], Index[Colour, 4]] + 
     (cqq11331 + cqq13113 + cqq31331 + cqq33113)*
      FermionChain[HC[yd[3, 3]]*(NonCommutative[ChiralityProjector[-1]] + 
         NonCommutative[ChiralityProjector[1]]), NonCommutative[
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 1, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 2, Number == 34], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[-((cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
        Index[Colour, 2]]*(NonCommutative[DiracSlash[
          -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 3, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 4, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[-((cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
        Index[Colour, 2]]*(NonCommutative[DiracSlash[
          -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 5, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[(cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 6, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[-((cHq111 - cHq311)*IndexDelta[Index[Colour, 1], 
        Index[Colour, 2]]*(NonCommutative[DiracSlash[
          -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 7, Number == 39], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*(cHq111 + cHq311)*IndexDelta[Index[Colour, 1], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 8, Number == 40], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*(cHq111 + cHq311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
    ...
    SumOver[Index[Colour, 1], 3, External]*SumOver[Index[Colour, 2], 3, 
     External]*SumOver[Index[Colour, 3], 3, External]*
    SumOver[Index[Colour, 4], 3, External])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 9, Number == 41], 
  Integral[FourMomentum[Internal, 1]], 
  ((-I)*FermionChain[I*(cHq111 + cHq311)*IndexDelta[Index[Colour, 1], 
       Index[Colour, 2]]*(NonCommutative[DiracSlash[
         -FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]], 
...
TopologyList[Process -> {F[7, {Index[Colour, 1]}], 
     -F[7, {Index[Colour, 2]}]} -> {F[21, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
      -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[7] -> -F[9, {Index[Colour, 3]}]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> -S[3], 
      Field[6] -> -F[21, {Index[Colour, 2]}], 
      Field[7] -> -F[7, {Index[Colour, 3]}]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
   Propagator[Incoming][Vertex[1][2], Vertex[3][6], Field[2]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][
     ...
     Field[7] -> F] -> Insertions[Particles][FeynmanGraph[1, Particles == 1][
      ...
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[2], 
      Field[6] -> -F[12, {Index[Colour, 3]}], 
      Field[7] -> F[12, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[3], 
      Field[6] -> -F[7, {Index[Colour, 3]}], Field[7] -> 
       F[7, {Index[Colour, 4]}]], FeynmanGraph[1, Particles == 6][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> S[3], 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> F[7, {Index[Colour, 1]}], 
      Field[2] -> -F[7, {Index[Colour, 2]}], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -F[10, {Index[Colour, 3]}], Field[6] -> S[2], 
      Field[7] -> S[1]], FeynmanGraph[1, Particles == 3][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 4][Field[1] -> F[7, {Index[Colour, 1]}], 
      Field[2] -> -F[7, {Index[Colour, 2]}], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -F[11, {Index[Colour, 3]}], Field[6] -> S[2], 
      Field[7] -> S[1]], FeynmanGraph[1, Particles == 5][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 6][Field[1] -> F[7, {Index[Colour, 1]}], 
      Field[2] -> -F[7, {Index[Colour, 2]}], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -F[12, {Index[Colour, 3]}], Field[6] -> S[2], 
      Field[7] -> S[1]], FeynmanGraph[1, Particles == 7][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
     ...
     FeynmanGraph[1, Particles == 8][Field[1] -> F[7, {Index[Colour, 1]}], 
      Field[2] -> -F[7, {Index[Colour, 2]}], Field[3] -> 
       -F[21, {Index[Colour, 3]}], Field[4] -> F[21, {Index[Colour, 4]}], 
      Field[5] -> -F[8, {Index[Colour, 3]}], Field[6] -> S[3], 
      Field[7] -> -S[3]], FeynmanGraph[1, Particles == 9][
      Field[1] -> F[7, {Index[Colour, 1]}], Field[2] -> 
       -F[7, {Index[Colour, 2]}], Field[3] -> -F[21, {Index[Colour, 3]}], 
      Field[4] -> F[21, {Index[Colour, 4]}], Field[5] -> 
