...
FeynAmpList[Process -> {{V[2], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  Model -> {"Mine/1312.2014.LR.noT"}, GenericModel -> 
   {"Mine/1312.2014.LR.noT"}, AmplitudeLevel -> {Particles}, 
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, Number == 1], 
      ...
      (FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
        FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         ...
         (ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
             1], -FourMomentum[Outgoing, 1]] + ScalarProduct[
           FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        ...
        FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
         (6*lam*LAMBDA^2 + 3*cHBOX*ScalarProduct[FourMomentum[Incoming, 2] + 
           ...
           ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
              1], -FourMomentum[Outgoing, 1]] + 2*cHBOX*ScalarProduct[
            FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
            ...
            -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
             FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]] + 
          cHD*ScalarProduct[FourMomentum[Incoming, 2] + FourMomentum[
              Internal, 1], -FourMomentum[Incoming, 2] - FourMomentum[
              Internal, 1] + FourMomentum[Outgoing, 1] + FourMomentum[
              Outgoing, 2]] + 3*cHBOX*ScalarProduct[
          ...
          3*cHBOX*ScalarProduct[-FourMomentum[Outgoing, 2], 
            ...
            -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
             FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]]))))/
   (4*LAMBDA^2)], FeynAmp[GraphID[Topology == 1, Generic == 1, 
  ...
  -(g1*gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     ...
     (2*lam*LAMBDA^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
      ...
      cHBOX*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        Index[Lorentz, 2]]*ScalarProduct[-FourMomentum[Outgoing, 1], 
        -FourMomentum[Outgoing, 1]] + 
      cHBOX*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
      ...
      2*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
       ...
       (lam*LAMBDA^2 + cHBOX*ScalarProduct[FourMomentum[Incoming, 2] + 
          ...
          -FourMomentum[Outgoing, 1], -FourMomentum[Outgoing, 2]]) + 
      2*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 2]]*(FourVector[-FourMomentum[Internal, 1], 
         Index[Lorentz, 1]] + FourVector[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2], Index[Lorentz, 1]])*
      ...
      cHBOX*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       ScalarProduct[-FourMomentum[Outgoing, 2], 
        -FourMomentum[Outgoing, 2]] + 
      cHBOX*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
        Index[Lorentz, 2]]*ScalarProduct[-FourMomentum[Outgoing, 2], 
        -FourMomentum[Outgoing, 2]] + 
      cHBOX*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
  ...
  (gw^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (4*cHWB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (g1*gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
         Index[Lorentz, 1]]*FourVector[-FourMomentum[Outgoing, 1], 
         Index[Lorentz, 3]] + FourVector[-FourMomentum[Internal, 1], 
         Index[Lorentz, 1]]*(4*cHWB*FourVector[-FourMomentum[Outgoing, 1], 
       ...
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
         Index[Lorentz, 1]]*(g1*gw*LAMBDA^2*FourVector[
           -FourMomentum[Internal, 1], Index[Lorentz, 3]] + 
         4*cHWB*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
          ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (g1*gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
         ...
         Index[Lorentz, 3]] + FourVector[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
          FourMomentum[Outgoing, 2], Index[Lorentz, 1]]*
        (g1*gw*LAMBDA^2*FourVector[FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]] + 4*cHWB*FourVector[-FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
         FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
          (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
  ...
  (g1*gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
    ...
    (8*cHB*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
        (g1^2*LAMBDA^2*FourVector[-FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]] + 8*cHB*FourVector[FourMomentum[Internal, 1], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]) + 
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
        (g1^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
           Index[Lorentz, 3]] + 8*cHB*FourVector[-FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]) + 
       FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
         Index[Lorentz, 1]]*(g1^2*LAMBDA^2*FourVector[
           -FourMomentum[Internal, 1], Index[Lorentz, 3]] + 
         g1^2*LAMBDA^2*FourVector[-FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]] + 8*cHB*(FourVector[FourMomentum[Internal, 1], 
            Index[Lorentz, 3]] + FourVector[FourMomentum[Outgoing, 1], 
            Index[Lorentz, 3]])*ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]))))/
   (8*LAMBDA^2)], FeynAmp[GraphID[Topology == 2, Generic == 2, 
   Particles == 1, Number == 9], Integral[FourMomentum[Internal, 1]], 
  (gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    ...
    (4*cHWB*gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], 
     ...
     4*cHWB*gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2], 
     ...
     4*cHWB*gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2], 
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
       ...
       Index[Lorentz, 3]] + 4*cHWB*gw*LAMBDA^2*
     ...
     4*cHWB*gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2], 
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
       Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 5]] + 4*cHWB*gw*LAMBDA^2*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
       Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 5]] + g1*gw^2*LAMBDA^4*
     ...
     g1*gw^2*LAMBDA^4*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*FourVector[-FourMomentum[Outgoing, 1], 
     ...
     g1*gw^2*LAMBDA^4*FourVector[FourMomentum[Internal, 1], 
      ...
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     g1*gw^2*LAMBDA^4*FourVector[-FourMomentum[Incoming, 1], 
       Index[Lorentz, 3]]*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     g1*gw^2*LAMBDA^4*FourVector[FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
     ...
     g1*gw^2*LAMBDA^4*FourVector[-FourMomentum[Outgoing, 1], 
      ...
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]] - 
     24*cHWB*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 3]]*FourVector[-FourMomentum[Incoming, 2] - 
     ...
     24*cHWB*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] - 
     6*cW*g1*gw*LAMBDA^2*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] + 
     6*cW*g1*gw*LAMBDA^2*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
     ...
     24*cHWB*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2]] - 24*cHWB*cW*
      FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2]] + 6*cW*g1*gw*LAMBDA^2*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2]] + 4*cHWB*gw*LAMBDA^2*
      FourVector[FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
       ...
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]] + 
     24*cHWB*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
       ...
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]] + 
     24*cHWB*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
     ...
     24*cHWB*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
       ...
       -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]] + 
     FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      (-4*cHWB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
        FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
         Index[Lorentz, 2]]*(6*cW*FourVector[-FourMomentum[Internal, 1], 
           Index[Lorentz, 5]]*(FourVector[FourMomentum[Internal, 1] - 
             FourMomentum[Outgoing, 1], Index[Lorentz, 4]] + 
           FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]])*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]] + MetricTensor[Index[Lorentz, 1], 
           Index[Lorentz, 5]]*(gw*LAMBDA^2*FourVector[FourMomentum[Outgoing, 
              1], Index[Lorentz, 4]] + 6*cW*(FourVector[FourMomentum[
               Outgoing, 1], Index[Lorentz, 4]] + FourVector[
              -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
              Index[Lorentz, 4]])*ScalarProduct[-FourMomentum[Internal, 1], 
             FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]])) - 
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
        (6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]]*(g1*gw*LAMBDA^2*FourVector[
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]] + 4*cHWB*FourVector[-FourMomentum[Internal, 
                1] + FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
            ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 
                2] - FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
              FourMomentum[Outgoing, 2]] + 
           FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
            (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 
                2], -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
                FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]])) + 
         MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
          (g1*gw^2*LAMBDA^4*FourVector[FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]] - 6*cW*FourVector[-FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]]*(g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[
             ...
             -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
              ...
              FourMomentum[Outgoing, 2]] + 
           FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]]*(6*cW*g1*gw*LAMBDA^2*ScalarProduct[
               -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                FourMomentum[Outgoing, 2]] - 4*cHWB*ScalarProduct[
               FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
                FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
                FourMomentum[Outgoing, 2]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
                 -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                  FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                  FourMomentum[Outgoing, 2]]))))) + 
     FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
        ...
        FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
         ...
         Index[Lorentz, 2]]*(6*cW*FourVector[-FourMomentum[Internal, 1], 
          ...
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
           ...
           Index[Lorentz, 3]]*(-6*cW*FourVector[-FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]]*ScalarProduct[-FourMomentum[Internal, 1], 
             FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
           FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
               -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                FourMomentum[Outgoing, 2]]))) + 
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
        (6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 3]]*(g1*gw*LAMBDA^2*FourVector[
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]] + 4*cHWB*FourVector[-FourMomentum[Internal, 
                1] + FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
            ScalarProduct[FourMomentum[Incoming, 2], -FourMomentum[Incoming, 
         ...
         MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
          (FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
             Index[Lorentz, 4]]*(g1*gw^2*LAMBDA^4 + 6*cW*(g1*gw*LAMBDA^2 - 4*
                cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
                 -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
                  FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]])*
              ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[
                 Incoming, 2] + FourMomentum[Internal, 1] - FourMomentum[
                 Outgoing, 1] - FourMomentum[Outgoing, 2]]) + 
           2*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
            (-3*cW*g1*gw*LAMBDA^2*ScalarProduct[-FourMomentum[Internal, 1], 
               FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
                FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
             2*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
               -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
                FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]]*
              (gw*LAMBDA^2 + 6*cW*ScalarProduct[-FourMomentum[Internal, 1], 
                 FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
             ...
             2*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
              ...
              (gw*LAMBDA^2 + 6*cW*ScalarProduct[-FourMomentum[Internal, 1], 
                 FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
                  FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 
                   2]])))))))/(4*LAMBDA^4)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 1, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  (gw^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH], PropagatorDenominator[FourMomentum[Internal, 1] - 
    ...
    (4*cHWB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 
       ...
       g1*gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
          FourMomentum[Outgoing, 2], Index[Lorentz, 1]]*
        FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]] + 
       4*cHWB*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
       ...
       4*cHWB*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         ...
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
        (4*cHWB*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
          ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
         FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
          (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 
       ...
       (FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]] + 
         FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          ...
          Index[Lorentz, 1]])*FourVector[-FourMomentum[Outgoing, 2], 
         Index[Lorentz, 3]]) + MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 4]]*(g1*gw*LAMBDA^2*FourVector[FourMomentum[Internal, 
          1], Index[Lorentz, 1]]*FourVector[FourMomentum[Internal, 1], 
         Index[Lorentz, 3]] + FourVector[-FourMomentum[Outgoing, 2], 
         Index[Lorentz, 3]]*(g1*gw*LAMBDA^2*FourVector[
           -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
            FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]] + 4*cHWB*FourVector[FourMomentum[Incoming, 2] + 
            FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
            FourMomentum[Outgoing, 2], Index[Lorentz, 1]]*
          ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
         FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
          (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
             FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]])) + 
       FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
        (4*cHWB*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
          ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
         FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]]*(g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[
             FourMomentum[Incoming, 2], FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 2]])))))/(8*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 3, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  (gw^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH], PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
        ...
        (4*cHWB*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
         ...
         FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
           ...
           Index[Lorentz, 1]]*(g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[
             FourMomentum[Incoming, 2], FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 2]])))))/(8*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 3, Generic == 1, Particles == 4, Number == 14], 
  Integral[FourMomentum[Internal, 1]], 
  (g1*gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH], PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (g1^2*LAMBDA^2*FourVector[-FourMomentum[Internal, 1], 
       ...
       g1^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
        FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]] + 
       g1^2*LAMBDA^2*FourVector[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
          FourMomentum[Outgoing, 2], Index[Lorentz, 1]]*
        FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]] + 
       ...
       8*cHB*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
        FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
         ...
         Index[Lorentz, 1]]*ScalarProduct[FourMomentum[Incoming, 2], 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
       8*cHB*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
        FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
         Index[Lorentz, 1]]*ScalarProduct[FourMomentum[Incoming, 2], 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]] + 
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
        (g1^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
           Index[Lorentz, 3]] + 8*cHB*FourVector[-FourMomentum[Outgoing, 2], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 2], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]))))/
   (8*LAMBDA^2)], FeynAmp[GraphID[Topology == 3, Generic == 2, 
   Particles == 1, Number == 15], Integral[FourMomentum[Internal, 1]], 
  (gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
    ...
    (4*cHWB*gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], 
       Index[Lorentz, 5]]*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 2], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
     4*cHWB*gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2], 
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*FourVector[-FourMomentum[Outgoing, 2], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2], Index[Lorentz, 2]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
     ...
     g1*gw^2*LAMBDA^4*FourVector[-FourMomentum[Incoming, 1], 
      ...
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     g1*gw^2*LAMBDA^4*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     g1*gw^2*LAMBDA^4*FourVector[-FourMomentum[Outgoing, 2], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
     ...
     24*cHWB*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
       ...
       Index[Lorentz, 2]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] - 
     6*cW*g1*gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
         ...
         Index[Lorentz, 2]]*(6*cW*FourVector[-FourMomentum[Internal, 1], 
           ...
           FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
             Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
              ...
              FourMomentum[Outgoing, 2], Index[Lorentz, 1]]) + 
         MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
          (gw*LAMBDA^2*FourVector[FourMomentum[Outgoing, 2], 
             Index[Lorentz, 4]] + 6*cW*(FourVector[FourMomentum[Outgoing, 2], 
              Index[Lorentz, 4]] + FourVector[-FourMomentum[Internal, 1] + 
               FourMomentum[Outgoing, 2], Index[Lorentz, 4]])*
            ScalarProduct[-FourMomentum[Internal, 1], 
             FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]])) - 
       MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
        (6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
          (g1*gw*LAMBDA^2*FourVector[-FourMomentum[Internal, 1] + 
            ...
            FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 
             ...
             Index[Lorentz, 1]] + FourVector[FourMomentum[Incoming, 2] + 
              FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
              FourMomentum[Outgoing, 2], Index[Lorentz, 1]]*
            (4*cHWB*FourVector[-FourMomentum[Internal, 1] + FourMomentum[
                 Outgoing, 2], Index[Lorentz, 4]]*ScalarProduct[FourMomentum[
                Incoming, 2], -FourMomentum[Incoming, 2] - FourMomentum[
                 Internal, 1] + FourMomentum[Outgoing, 1] + FourMomentum[
                 Outgoing, 2]] + FourVector[-FourMomentum[Outgoing, 2], Index[
                Lorentz, 4]]*(g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[
                 FourMomentum[Incoming, 2], -FourMomentum[Incoming, 2] - 
                  FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
                  FourMomentum[Outgoing, 2]]))) + 
         MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
         ...
         Index[Lorentz, 2]]*(6*cW*FourVector[-FourMomentum[Internal, 1], 
           ...
           FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
             Index[Lorentz, 4]]*FourVector[-FourMomentum[Incoming, 2] - 
              ...
              FourMomentum[Outgoing, 2], Index[Lorentz, 3]]) + 
         MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
          (-6*cW*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 4]]*
            ScalarProduct[-FourMomentum[Internal, 1], 
             FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
              FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
           FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
          ...
          (FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
             Index[Lorentz, 4]]*(g1*gw^2*LAMBDA^4 + 6*cW*(g1*gw*LAMBDA^2 - 4*
              ...
              ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[
                 Incoming, 2] + FourMomentum[Internal, 1] - FourMomentum[
                 Outgoing, 1] - FourMomentum[Outgoing, 2]]) + 
           2*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 4]]*
            (-3*cW*g1*gw*LAMBDA^2*ScalarProduct[-FourMomentum[Internal, 1], 
               FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
                FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
             2*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
              ...
              (gw*LAMBDA^2 + 6*cW*ScalarProduct[-FourMomentum[Internal, 1], 
                 FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
                  FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 
                   2]])))))))/(4*LAMBDA^4)], 
 FeynAmp[GraphID[Topology == 3, Generic == 2, Particles == 2, Number == 16], 
  Integral[FourMomentum[Internal, 1]], 
  (gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], MH], PropagatorDenominator[
             ...
             2*cHWB*ScalarProduct[FourMomentum[Incoming, 2], 
              ...
              (gw*LAMBDA^2 + 6*cW*ScalarProduct[-FourMomentum[Internal, 1], 
                 FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
                  FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 
                   2]])))))))/(4*LAMBDA^4)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 17], 
  Integral[FourMomentum[Internal, 1]], 
  (g1*gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      MH], PropagatorDenominator[-FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MH], PropagatorDenominator[
    ...
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    (8*cHW*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]]*(FourVector[FourMomentum[Internal, 1], 
         Index[Lorentz, 3]]*FourVector[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
     ...
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      (gw^2*LAMBDA^2*FourVector[-FourMomentum[Internal, 1], 
         Index[Lorentz, 3]]*FourVector[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
       gw^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]] + 
       gw^2*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]] + 
       8*cHW*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
        ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 1]] + 
       8*cHW*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
        FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
         Index[Lorentz, 2]]*ScalarProduct[FourMomentum[Incoming, 1], 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
       8*cHW*FourVector[FourMomentum[Incoming, 2] - FourMomentum[Internal, 
           1], Index[Lorentz, 2]]*FourVector[-FourMomentum[Outgoing, 1], 
         Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 1], 
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        (gw^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
           Index[Lorentz, 3]] + 8*cHW*FourVector[-FourMomentum[Outgoing, 1], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 1], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]]))))/
    ...
    (4*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       Index[Lorentz, 4]]*(g1*gw*LAMBDA^2*FourVector[
         -FourMomentum[Internal, 1], Index[Lorentz, 3]]*
        FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
         Index[Lorentz, 2]] + g1*gw*LAMBDA^2*FourVector[
         FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]] + 
       g1*gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1], Index[Lorentz, 2]]*
       ...
       4*cHWB*FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 
         ...
         FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        (4*cHWB*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
          ScalarProduct[FourMomentum[Incoming, 1], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1]] + 
         FourVector[FourMomentum[Internal, 1], Index[Lorentz, 3]]*
    ...
    (8*cHW*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
     ...
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]]*
      (gw^2*LAMBDA^2*FourVector[-FourMomentum[Internal, 1], 
       ...
       FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
        (gw^2*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
           Index[Lorentz, 3]] + 8*cHW*FourVector[-FourMomentum[Outgoing, 2], 
           Index[Lorentz, 3]]*ScalarProduct[FourMomentum[Incoming, 1], 
           FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2]]))))/
   (8*LAMBDA^2)], FeynAmp[GraphID[Topology == 5, Generic == 1, 
  ...
  (g1^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   Particles == 1, Number == 21], Integral[FourMomentum[Internal, 1]], 
  (gw^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
      0], PropagatorDenominator[FourMomentum[Internal, 1] + 
       FourMomentum[Outgoing, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], MH]]*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    (4*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      ...
      (FourVector[-FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
        (4*cHWB*FourVector[-FourMomentum[Internal, 1] + FourMomentum[
             Outgoing, 2], Index[Lorentz, 4]]*ScalarProduct[
           FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]] + 
         FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 4]]*
          (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 1], 
             FourMomentum[Incoming, 2]])))))/(8*LAMBDA^2)], 
    ...
    (4*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
      ...
      (FourVector[FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
       ...
       4*cHWB*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
        FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 
         Index[Lorentz, 4]]*ScalarProduct[FourMomentum[Incoming, 1], 
         FourMomentum[Incoming, 2]] + FourVector[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1], Index[Lorentz, 3]]*
        (4*cHWB*FourVector[-FourMomentum[Internal, 1] + FourMomentum[
             Outgoing, 2], Index[Lorentz, 4]]*ScalarProduct[
           FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]] + 
 ...
 FeynAmp[GraphID[Topology == 7, Generic == 1, Particles == 1, Number == 25], 
  Integral[FourMomentum[Internal, 1]], 
  (g1*gw^3*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
       1], MH], PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
 ...
 FeynAmp[GraphID[Topology == 7, Generic == 1, Particles == 4, Number == 28], 
  Integral[FourMomentum[Internal, 1]], 
  (g1^3*gw*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
       1], MH], PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 2], 0], PropagatorDenominator[
 ...
 FeynAmp[GraphID[Topology == 9, Generic == 1, Particles == 1, Number == 33], 
  Integral[FourMomentum[Internal, 1]], 
  (g1*gw^2*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 
       1], 0], PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
    ...
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]*
    (gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 3]] + gw*LAMBDA^2*FourVector[
     ...
     gw*LAMBDA^2*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
     ...
     gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Outgoing, 2], 
       Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 3]] + gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*FourVector[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[-FourMomentum[Outgoing, 2], 
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 1], 
       Index[Lorentz, 5]] + gw*LAMBDA^2*FourVector[
       -FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
     ...
     gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2] + 
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]] + 
     gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
     ...
     gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1] - 
      ...
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       ...
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 3], 
       Index[Lorentz, 5]] + gw*LAMBDA^2*FourVector[FourMomentum[Internal, 1], 
       Index[Lorentz, 1]]*FourVector[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
     ...
     gw*LAMBDA^2*FourVector[-FourMomentum[Internal, 1] + 
      ...
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[-FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
     ...
     gw*LAMBDA^2*FourVector[FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      ...
      FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]] + 
     6*cW*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*FourVector[FourMomentum[Incoming, 2] + 
     ...
     6*cW*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      ...
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       ...
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] - 
     6*cW*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
     ...
     6*cW*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      ...
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] + 
     6*cW*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
     ...
     6*cW*FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
      ...
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 1]]*FourVector[-FourMomentum[Outgoing, 2], 
       Index[Lorentz, 6]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] - 
     6*cW*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
     ...
     6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 2]]*FourVector[FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 6]]*FourVector[-FourMomentum[Outgoing, 1], 
       Index[Lorentz, 4]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2]] - 
     6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
     ...
     6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
       ...
       Index[Lorentz, 5]]*(-6*cW*FourVector[-FourMomentum[Internal, 1], 
         Index[Lorentz, 1]]*FourVector[FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
          FourMomentum[Outgoing, 2], Index[Lorentz, 3]]*
        (FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       ...
       MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
        (FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
            FourMomentum[Outgoing, 1], Index[Lorentz, 2]]*
          (FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]]*
            (-6*cW*FourVector[-FourMomentum[Internal, 1] + FourMomentum[
                 Outgoing, 1], Index[Lorentz, 4]]*ScalarProduct[-FourMomentum[
                 Internal, 1], FourMomentum[Incoming, 2] + FourMomentum[
                 Internal, 1] - FourMomentum[Outgoing, 1] - FourMomentum[
                 Outgoing, 2]] + FourVector[-FourMomentum[Outgoing, 1], Index[
                Lorentz, 4]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
                 -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                  FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                  FourMomentum[Outgoing, 2]])) + 
           FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            ...
            (-6*cW*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
              ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[
                 Incoming, 2] + FourMomentum[Internal, 1] - FourMomentum[
                 Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
             FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
                 1], Index[Lorentz, 4]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
                 -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                  FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                  FourMomentum[Outgoing, 2]]))) + 
         FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
           Index[Lorentz, 2]]*(FourVector[FourMomentum[Incoming, 2] + 
              FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
             Index[Lorentz, 6]]*(-6*cW*FourVector[-FourMomentum[Internal, 
                  1] + FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
              ScalarProduct[-FourMomentum[Internal, 1], FourMomentum[
                 Incoming, 2] + FourMomentum[Internal, 1] - FourMomentum[
                 Outgoing, 1] - FourMomentum[Outgoing, 2]] + 
            ...
            (-6*cW*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 4]]*
             ...
             FourVector[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
                 ...
                 -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
                  FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
                  FourMomentum[Outgoing, 2]])))))))/(8*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 1, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  (cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MH]]*
    (FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
     ...
     FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 2]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
       ...
       Index[Lorentz, 1]]*(FourVector[FourMomentum[Internal, 1], 
        Index[Lorentz, 2]] + FourVector[-FourMomentum[Outgoing, 1], 
        Index[Lorentz, 2]] + FourVector[-FourMomentum[Outgoing, 2], 
        Index[Lorentz, 2]] - 3*FourVector[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2], Index[Lorentz, 2]]) + 
     3*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 1]]*FourVector[-FourMomentum[Incoming, 2] - 
        FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
        FourMomentum[Outgoing, 2], Index[Lorentz, 2]]))/(4*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 2, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  (cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
    ...
    (FourVector[FourMomentum[Internal, 1], Index[Lorentz, 1]]*
     ...
     FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]]*
      ...
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2], 
       Index[Lorentz, 2]]))/(4*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 10, Generic == 2, Particles == 1, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  (-2*cHWB*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], 0], PropagatorDenominator[
      FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 0]]*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]*
    (gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
     ...
     gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
      ...
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]] + 
     gw*LAMBDA^2*FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     gw*LAMBDA^2*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
       ...
       Index[Lorentz, 1]]*MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
      MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]] + 
     6*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      ScalarProduct[FourMomentum[Incoming, 1], -FourMomentum[Internal, 1]] - 
     6*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
       Index[Lorentz, 3]]*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 5]]*
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
     ...
     6*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      ...
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
        FourMomentum[Outgoing, 2]] + FourVector[FourMomentum[Incoming, 1], 
       Index[Lorentz, 5]]*(6*cW*FourVector[FourMomentum[Incoming, 2], 
       ...
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
        ...
        (-6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]]*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 3]] + MetricTensor[Index[Lorentz, 1], 
           Index[Lorentz, 3]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
             -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
              FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
              FourMomentum[Outgoing, 2]]))) + 
     FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      (6*cW*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 6]]*
        ...
        (FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]] - MetricTensor[Index[Lorentz, 1], 
           Index[Lorentz, 5]]*ScalarProduct[-FourMomentum[Internal, 1], 
           FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2]]) + 
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
        MetricTensor[Index[Lorentz, 2], Index[Lorentz, 6]]*
        (-6*cW*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 5]]*
          FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
            FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], 
           Index[Lorentz, 1]] + MetricTensor[Index[Lorentz, 1], 
           Index[Lorentz, 5]]*(gw*LAMBDA^2 + 6*cW*ScalarProduct[
             -FourMomentum[Internal, 1], FourMomentum[Incoming, 2] + 
              FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1] - 
              FourMomentum[Outgoing, 2]])))))/LAMBDA^4], 
 FeynAmp[GraphID[Topology == 11, Generic == 1, Particles == 1, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
   ...
   Particles == 2, Number == 39], Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Internal, 1] - 
       FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MH]]*
    (4*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
     ...
     cHBOX*ScalarProduct[-FourMomentum[Internal, 1] + FourMomentum[Outgoing, 
        ...
        FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]]))/
   (4*LAMBDA^4)], FeynAmp[GraphID[Topology == 11, Generic == 1, 
   Particles == 3, Number == 40], Integral[FourMomentum[Internal, 1]], 
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
      PropagatorDenominator[FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 1] - FourMomentum[Outgoing, 2], MH]]*
     (-4*cHD*cHWB*FourVector[-FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
       (ScalarProduct[FourMomentum[Internal, 1], 
         -FourMomentum[Outgoing, 1]] + ScalarProduct[FourMomentum[Internal, 
          1], -FourMomentum[Outgoing, 2]] + ScalarProduct[
         -FourMomentum[Outgoing, 1], -FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]] + 
        ScalarProduct[-FourMomentum[Outgoing, 2], 
         -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
          FourMomentum[Outgoing, 2]]) + 
      8*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
       FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
       ...
       (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 1], 
        ...
        cHD*ScalarProduct[-FourMomentum[Outgoing, 2], 
          ...
          -FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1] + 
           FourMomentum[Outgoing, 2], -FourMomentum[Internal, 1] + 
           FourMomentum[Outgoing, 1] + FourMomentum[Outgoing, 2]])))/
   (4*LAMBDA^4)], FeynAmp[GraphID[Topology == 12, Generic == 1, 
   Particles == 1, Number == 41], Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    (8*cHW*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 1]] + 
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      (gw^2*LAMBDA^2 - 8*cHW*ScalarProduct[FourMomentum[Incoming, 1], 
         FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
          FourMomentum[Outgoing, 2]]))*
    (4*cHWB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
 ...
 FeynAmp[GraphID[Topology == 12, Generic == 1, Particles == 2, Number == 42], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]]*
    (4*cHWB*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 3]]*
      FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
        FourMomentum[Outgoing, 2], Index[Lorentz, 1]] + 
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 3]]*
      (g1*gw*LAMBDA^2 - 4*cHWB*ScalarProduct[FourMomentum[Incoming, 1], 
    ...
    (8*cHB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (g1^2*LAMBDA^2 - 8*cHB*ScalarProduct[FourMomentum[Incoming, 2], 
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 2]])))/(4*LAMBDA^4)], 
 FeynAmp[GraphID[Topology == 13, Generic == 1, Particles == 1, Number == 43], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0]]*
 ...
 FeynAmp[GraphID[Topology == 13, Generic == 1, Particles == 2, Number == 44], 
  Integral[FourMomentum[Internal, 1]], 
  (FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
     PropagatorDenominator[FourMomentum[Incoming, 2] + 
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 0]]*
    ...
    (8*cHB*FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]]*
      (g1^2*LAMBDA^2 - 8*cHB*ScalarProduct[FourMomentum[Incoming, 2], 
         -FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]])))/(4*LAMBDA^4)], 
 FeynAmp[GraphID[Topology == 14, Generic == 1, Particles == 1, Number == 45], 
  Integral[FourMomentum[Internal, 1]], 
  -(cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
       FourMomentum[Internal, 1], MH], PropagatorDenominator[
     ...
     (3*FourVector[FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
      ...
      (FourVector[FourMomentum[Internal, 1], Index[Lorentz, 2]] + 
        FourVector[-FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], 
         ...
         Index[Lorentz, 1]] + FourVector[-FourMomentum[Outgoing, 1], 
         Index[Lorentz, 1]] + FourVector[-FourMomentum[Outgoing, 2], 
         Index[Lorentz, 1]])))/(4*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 14, Generic == 1, Particles == 2, Number == 46], 
  Integral[FourMomentum[Internal, 1]], 
  (cHD*g1*gw*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      -FourMomentum[Incoming, 2] + FourMomentum[Internal, 1], MH]]*
    (FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 2]]*
     ...
     (FourVector[FourMomentum[Incoming, 2] - FourMomentum[Internal, 1], 
        Index[Lorentz, 1]] + FourVector[-FourMomentum[Internal, 1], 
        Index[Lorentz, 1]])*FourVector[-FourMomentum[Incoming, 2] + 
        FourMomentum[Internal, 1], Index[Lorentz, 2]]))/(4*LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 15, Generic == 1, Particles == 1, Number == 47], 
  Integral[FourMomentum[Internal, 1]], 
  (cHWB*gw^2*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 0]]*
    (FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
      FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 3]]*
 ...
 FeynAmp[GraphID[Topology == 15, Generic == 1, Particles == 2, Number == 48], 
  Integral[FourMomentum[Internal, 1]], 
  (cHWB*gw^2*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 1], 0]]*
    (FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     (FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
      ...
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 16, Generic == 1, Particles == 1, Number == 49], 
  Integral[FourMomentum[Internal, 1]], 
  (cHWB*gw^2*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 0]]*
    (FourVector[-FourMomentum[Incoming, 2], Index[Lorentz, 4]]*
     ...
     (FourVector[FourMomentum[Incoming, 2], Index[Lorentz, 1]]*
      ...
      MetricTensor[Index[Lorentz, 2], Index[Lorentz, 4]])*
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/LAMBDA^2], 
 FeynAmp[GraphID[Topology == 16, Generic == 1, Particles == 2, Number == 50], 
  Integral[FourMomentum[Internal, 1]], 
  (cHWB*gw^2*FeynAmpDenominator[PropagatorDenominator[
      FourMomentum[Internal, 1], MH], PropagatorDenominator[
      FourMomentum[Internal, 1] + FourMomentum[Outgoing, 2], 0]]*
    ...
    MetricTensor[Index[Lorentz, 3], Index[Lorentz, 4]])/LAMBDA^2]]
ins1=
TopologyList[Process -> {V[2], V[5]} -> {S[1], S[1]}, 
  Model -> {"Mine/1312.2014.LR.noT"}, GenericModel -> 
   {"Mine/1312.2014.LR.noT"}, InsertionLevel -> {Particles}, 
  ExcludeParticles -> {F, -F[1], F[1], -F[2], F[2], -F[3], F[3], -F[4], F[4], 
    -F[5], F[5], -F[6], F[6], -F[7], F[7], -F[8], F[8], -F[9], F[9], -F[10], 
    F[10], -F[11], F[11], -F[12], F[12], -F[13], F[13], -F[14], F[14], 
    -F[15], F[15], -F[16], F[16], -F[17], F[17], -F[18], F[18], -F[19], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[2], Field[2] -> V[5], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[2], Field[6] -> S[1], 
      Field[7] -> S[1]], FeynmanGraph[1, Particles == 2][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[1], 
      Field[6] -> S[2], Field[7] -> S[2]], FeynmanGraph[1, Particles == 3][
      Field[1] -> V[2], Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> -S[3], Field[6] -> S[3], Field[7] -> -S[3]], 
     FeynmanGraph[1, Particles == 4][Field[1] -> V[2], Field[2] -> V[5], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
   ...
   FeynmanGraph[1, Generic == 2][Field[1] -> V[2], Field[2] -> V[5], 
     ...
     FeynmanGraph[1, Particles == 2][Field[1] -> V[2], Field[2] -> V[5], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[2], Field[2] -> V[5], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[2], Field[6] -> S[1], 
      Field[7] -> V[2]], FeynmanGraph[1, Particles == 2][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[2], 
      Field[6] -> S[1], Field[7] -> V[5]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
   Propagator[Incoming][Vertex[1][2], Vertex[3][6], Field[2]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[2], Field[2] -> V[5], 
      ...
      Field[7] -> S[2]], FeynmanGraph[1, Particles == 2][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[1], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[2], 
     Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> V, 
     Field[6] -> V, Field[7] -> S, Field[8] -> S] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> -V[3], Field[6] -> V[3], Field[7] -> S[3], 
      Field[8] -> -S[3]], FeynmanGraph[1, Particles == 2][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> V[3], 
 ...
 Topology[2][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[2, Generic == 1][Field[1] -> V[2], 
   ...
   FeynmanGraph[2, Generic == 2][Field[1] -> V[2], Field[2] -> V[5], 
     Field[3] -> S[1], Field[4] -> S[1], Field[5] -> V, Field[6] -> V] -> 
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[2], 
      Field[2] -> V[5], Field[3] -> S[1], Field[4] -> S[1], 
