...
process1 = {V[2], V[5]} -> {S[1], S[1]};

top = CreateTopologies[1, 2 -> 2, Adjacencies -> {3,4,5}, ExcludeTopologies -> {Internal, Tadpoles} ];

 ins1 = InsertFields[ top, process1, Model -> "Mine/1312.2014.LR.noT", GenericModel -> "Mine/1312.2014.LR.noT", ExcludeParticles -> {F}, InsertionLevel->{Particles} ];
...
FILE = NotebookDirectory[]<>"WBHHgen.res";
