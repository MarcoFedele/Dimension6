                                     ...
                                     If[count[[DIAG,TERM]] == {3, 2},
                                        ...
                                        If[count[[DIAG, TERM]] == {4, 0},
                                           ...
                                           If[count[[DIAG, TERM]] == {4, 1},
                                              ...
                                              temp1 = diagSimplify[{temp1}]// Simplify // Expand ;
                                              temp1 = temp1 //. PVsub;
                                              temp0 = Append[temp0, temp1]
                                              ]]]]]]]]]]
                                  ...
                                  If[count[[DIAG]][[1]] == {3, 2},
                                     ...
                                     If[count[[DIAG]][[1]] == {4, 0},
                                        ...
                                        If[count[[DIAG]][[1]] == {4, 1},
                                           ...
                                           temp1 = diagSimplify[{temp1}] // Simplify // Expand (*/. {Power[q1, n_] :> 0 /; n > 0, Power[q2, n_] :> 0 /; n > 0}*);
                                           temp1 = temp1 //. PVsub;
                                           temp0 = Append[temp0, temp1[[1]]]
                                           ]]]]]]]]]]
             ]
...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHW."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c (sp[Ep1, Ep2] sp[q1, q2] - sp[q1, Ep2] sp[q2, Ep1]) ] / (-4) ] + If[c === cHW,HWF,0] ],"\n"],{c,{cW, cHW, cHWB}}];
(*Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHWtilde."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n",
            Expand[ -2 Simplify[ Coefficient[total, c (LeviCivita[FourVector[q1], FourVector[q2], Index[Lorentz, 1], Index[Lorentz, 2]]sp[{Index[Lorentz,1]},Ep1] sp[{Index[Lorentz,2]},Ep2]) ]
                                / (-4) ] + If[c === cHWt,HWF,0] ],"\n"],{c,{cWt, cHWt, cHWBt}}];
*)
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ -2 Simplify[ Coefficient[total, c (sp[Ep1, Ep2] sp[q1, q2] - sp[q1, Ep2] sp[q2, Ep1]) ] / (-2) ] ] ];
   WriteString[FILE,"\n"];
   ,{c,{ceW22,ceW23,ceW32,ceW33,cuW22,cuW23,cuW32,cuW33,cdW22,cdW23,cdW32,cdW33}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
WriteString[FILE,"########  ANOMALOUS DIMENSION ENTRIES  ########"];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
