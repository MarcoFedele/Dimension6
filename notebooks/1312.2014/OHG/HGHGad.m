...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHG."];
Print[""];
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c (sp[Ep1, Ep2] sp[q1, q2] - sp[q1, Ep2] sp[q2, Ep1]) ] / (-4) ] + HWF ],"\n"],{c,{cHG}}];
(*Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES FOR OHGtilde."];
Print[""];
Print[""];
total = Total[diag];
...
FILE = NotebookDirectory[]<>"HGHGad.res";
DeleteFile[FILE]; OpenWrite[FILE];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
WriteString[FILE,"########  ANOMALOUS DIMENSION ENTRIES FOR OG  ########"];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   ...
   WriteString[FILE,"\n"];
   ,{c,{cuG22,cuG23,cuG32,cuG33,cdG22,cdG23,cdG32,cdG33}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
WriteString[FILE,"########  ANOMALOUS DIMENSION ENTRIES FOR OGtilde  ########"];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
