...
Print[""];
Print[""];
Print["ANOMALOUS DIMENSION ENTRIES."]; (* il fattore 4 viene dalla base LR, il fattore 2 dal mixing aabb-bbaa *)
Print[""];
Print[""];
Table[Print["Entry relative to ", c, " : \n", Expand[ -2 Simplify[ Coefficient[total, c] / 4 / 2 ] ],"\n"],{c,{cHl111,cHl133,cHl311,cHl333,cll1133,cll3311,cll1331,cll3113}}];
