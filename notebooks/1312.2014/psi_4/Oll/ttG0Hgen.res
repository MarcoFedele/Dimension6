...
FeynAmpList[Process -> {{F[1], FourMomentum[Incoming, 1], 0, {LeptonNumber}}, 
  ...
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
     ...
     (FermionChain[(I/2)*gw*(NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
       ...
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
          ...
          FourMomentum[Outgoing, 2]]], (I/2)*gw*
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 2, Number == 2], 
  ...
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ChiralityProjector[-1]]] + FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
     (FermionChain[(I*gw*(NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
           ChiralityProjector[-1]] + NonCommutative[DiracMatrix[
 ...
 FeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 3, Number == 3], 
  ...
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ChiralityProjector[-1]]] + FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
     (FermionChain[(-I/2)*g1*(NonCommutative[DiracMatrix[Index[Lorentz, 2]], 
          ChiralityProjector[-1]] + NonCommutative[DiracMatrix[
           Index[Lorentz, 2]], ChiralityProjector[1]]), 
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] - 
          FourMomentum[Internal, 1]]], NonCommutative[
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 4], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[(-I/2)*gw*(NonCommutative[DiracMatrix[
           Index[Lorentz, 2]], ChiralityProjector[-1]] + 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 2, Number == 5], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[(-I/2)*g1*(NonCommutative[DiracMatrix[
           Index[Lorentz, 2]], ChiralityProjector[-1]] + 
         NonCommutative[DiracMatrix[Index[Lorentz, 2]], ChiralityProjector[
           1]]), NonCommutative[DiracSlash[-FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[
 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 1, Number == 8], 
  ...
  -((cll1123*(FermionChain[(I/2)*gw*(NonCommutative[DiracMatrix[
         ...
         NonCommutative[DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[
          ...
          FourMomentum[Internal, 1]]], NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
      FermionChain[(I/2)*gw*(NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
          ChiralityProjector[-1]] + NonCommutative[DiracMatrix[
           Index[Lorentz, 1]], ChiralityProjector[1]]), 
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1]]], NonCommutative[
     ...
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 2, Number == 9], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[(-I/2)*g1*(NonCommutative[DiracMatrix[
           Index[Lorentz, 1]], ChiralityProjector[-1]] + 
         NonCommutative[DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[
          ...
          FourMomentum[Internal, 1]]], NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[-1]]] + 
      FermionChain[(-I/2)*g1*(NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
          ChiralityProjector[-1]] + NonCommutative[DiracMatrix[
           Index[Lorentz, 1]], ChiralityProjector[1]]), 
       NonCommutative[DiracSlash[-FourMomentum[Incoming, 2] + 
          FourMomentum[Internal, 1]]], NonCommutative[
 ...
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 1, Number == 10], 
  ...
  -((cll1123*(FermionChain[(I/2)*gw*(NonCommutative[DiracMatrix[
     ...
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 5, Generic == 1, Particles == 2, Number == 11], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[(-I/2)*g1*(NonCommutative[DiracMatrix[
           Index[Lorentz, 1]], ChiralityProjector[-1]] + 
         NonCommutative[DiracMatrix[Index[Lorentz, 1]], ChiralityProjector[
  ...
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
     ...
     (FermionChain[(-I/2)*gw*(NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
      ...
      PropagatorDenominator[FourMomentum[Internal, 1] + 
       ...
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 2, Number == 13], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ChiralityProjector[-1]]] + FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
     (FermionChain[(I*gw*(NonCommutative[DiracMatrix[Index[Lorentz, 1]], 
           ChiralityProjector[-1]] + NonCommutative[DiracMatrix[
            Index[Lorentz, 1]], ChiralityProjector[1]]))/Sqrt[2], 
       NonCommutative[DiracSlash[FourMomentum[Internal, 1] + 
          FourMomentum[Outgoing, 1]]], NonCommutative[
     ...
     FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
      PropagatorDenominator[FourMomentum[Internal, 1] + 
       ...
       FourMomentum[Internal, 1] - FourMomentum[Outgoing, 2], 0]]*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]])/LAMBDA^2)], 
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 3, Number == 14], 
  Integral[FourMomentum[Internal, 1]], 
  -((cll1123*(FermionChain[NonCommutative[DiracMatrix[Index[Lorentz, a]], 
        ChiralityProjector[-1]]] + FermionChain[NonCommutative[
        DiracMatrix[Index[Lorentz, a]], ChiralityProjector[1]]])*
...
TopologyList[Process -> {F[1], -F[1]} -> {F[5], -F[6]}, 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[1], 
     Field[2] -> -F[1], Field[3] -> -F[5], Field[4] -> F[6], Field[5] -> V, 
     Field[6] -> F, Field[7] -> F] -> Insertions[Particles][
     FeynmanGraph[1, Particles == 1][Field[1] -> F[1], Field[2] -> -F[1], 
      Field[3] -> -F[5], Field[4] -> F[6], Field[5] -> V[2], 
      Field[6] -> F[1], Field[7] -> -F[1]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[1], Field[2] -> -F[1], Field[3] -> -F[5], 
      Field[4] -> F[6], Field[5] -> V[3], Field[6] -> F[4], 
      Field[7] -> -F[4]], FeynmanGraph[1, Particles == 3][Field[1] -> F[1], 
      Field[2] -> -F[1], Field[3] -> -F[5], Field[4] -> F[6], 
      Field[5] -> V[5], Field[6] -> F[1], Field[7] -> -F[1]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[1], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> F[1], Field[2] -> -F[1], 
      Field[3] -> -F[5], Field[4] -> F[6], Field[5] -> V[2], 
      Field[6] -> F[1], Field[7] -> -F[5]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[1], Field[2] -> -F[1], Field[3] -> -F[5], 
      Field[4] -> F[6], Field[5] -> V[5], Field[6] -> F[1], 
      Field[7] -> -F[5]]]], 
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
   Propagator[Incoming][Vertex[1][2], Vertex[4][6], Field[2]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[1], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> F[1], Field[2] -> -F[1], 
      Field[3] -> -F[5], Field[4] -> F[6], Field[5] -> V[2], 
      Field[6] -> F[1], Field[7] -> F[6]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[1], Field[2] -> -F[1], Field[3] -> -F[5], 
      Field[4] -> F[6], Field[5] -> V[5], Field[6] -> F[1], 
      Field[7] -> F[6]]]], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> F[1], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> F[1], Field[2] -> -F[1], 
      Field[3] -> -F[5], Field[4] -> F[6], Field[5] -> V[2], 
      Field[6] -> -F[5], Field[7] -> F[6]], FeynmanGraph[1, Particles == 2][
      Field[1] -> F[1], Field[2] -> -F[1], Field[3] -> -F[5], 
      Field[4] -> F[6], Field[5] -> V[3], Field[6] -> -F[2], 
      Field[7] -> F[3]], FeynmanGraph[1, Particles == 3][Field[1] -> F[1], 
      Field[2] -> -F[1], Field[3] -> -F[5], Field[4] -> F[6], 
      Field[5] -> V[5], Field[6] -> -F[5], Field[7] -> F[6]]]]]
