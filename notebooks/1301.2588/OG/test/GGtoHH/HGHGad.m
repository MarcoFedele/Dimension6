...
Print[""];
total = Total[diag];
Table[Print["Entry relative to ", c, " : \n", Expand[ 2 Simplify[ Coefficient[total, c] * (1/2/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] + HWF],"\n"],{c,{cG}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ 2 Simplify[ Coefficient[total,c]* (1/2/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] + HWF] ];
   WriteString[FILE,"\n"];
   ,{c,{cG}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
