...
diag = diag/.{MH->Sqrt[h], MGl->Sqrt[gl]};

diag = diagSimplify[diag];

prefactor = Nc cG GS^4 / LAMBDA^2;
...
diagdiv = Simplify[prefactor Total[diag] * (LAMBDA^2/cG/GS^2)] /.{ A0[x_] -> x, B0[q1, gl, gl] -> 0, B0[q2, gl, gl] -> 0, B0[-q1, gl, gl] -> 0, B0[-q2, gl, gl] -> 0, B0[___,___,___] -> 1, C0[_,_,_,_,_] -> 0, q1^2 -> 0, q2^2 -> 0, q1^4 -> 0, q2^4 -> 0,  gl -> 0 } //FullSimplify
