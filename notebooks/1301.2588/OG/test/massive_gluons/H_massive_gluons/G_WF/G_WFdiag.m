...
ContractionRules = { MetricTensor[Index[Lorentz, a_], Index[Lorentz, b_]]*
                      MetricTensor[Index[Lorentz, b_], Index[orentz, c_]] :>
...
amp3 = {0};
Do[
   If[ ! MatchQ[Simplify[amp2[[DIAG]]], 1/LAMBDA^2*___], amp3 = Append[amp3, amp2[[DIAG]]];
      Print["Diagram number ", DIAG, " included"]
      ]
   , {DIAG, Length[amp2]}];
amp2 = Rest[amp3];
...
FILE = NotebookDirectory[]<>"G_WFdiag.res";
