...
diag = diag /. {sp[Ep1, q1] -> 0, sp[Ep2, q1] -> 0} /. {sp[Epa_, q_] :>  sp[q, Epa] /; MatchQ[Epa, Ep1 | Ep2] && ! MatchQ[q, Ep1 | Ep2]};
...
diagder = Coefficient[Simplify[diag /. nd -> 4],q1^2 sp[Ep1,Ep2]]
...
FILE = NotebookDirectory[]<>"G_WFwork.res";
