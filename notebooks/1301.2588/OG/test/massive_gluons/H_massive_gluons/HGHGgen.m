...
ins1 = InsertFields[ top, process1, Model -> "Mine/1301.2581_massive", GenericModel -> "Mine/1301.2581_massive", ExcludeParticles -> {V[1], V[2], S[2], S[3],F}, InsertionLevel->{Particles} ];
