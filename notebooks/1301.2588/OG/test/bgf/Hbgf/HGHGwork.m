...
Print[Simplify[diag]];
diag = diag /.{ A0[m_] -> m, B0[___,___,___] -> 1, C0[-q1,q2,0,0,0] -> 0 };
diagdiv = Expand[Simplify[ prefactor Total[diag] * (LAMBDA^2/2/cG/GS^2)/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1]) ]]

Print[""];
Print["diag divergences (C0 -> 0 by hand):"];
Print[diagdiv];
