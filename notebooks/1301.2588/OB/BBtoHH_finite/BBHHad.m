...
Table[Print["Entry relative to ", c, " : \n", Expand[ 2 Simplify[ Coefficient[totale, c] * (1/2/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] + If[c === cB,HWF,0] ],"\n"],{c,{cB,cW,cWB}}];
...
Do[WriteString[FILE,ToString[c]<>"entry:=\n"];
   Write[FILE, Expand[ 2 Simplify[ Coefficient[totale,c]* (1/2/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] + If[c === cB,HWF,0] ] ];
   WriteString[FILE,"\n"];
   ,{c,{cB,cW,cWB}}];
WriteString[FILE,"\n"];WriteString[FILE,"\n"];
