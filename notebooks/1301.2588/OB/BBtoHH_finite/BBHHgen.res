 ...
 FeynAmp[GraphID[Topology == 4, Generic == 1, Particles == 4, Number == 16], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   (((2*I)*cB*g1^2*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 4]]*
      FourVector[FourMomentum[Internal, 1] - FourMomentum[Outgoing, 1], 
       Index[Lorentz, 1]])/LAMBDA^2 + (I/2)*g1^2*
     MetricTensor[Index[Lorentz, 1], Index[Lorentz, 4]] - 
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 1, Number == 21], 
  ...
  (2*I)*lam*FeynAmpDenominator[PropagatorDenominator[
   ...
   (((2*I)*cB*g1^2*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 2]]*
    ...
    ((2*I)*cB*g1^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
      ScalarProduct[FourMomentum[Incoming, 1], FourMomentum[Incoming, 2]])/
     LAMBDA^2)], FeynAmp[GraphID[Topology == 10, Generic == 1, 
...
TopologyList[Process -> {V[6], V[6]} -> {S[1], S[1]}, 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[6], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[6], Field[2] -> V[6], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[2], Field[6] -> S[1], 
      Field[7] -> S[1]], FeynmanGraph[1, Particles == 2][Field[1] -> V[6], 
     ...
     FeynmanGraph[1, Particles == 4][Field[1] -> V[6], Field[2] -> V[6], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[6], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[6], Field[2] -> V[6], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[2], Field[6] -> S[1], 
      Field[7] -> V[2]], FeynmanGraph[1, Particles == 2][Field[1] -> V[6], 
      Field[2] -> V[6], Field[3] -> S[1], Field[4] -> S[1], 
      Field[5] -> -S[3], Field[6] -> S[3], Field[7] -> -V[3]], 
     FeynmanGraph[1, Particles == 3][Field[1] -> V[6], Field[2] -> V[6], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[3], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[4][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[6], 
     ...
     FeynmanGraph[1, Particles == 1][Field[1] -> V[6], Field[2] -> V[6], 
      ...
      Field[7] -> S[2]], FeynmanGraph[1, Particles == 2][Field[1] -> V[6], 
      Field[2] -> V[6], Field[3] -> S[1], Field[4] -> S[1], 
 ...
 Topology[1][Propagator[Incoming][Vertex[1][1], Vertex[3][5], Field[1]], 
  ...
  Insertions[Generic][FeynmanGraph[1, Generic == 1][Field[1] -> V[6], 
    ...
    Insertions[Particles][FeynmanGraph[1, Particles == 1][Field[1] -> V[6], 
      Field[2] -> V[6], Field[3] -> S[1], Field[4] -> S[1], Field[5] -> S[1], 
      Field[6] -> S[2], Field[7] -> S[2], Field[8] -> V[2]], 
     FeynmanGraph[1, Particles == 2][Field[1] -> V[6], Field[2] -> V[6], 
      Field[3] -> S[1], Field[4] -> S[1], Field[5] -> -S[3], 
