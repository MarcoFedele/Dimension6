      ...
      If[MatchQ[diag[[DIAG]], 0], Print["There's something wrong in spcounter!"],
         Do[i = 1;
            ...
            While[i <= Length[diag[[DIAG, TERM]]],
                  ...
                  If[MatchQ[diag[[DIAG, TERM, i]], p^2], check+=2];
                  i++];
...
Print[""];
total = Total[diag];
Table[Print["div relative to ", c, " : \n", Expand[ Simplify[ Coefficient[total,c]* (-1/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] ],"\n"],{c,{cB,cW,cWB}}];


FILE = NotebookDirectory[]<>"WBHHwork.res";
...
Do[WriteString[FILE,ToString[c]<>"div:=\n"];
   Write[FILE, Expand[ Simplify[ Coefficient[total,c]* (-1/(sp[Ep1,Ep2] sp[q1,q2]-sp[q1,Ep2] sp[q2,Ep1])) ] ] ];
   WriteString[FILE,"\n"];
,{c,{cB,cW,cWB}}];
Close[FILE];
