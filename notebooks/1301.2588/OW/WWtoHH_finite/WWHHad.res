...
cWB*((5*g1^2)/2 - (g1^2*B0[q1 - q3, 0, h])/2 - (g1^2*B0[q2 - q3, 0, h])/2 + 
   (g1^2*h*C0[q1, q1 - q3, h, h, 0])/8 + (g1^2*h*C0[q1, q1 - q4, h, h, 0])/
    8 + (g1^2*h*C0[q2, q2 - q3, h, h, 0])/8 + 
   (g1^2*h*C0[q2, q2 - q4, h, h, 0])/8 - (3*g1^2*Log[h])/2) + 
 cW*(-2*g1^2 - gw^2 + ((g1^2 + 3*(gw^2 + 8*lam))*B0[q1 + q2, h, h])/4 - 
   gw^2*B0[q1 - q3, 0, h] - gw^2*B0[q2 - q3, 0, h] + 
   (16*gw^2*h*C0[q1, q1 + q2, 0, 0, 0])/3 + (gw^2*h*C0[q1, q1 - q3, h, h, 0])/
    4 + (gw^2*h*C0[q1, q1 - q4, h, h, 0])/4 + 
   (gw^2*h*C0[q2, q2 - q3, h, h, 0])/4 + (gw^2*h*C0[q2, q2 - q4, h, h, 0])/
    4 - ((g1^2 + 3*gw^2)*h*C0[q3, -q4, 0, h, h])/3 + g1^2*Log[h] + 
   B0[h, t, t]*yu[3, 3]^2)
