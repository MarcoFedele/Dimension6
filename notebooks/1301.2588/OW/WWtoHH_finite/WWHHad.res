...
finiteterms:=
cWB*(5*g1^2 - g1^2*B0[q1 - q3, 0, h] - g1^2*B0[q2 - q3, 0, h] + 
   g1^2*h*C0[0, h, h, h, 0] - 3*g1^2*Log[h]) + 
 cW*(-2*g1^2 + 4*gw^2 + ((g1^2 + 3*(gw^2 + 8*lam))*B0[q1 + q2, h, h])/2 - 
   2*gw^2*B0[q1 - q3, 0, h] - 2*gw^2*B0[q2 - q3, 0, h] + 
   2*gw^2*h*C0[0, h, h, h, 0] + (32*gw^2*h*C0[0, q2, 0, 0, 0])/3 - 
   (2*(g1^2 + 3*gw^2)*h*C0[-h, h, 0, h, h])/3 + (g1^2 - 3*gw^2)*Log[h])
