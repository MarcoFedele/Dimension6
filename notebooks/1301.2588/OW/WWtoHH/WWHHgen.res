...
FeynAmpList[Process -> {{V[3], FourMomentum[Incoming, 1], 0, {Q}}, 
 ...
 FeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, Number == 7], 
  ...
  I*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
   ...
   ((gw*FourVector[-FourMomentum[Internal, 1], Index[Lorentz, 1]])/2 - 
    ...
    Index[Lorentz, 4]]*(((2*I)*cW*gw^2*FourVector[FourMomentum[Incoming, 2], 
 ...
 FeynAmp[GraphID[Topology == 6, Generic == 1, Particles == 1, Number == 15], 
  ...
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 2, Number == 20], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
   ...
   ((-I)*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
    ...
    I*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 6, Generic == 2, Particles == 3, Number == 21], 
  Integral[FourMomentum[Internal, 1]], 
  (-I)*FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 
     MGP], PropagatorDenominator[FourMomentum[Internal, 1] + 
      FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
   ...
   ((2*I)*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 6]]*
    ...
    I*gw^2*MetricTensor[Index[Lorentz, 1], Index[Lorentz, 2]]*
     MetricTensor[Index[Lorentz, 4], Index[Lorentz, 6]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 7, Generic == 1, Particles == 1, Number == 22], 
  Integral[FourMomentum[Internal, 1]], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MH], 
    ...
    (-(gw*FourVector[-FourMomentum[Outgoing, 1], Index[Lorentz, 3]])/2 + 
     (gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
        ...
        Index[Lorentz, 3]])/2)*MetricTensor[Index[Lorentz, 3], 
     Index[Lorentz, 4]])], FeynAmp[GraphID[Topology == 7, Generic == 1, 
   Particles == 3, Number == 24], Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 9, Generic == 1, Particles == 1, Number == 34], 
  ...
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MG0], 
   ...
   (-(gw*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]])/2 + 
    ...
    Index[Lorentz, 4]]*((-I)*gw*FourVector[FourMomentum[Incoming, 2], 
    ...
    I*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 9, Generic == 1, Particles == 2, Number == 35], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], MGP], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], 0], PropagatorDenominator[
   ...
   (-(gw*FourVector[-FourMomentum[Outgoing, 2], Index[Lorentz, 6]])/2 + 
    ...
    I*gw*FourVector[-FourMomentum[Incoming, 2] - FourMomentum[Internal, 1] + 
     ...
     MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 9, Generic == 2, Particles == 1, Number == 36], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MG0], PropagatorDenominator[
   ...
   (I*gw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
    ...
    I*gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      ...
      Index[Lorentz, 1]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 9, Generic == 2, Particles == 2, Number == 37], 
  Integral[FourMomentum[Internal, 1]], 
  FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
    PropagatorDenominator[FourMomentum[Internal, 1] - 
      FourMomentum[Outgoing, 1], MGP], PropagatorDenominator[
   ...
   ((-I)*gw*FourVector[FourMomentum[Incoming, 1], Index[Lorentz, 5]]*
    ...
    I*gw*FourVector[FourMomentum[Incoming, 2] + FourMomentum[Internal, 1] - 
      ...
      Index[Lorentz, 1]]*MetricTensor[Index[Lorentz, 3], Index[Lorentz, 5]])*
   MetricTensor[Index[Lorentz, 5], Index[Lorentz, 6]]], 
 FeynAmp[GraphID[Topology == 10, Generic == 1, Particles == 1, Number == 38], 
  Integral[FourMomentum[Internal, 1]], 
 ...
 FeynAmp[GraphID[Topology == 15, Generic == 1, Particles == 1, Number == 50], 
  ...
  -(FeynAmpDenominator[PropagatorDenominator[FourMomentum[Internal, 1], 0], 
     ...
     Index[Lorentz, 4]]*((-I)*gw*FourVector[FourMomentum[Incoming, 2], 
       ...
       Index[Lorentz, 3]] + I*gw*FourVector[-FourMomentum[Internal, 1], 
       Index[Lorentz, 5]]*MetricTensor[Index[Lorentz, 2], 
       Index[Lorentz, 3]] + I*gw*FourVector[FourMomentum[Incoming, 2], 
