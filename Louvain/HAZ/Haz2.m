...
decayKinematics := {sp[q1,q1] -> 0, sp[q2,q2] -> z, sp[Ep1,q1] -> 0, sp[Ep2,q2] -> 0}
...
(* Here I store the result I obtained so far in the file Haz2.res. I have to do so, since I have to quit
   the kernel I am working on before loading FeynCalc, which is in conflict with Tracer. *)

FILE = NotebookDirectory[]<>"Haz2.res";
