...
decayKinematics := {sp[q1,q1] -> z, sp[Ep1,q1] -> 0}
...
(* Here I store the result I obtained so far in the file az2.res. I have to do so, since I have to quit
  the kernel I am working on before loading FeynCalc, which is in conflict with Tracer. *)

FILE = NotebookDirectory[]<>"az2.res";
